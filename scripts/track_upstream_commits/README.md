...
The results include the `crates/iota-bridge` and all the folders that are managed by the `@iotaledger/node` team.
...
```
./run.sh --since mainnet-v1.32.2 --until mainnet-v1.36.2 --codeowners @iotaledger/node
```
