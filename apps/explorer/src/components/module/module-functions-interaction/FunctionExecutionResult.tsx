...
export function FunctionExecutionResult({ error, result, onClear }: FunctionExecutionResultProps) {
    ...
    return (
        <div className="bg-neutral-96 dark:bg-neutral-12 relative inline-flex flex-nowrap items-center gap-2 overflow-hidden rounded-lg p-xs">
            <div className="space-y-4 text-body-sm">
                ...
                <div className="absolute right-2 top-2">
                    <Close
                        className="text-neutral-10 dark:text-neutral-92 h-3 w-3"
                        onClick={onClear}
                        aria-label="Close"
                    />
                </div>
