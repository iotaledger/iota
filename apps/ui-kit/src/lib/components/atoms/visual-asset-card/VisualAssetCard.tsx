...
export function VisualAssetCard({
    ...
    return (
        <div
            ...
            onClick={onClick}
        >
            {'assetSrc' in assetProps ? (
                <AssetDisplay
                    assetType={assetProps.assetType}
                    assetSrc={assetProps.assetSrc}
                    altText={assetProps.altText}
                />
            ) : (
                assetProps.renderAsset
            )}
...
function AssetDisplay({ assetSrc, assetType, altText }: AssetDisplayProps): React.JSX.Element {
