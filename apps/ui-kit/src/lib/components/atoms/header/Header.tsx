...
export function Header({
    ...
    return (
        <div className="text-neutral-10 dark:bg-neutral-6 dark:text-neutral-92 flex min-h-[56px] w-full items-center bg-neutral-100 px-md--rs pb-xs pt-sm [&_svg]:h-5 [&_svg]:w-5">
            {onBack ? (
                <Button
