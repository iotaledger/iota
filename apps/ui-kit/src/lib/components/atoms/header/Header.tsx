...
export function Header({ title, hasLeftIcon, hasRightIcon }: HeaderProps): JSX.Element {
    return (
        <div
            className={cx(
                'px-4 md:px-6 py-2 flex items-center justify-between',
                'min-h-[56px] bg-gray-200',
            )}
        >
            {hasLeftIcon && (
                <svg
