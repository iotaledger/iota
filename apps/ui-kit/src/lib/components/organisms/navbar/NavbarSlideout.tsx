...
export function NavbarSlideout({
    ...
    return (
        <>
            ...
            <div
                className={cx(
                    'z-999 rounded-tb-3xl dark:bg-neutral-6 fixed left-0 top-0 h-full w-11/12 rounded-tr-3xl bg-white px-lg py-lg transition-transform duration-300 ease-out',
                    {
