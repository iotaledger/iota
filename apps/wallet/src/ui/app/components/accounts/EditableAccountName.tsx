...
export const Input = forwardRef<HTMLInputElement, InputProps>((props, forwardedRef) => (
    <input
        className="text-steel-darker hover:text-hero p-0 peer items-center rounded-sm border-none bg-transparent text-pBody font-semibold outline-none transition focus:bg-transparent"
        ref={forwardedRef}
        {...props}
    />
));
