...
function CardView({ name, link, icon }: CardViewProps) {
    ...
    return (
        <div className="border-gray-45 hover:border-iota/30 hover:bg-iota/10 p-3.75 box-border flex h-32 w-full flex-col rounded-2xl border border-solid bg-white">
...
function ListView({ name, icon, description, tags }: ListViewProps) {
    return (
        <div className="item-center hover:bg-iota/10 px-1.25 py-3.5 box-border flex gap-3 rounded bg-white">
            ...
            <div className="flex flex-col justify-center gap-1">
                ...
                {tags?.length && (
                    <div className="mt-0.5 flex flex-wrap gap-1">
                        {tags?.map((tag) => (
                            <div
                                className="item-center border-steel px-1.5 py-0.5 flex justify-center rounded border border-solid"
                                key={tag}
                            >
