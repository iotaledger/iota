...
import { GAS_SYMBOL, GAS_COIN_TYPE } from '_redux/slices/iota-objects/Coin';
...
export function SponsoredTxnGasSummary({ totalGas, sponsor }: SponsoredTxnGasSummaryProps) {
    const [sponsorTotalAmount, sponsorTotalAmountSymbol] = useFormatCoin(totalGas, GAS_COIN_TYPE);
