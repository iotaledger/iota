...
export function AccountGroup({
    ...
    return (
        <div className="relative overflow-visible">
                ...
                render={({ isOpen }) => (
                    <div className="relative flex min-h-[52px] w-full items-center justify-between gap-1 py-2 pl-1 pr-sm">
                        <div className="flex items-center gap-1">
                            <TriangleDown
                                className={clsx(
                                    'text-neutral-10 dark:text-neutral-40 h-5 w-5',
                                    isOpen
                                        ? 'rotate-0 transition-transform ease-linear'
                                        : '-rotate-90 transition-transform ease-linear',
                                )}
                            />
                            <div className="text-neutral-10 dark:text-neutral-92 text-title-md">
                        ...
                        <div className="flex items-center gap-1">
                            {(isMnemonicDerivedGroup || isSeedDerivedGroup) && accountSource ? (
                                <Button
                                    ...
                                    onClick={handleAdd}
                                    icon={
                                        <Add className="text-neutral-10 dark:text-neutral-92 h-5 w-5" />
                                    }
                                />
                            ) : null}
                            {showMoreButton && (
                                <div className="relative">
                                    <Button
                                        ...
                                        icon={
                                            <MoreHoriz className="text-neutral-10 dark:text-neutral-92 h-5 w-5" />
                                        }
                                    />
                                </div>
                            )}
                        ...
                        {Object.entries(groupAccountsByAccountIndex(accounts)).map(
                            ([walletName, walletAccounts], index) => (
                                <Collapsible
                                    ...
                                    hideBorder
                                    render={({ isOpen }) => (
                                        <div className="text-neutral-40 dark:text-neutral-60 flex w-full items-center gap-x-md p-sm">
            ...
            <div
                className={`dark:bg-neutral-6 absolute right-3 top-3 z-[100] rounded-lg bg-neutral-100 shadow-md ${isDropdownOpen ? '' : 'hidden'}`}
            >
