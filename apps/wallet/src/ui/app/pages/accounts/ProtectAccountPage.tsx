...
export function ProtectAccountPage() {
    ...
    return (
        <div className="bg-iota-lightest px-6 py-10 flex h-screen max-h-popup-height min-h-popup-minimum w-popup-width flex-col items-center overflow-auto rounded-20 shadow-wallet-content">
