...
use crate::{
    ...
    iota_mode::{
        ...
        BRIDGE_CREATE, BRIDGE_MODULE_NAME, CLAIM_CLAIM_ADDRESS, CLAIM_MODULE_NAME,
        CLAIM_REGISTRY_CLAIM, CLAIM_REGISTRY_CREATE, CLAIM_REGISTRY_MODULE_NAME, CLOCK_MODULE_NAME,
        DENY_LIST_CREATE, DENY_LIST_MODULE_NAME, ID_LEAK_DIAG, IOTA_ADDR_NAME, IOTA_ADDR_VALUE,
        IOTA_CLOCK_CREATE, IOTA_SYSTEM_ADDR_VALUE, IOTA_SYSTEM_CREATE, IOTA_SYSTEM_MODULE_NAME,
        OBJECT_MODULE_NAME, OBJECT_NEW, OBJECT_NEW_UID_FROM_HASH, RANDOMNESS_MODULE_NAME,
        RANDOMNESS_STATE_CREATE, TEST_SCENARIO_MODULE_NAME, TS_NEW_OBJECT, UID_TYPE_NAME,
    },
...
pub const FRESH_ID_FUNCTIONS: &[(AccountAddress, Symbol, Symbol)] = &[
    ...
    (IOTA_ADDR_VALUE, CLAIM_MODULE_NAME, CLAIM_CLAIM_ADDRESS),
];
