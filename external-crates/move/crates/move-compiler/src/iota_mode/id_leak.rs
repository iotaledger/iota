...
use crate::{
    ...
    }, diag, diagnostics::{Diagnostic, Diagnostics}, editions::Flavor, expansion::ast::ModuleIdent, hlir::ast::{self as H, Exp, Label, ModuleCall, SingleType, Type, Type_, Var}, iota_mode::{
        ACCOUNT_REGISTRY_MODULE_NAME, AUTHENTICATOR_STATE_CREATE, AUTHENTICATOR_STATE_MODULE_NAME, BRIDGE_ADDR_VALUE, BRIDGE_CREATE, BRIDGE_MODULE_NAME, CLOCK_MODULE_NAME, DENY_LIST_CREATE, DENY_LIST_MODULE_NAME, DETERMINISTIC_OBJECT_MODULE_NAME, ID_LEAK_DIAG, IOTA_ACCOUNT_REGISTRY_CREATE, IOTA_ADDR_NAME, IOTA_ADDR_VALUE, IOTA_CLOCK_CREATE, IOTA_DETERMINISTIC_OBJECT_NEW_PRECOMPUTED, IOTA_SYSTEM_ADDR_VALUE, IOTA_SYSTEM_CREATE, IOTA_SYSTEM_MODULE_NAME, OBJECT_MODULE_NAME, OBJECT_NEW, OBJECT_NEW_UID_FROM_HASH, RANDOMNESS_MODULE_NAME, RANDOMNESS_STATE_CREATE, TEST_SCENARIO_MODULE_NAME, TS_NEW_OBJECT, UID_TYPE_NAME
    }, parser::ast::{Ability_, TargetKind}, shared::{program_info::TypingProgramInfo, Identifier}
};
...
pub const FRESH_ID_FUNCTIONS: &[(AccountAddress, Symbol, Symbol)] = &[
    ...
    (IOTA_ADDR_VALUE, DETERMINISTIC_OBJECT_MODULE_NAME, IOTA_DETERMINISTIC_OBJECT_NEW_PRECOMPUTED),
];
pub const FUNCTIONS_TO_SKIP: &[(AccountAddress, Symbol, Symbol)] = &[
    ...
    (IOTA_ADDR_VALUE, ACCOUNT_REGISTRY_MODULE_NAME, IOTA_ACCOUNT_REGISTRY_CREATE),
];
