...
// Traverses an ExternalAttributeValue and returns any (ModuleIdent, Name)
// found.
//
// Specifically, if the value is a ModuleAccess then we pattern-match on its
// inner value and insert the module identifier and name into the set.
...
// Traverses a single ExternalAttributeEntry and returns any module accesses
// found.
...
// Traverses a collection of ExternalAttributeEntries and returns the union of
// all module accesses found.
