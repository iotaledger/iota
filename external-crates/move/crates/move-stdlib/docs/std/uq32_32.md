...
-  [Structs](#@Structs_0)
    -  [`UQ32_32` <span class="move-vis move-vis-struct">struct</span>](#std_uq32_32_UQ32_32)
        -  [`add` <span class="move-vis move-vis-public">pub</span>](#std_uq32_32_add)
        -  [`div` <span class="move-vis move-vis-public">pub</span>](#std_uq32_32_div)
        -  [`ge` <span class="move-vis move-vis-public">pub</span>](#std_uq32_32_ge)
        -  [`gt` <span class="move-vis move-vis-public">pub</span>](#std_uq32_32_gt)
        -  [`le` <span class="move-vis move-vis-public">pub</span>](#std_uq32_32_le)
        -  [`lt` <span class="move-vis move-vis-public">pub</span>](#std_uq32_32_lt)
        -  [`mul` <span class="move-vis move-vis-public">pub</span>](#std_uq32_32_mul)
        -  [`sub` <span class="move-vis move-vis-public">pub</span>](#std_uq32_32_sub)
        -  [`to_int` <span class="move-vis move-vis-public">pub</span>](#std_uq32_32_to_int)
        -  [`to_raw` <span class="move-vis move-vis-public">pub</span>](#std_uq32_32_to_raw)
-  [Constants](#@Constants_1)
    -  [`EDenominator` <span class="move-vis move-vis-error">err</span>](#std_uq32_32_EDenominator)
    -  [`EQuotientTooSmall` <span class="move-vis move-vis-error">err</span>](#std_uq32_32_EQuotientTooSmall)
    -  [`EQuotientTooLarge` <span class="move-vis move-vis-error">err</span>](#std_uq32_32_EQuotientTooLarge)
    -  [`EOverflow` <span class="move-vis move-vis-error">err</span>](#std_uq32_32_EOverflow)
    -  [`EDivisionByZero` <span class="move-vis move-vis-error">err</span>](#std_uq32_32_EDivisionByZero)
    -  [`TOTAL_BITS` <span class="move-vis move-vis-const">const</span>](#std_uq32_32_TOTAL_BITS)
    -  [`FRACTIONAL_BITS` <span class="move-vis move-vis-const">const</span>](#std_uq32_32_FRACTIONAL_BITS)
-  [Module Functions](#@Module_Functions_2)
    -  [`from_int` <span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span>](#std_uq32_32_from_int)
    -  [`from_quotient` <span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span>](#std_uq32_32_from_quotient)
    -  [`from_raw` <span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span>](#std_uq32_32_from_raw)
    -  [`int_div` <span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span>](#std_uq32_32_int_div)
    -  [`int_mul` <span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span>](#std_uq32_32_int_mul)
...
### `UQ32_32` <span class="move-vis move-vis-struct">struct</span>
