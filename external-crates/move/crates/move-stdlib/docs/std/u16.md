...
-  [Public Functions](#@Public_Functions_0)
    -  [`bitwise_not`](#std_u16_bitwise_not)
    -  [`diff`](#std_u16_diff)
    -  [`divide_and_round_up`](#std_u16_divide_and_round_up)
    -  [`do` (macro)](#std_u16_do)
    -  [`do_eq` (macro)](#std_u16_do_eq)
    -  [`max`](#std_u16_max)
    -  [`max_value` (macro)](#std_u16_max_value)
    -  [`min`](#std_u16_min)
    -  [`pow`](#std_u16_pow)
    -  [`range_do` (macro)](#std_u16_range_do)
    -  [`range_do_eq` (macro)](#std_u16_range_do_eq)
    -  [`sqrt`](#std_u16_sqrt)
    -  [`to_string`](#std_u16_to_string)
    -  [`try_as_u8`](#std_u16_try_as_u8)
