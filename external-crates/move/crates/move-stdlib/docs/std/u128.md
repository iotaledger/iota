...
-  [Public Functions](#@Public_Functions_0)
    -  [`bitwise_not`](#std_u128_bitwise_not)
    -  [`diff`](#std_u128_diff)
    -  [`divide_and_round_up`](#std_u128_divide_and_round_up)
    -  [`do` (macro)](#std_u128_do)
    -  [`do_eq` (macro)](#std_u128_do_eq)
    -  [`max`](#std_u128_max)
    -  [`max_value` (macro)](#std_u128_max_value)
    -  [`min`](#std_u128_min)
    -  [`pow`](#std_u128_pow)
    -  [`range_do` (macro)](#std_u128_range_do)
    -  [`range_do_eq` (macro)](#std_u128_range_do_eq)
    -  [`sqrt`](#std_u128_sqrt)
    -  [`to_string`](#std_u128_to_string)
    -  [`try_as_u16`](#std_u128_try_as_u16)
    -  [`try_as_u32`](#std_u128_try_as_u32)
    -  [`try_as_u64`](#std_u128_try_as_u64)
    -  [`try_as_u8`](#std_u128_try_as_u8)
