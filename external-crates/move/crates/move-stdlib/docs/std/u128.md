...
-  [Module Functions](#@Module_Functions_0)
    -  [<span class="move-vis move-vis-public">pub</span> `bitwise_not`](#std_u128_bitwise_not)
    -  [<span class="move-vis move-vis-public">pub</span> `diff`](#std_u128_diff)
    -  [<span class="move-vis move-vis-public">pub</span> `divide_and_round_up`](#std_u128_divide_and_round_up)
    -  [<span class="move-vis move-vis-public">pub</span> `do` (macro)](#std_u128_do)
    -  [<span class="move-vis move-vis-public">pub</span> `do_eq` (macro)](#std_u128_do_eq)
    -  [<span class="move-vis move-vis-public">pub</span> `max`](#std_u128_max)
    -  [<span class="move-vis move-vis-public">pub</span> `max_value` (macro)](#std_u128_max_value)
    -  [<span class="move-vis move-vis-public">pub</span> `min`](#std_u128_min)
    -  [<span class="move-vis move-vis-public">pub</span> `pow`](#std_u128_pow)
    -  [<span class="move-vis move-vis-public">pub</span> `range_do` (macro)](#std_u128_range_do)
    -  [<span class="move-vis move-vis-public">pub</span> `range_do_eq` (macro)](#std_u128_range_do_eq)
    -  [<span class="move-vis move-vis-public">pub</span> `sqrt`](#std_u128_sqrt)
    -  [<span class="move-vis move-vis-public">pub</span> `to_string`](#std_u128_to_string)
    -  [<span class="move-vis move-vis-public">pub</span> `try_as_u16`](#std_u128_try_as_u16)
    -  [<span class="move-vis move-vis-public">pub</span> `try_as_u32`](#std_u128_try_as_u32)
    -  [<span class="move-vis move-vis-public">pub</span> `try_as_u64`](#std_u128_try_as_u64)
    -  [<span class="move-vis move-vis-public">pub</span> `try_as_u8`](#std_u128_try_as_u8)
...
### <span class="move-vis move-vis-public">pub</span> `sqrt`
