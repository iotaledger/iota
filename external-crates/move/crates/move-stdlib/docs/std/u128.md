...
-  [Module Functions](#@Module_Functions_0)
    -  [`bitwise_not` <span class="move-vis move-vis-public">pub</span>](#std_u128_bitwise_not)
    -  [`diff` <span class="move-vis move-vis-public">pub</span>](#std_u128_diff)
    -  [`divide_and_round_up` <span class="move-vis move-vis-public">pub</span>](#std_u128_divide_and_round_up)
    -  [`do` (macro) <span class="move-vis move-vis-public">pub</span>](#std_u128_do)
    -  [`do_eq` (macro) <span class="move-vis move-vis-public">pub</span>](#std_u128_do_eq)
    -  [`max` <span class="move-vis move-vis-public">pub</span>](#std_u128_max)
    -  [`max_value` (macro) <span class="move-vis move-vis-public">pub</span>](#std_u128_max_value)
    -  [`min` <span class="move-vis move-vis-public">pub</span>](#std_u128_min)
    -  [`pow` <span class="move-vis move-vis-public">pub</span>](#std_u128_pow)
    -  [`range_do` (macro) <span class="move-vis move-vis-public">pub</span>](#std_u128_range_do)
    -  [`range_do_eq` (macro) <span class="move-vis move-vis-public">pub</span>](#std_u128_range_do_eq)
    -  [`sqrt` <span class="move-vis move-vis-public">pub</span>](#std_u128_sqrt)
    -  [`to_string` <span class="move-vis move-vis-public">pub</span>](#std_u128_to_string)
    -  [`try_as_u16` <span class="move-vis move-vis-public">pub</span>](#std_u128_try_as_u16)
    -  [`try_as_u32` <span class="move-vis move-vis-public">pub</span>](#std_u128_try_as_u32)
    -  [`try_as_u64` <span class="move-vis move-vis-public">pub</span>](#std_u128_try_as_u64)
    -  [`try_as_u8` <span class="move-vis move-vis-public">pub</span>](#std_u128_try_as_u8)
...
### `sqrt` <span class="move-vis move-vis-public">pub</span>
