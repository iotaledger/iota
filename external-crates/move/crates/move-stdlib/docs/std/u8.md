...
-  [Module Functions](#@Module_Functions_0)
    -  [<span class="move-vis move-vis-public">pub</span> `bitwise_not`](#std_u8_bitwise_not)
    -  [<span class="move-vis move-vis-public">pub</span> `diff`](#std_u8_diff)
    -  [<span class="move-vis move-vis-public">pub</span> `divide_and_round_up`](#std_u8_divide_and_round_up)
    -  [<span class="move-vis move-vis-public">pub</span> `do` (macro)](#std_u8_do)
    -  [<span class="move-vis move-vis-public">pub</span> `do_eq` (macro)](#std_u8_do_eq)
    -  [<span class="move-vis move-vis-public">pub</span> `max`](#std_u8_max)
    -  [<span class="move-vis move-vis-public">pub</span> `max_value` (macro)](#std_u8_max_value)
    -  [<span class="move-vis move-vis-public">pub</span> `min`](#std_u8_min)
    -  [<span class="move-vis move-vis-public">pub</span> `pow`](#std_u8_pow)
    -  [<span class="move-vis move-vis-public">pub</span> `range_do` (macro)](#std_u8_range_do)
    -  [<span class="move-vis move-vis-public">pub</span> `range_do_eq` (macro)](#std_u8_range_do_eq)
    -  [<span class="move-vis move-vis-public">pub</span> `sqrt`](#std_u8_sqrt)
    -  [<span class="move-vis move-vis-public">pub</span> `to_string`](#std_u8_to_string)
