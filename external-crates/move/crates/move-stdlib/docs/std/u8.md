...
-  [Module Functions](#@Module_Functions_0)
    -  [`bitwise_not` <span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span>](#std_u8_bitwise_not)
    -  [`diff` <span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span>](#std_u8_diff)
    -  [`divide_and_round_up` <span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span>](#std_u8_divide_and_round_up)
    -  [`do` (macro) <span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span>](#std_u8_do)
    -  [`do_eq` (macro) <span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span>](#std_u8_do_eq)
    -  [`max` <span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span>](#std_u8_max)
    -  [`max_value` (macro) <span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span>](#std_u8_max_value)
    -  [`min` <span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span>](#std_u8_min)
    -  [`pow` <span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span>](#std_u8_pow)
    -  [`range_do` (macro) <span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span>](#std_u8_range_do)
    -  [`range_do_eq` (macro) <span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span>](#std_u8_range_do_eq)
    -  [`sqrt` <span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span>](#std_u8_sqrt)
    -  [`to_string` <span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span>](#std_u8_to_string)
