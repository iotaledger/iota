...
-  [Public Functions](#@Public_Functions_0)
    -  [`bitwise_not`](#std_u8_bitwise_not)
    -  [`diff`](#std_u8_diff)
    -  [`divide_and_round_up`](#std_u8_divide_and_round_up)
    -  [`do` (macro)](#std_u8_do)
    -  [`do_eq` (macro)](#std_u8_do_eq)
    -  [`max`](#std_u8_max)
    -  [`max_value` (macro)](#std_u8_max_value)
    -  [`min`](#std_u8_min)
    -  [`pow`](#std_u8_pow)
    -  [`range_do` (macro)](#std_u8_range_do)
    -  [`range_do_eq` (macro)](#std_u8_range_do_eq)
    -  [`sqrt`](#std_u8_sqrt)
    -  [`to_string`](#std_u8_to_string)
