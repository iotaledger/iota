...
-  [Structs](#@Structs_1)
    -  [<span class="move-vis move-vis-struct">struct</span> `String`](#std_string_String)
        ...
        -  [<span class="move-vis move-vis-public">pub</span> `append_utf8`](#std_string_append_utf8)
        -  [<span class="move-vis move-vis-public">pub</span> `as_bytes`](#std_string_as_bytes)
        -  [<span class="move-vis move-vis-public">pub</span> `bytes`](#std_string_bytes)
        -  [<span class="move-vis move-vis-public">pub</span> `index_of`](#std_string_index_of)
        -  [<span class="move-vis move-vis-public">pub</span> `insert`](#std_string_insert)
        -  [<span class="move-vis move-vis-public">pub</span> `into_bytes`](#std_string_into_bytes)
        -  [<span class="move-vis move-vis-public">pub</span> `is_empty`](#std_string_is_empty)
        -  [<span class="move-vis move-vis-public">pub</span> `length`](#std_string_length)
        -  [<span class="move-vis move-vis-public">pub</span> `sub_string`](#std_string_sub_string)
        -  [<span class="move-vis move-vis-public">pub</span> `substring`](#std_string_substring)
        -  [<span class="move-vis move-vis-public">pub</span> `to_ascii`](#std_string_to_ascii)
-  [Constants](#@Constants_2)
    -  [<span class="move-vis move-vis-error">err</span> `EInvalidUTF8`](#std_string_EInvalidUTF8)
    -  [<span class="move-vis move-vis-error">err</span> `EInvalidIndex`](#std_string_EInvalidIndex)
...
#### <span class="move-vis move-vis-public">pub</span> `append_utf8`
...
#### <span class="move-vis move-vis-public">pub</span> `bytes`
...
#### <span class="move-vis move-vis-public">pub</span> `sub_string`
...
#### <span class="move-vis move-vis-public">pub</span> `to_ascii`
...
### <span class="move-vis move-vis-error">err</span> `EInvalidUTF8`
