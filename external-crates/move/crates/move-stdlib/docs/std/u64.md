...
-  [Public Functions](#@Public_Functions_0)
    -  [`bitwise_not`](#std_u64_bitwise_not)
    -  [`diff`](#std_u64_diff)
    -  [`divide_and_round_up`](#std_u64_divide_and_round_up)
    -  [`do` (macro)](#std_u64_do)
    -  [`do_eq` (macro)](#std_u64_do_eq)
    -  [`max`](#std_u64_max)
    -  [`max_value` (macro)](#std_u64_max_value)
    -  [`min`](#std_u64_min)
    -  [`pow`](#std_u64_pow)
    -  [`range_do` (macro)](#std_u64_range_do)
    -  [`range_do_eq` (macro)](#std_u64_range_do_eq)
    -  [`sqrt`](#std_u64_sqrt)
    -  [`to_string`](#std_u64_to_string)
    -  [`try_as_u16`](#std_u64_try_as_u16)
    -  [`try_as_u32`](#std_u64_try_as_u32)
    -  [`try_as_u8`](#std_u64_try_as_u8)
