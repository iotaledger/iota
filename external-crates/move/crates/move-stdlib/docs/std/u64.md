...
-  [Module Functions](#@Module_Functions_0)
    -  [`bitwise_not` <span class="move-vis move-vis-public">pub</span>](#std_u64_bitwise_not)
    -  [`diff` <span class="move-vis move-vis-public">pub</span>](#std_u64_diff)
    -  [`divide_and_round_up` <span class="move-vis move-vis-public">pub</span>](#std_u64_divide_and_round_up)
    -  [`do` (macro) <span class="move-vis move-vis-public">pub</span>](#std_u64_do)
    -  [`do_eq` (macro) <span class="move-vis move-vis-public">pub</span>](#std_u64_do_eq)
    -  [`max` <span class="move-vis move-vis-public">pub</span>](#std_u64_max)
    -  [`max_value` (macro) <span class="move-vis move-vis-public">pub</span>](#std_u64_max_value)
    -  [`min` <span class="move-vis move-vis-public">pub</span>](#std_u64_min)
    -  [`pow` <span class="move-vis move-vis-public">pub</span>](#std_u64_pow)
    -  [`range_do` (macro) <span class="move-vis move-vis-public">pub</span>](#std_u64_range_do)
    -  [`range_do_eq` (macro) <span class="move-vis move-vis-public">pub</span>](#std_u64_range_do_eq)
    -  [`sqrt` <span class="move-vis move-vis-public">pub</span>](#std_u64_sqrt)
    -  [`to_string` <span class="move-vis move-vis-public">pub</span>](#std_u64_to_string)
    -  [`try_as_u16` <span class="move-vis move-vis-public">pub</span>](#std_u64_try_as_u16)
    -  [`try_as_u32` <span class="move-vis move-vis-public">pub</span>](#std_u64_try_as_u32)
    -  [`try_as_u8` <span class="move-vis move-vis-public">pub</span>](#std_u64_try_as_u8)
