...
-  [Module Functions](#@Module_Functions_0)
    -  [`bitwise_not` <span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span>](#std_u32_bitwise_not)
    -  [`diff` <span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span>](#std_u32_diff)
    -  [`divide_and_round_up` <span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span>](#std_u32_divide_and_round_up)
    -  [`do` (macro) <span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span>](#std_u32_do)
    -  [`do_eq` (macro) <span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span>](#std_u32_do_eq)
    -  [`max` <span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span>](#std_u32_max)
    -  [`max_value` (macro) <span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span>](#std_u32_max_value)
    -  [`min` <span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span>](#std_u32_min)
    -  [`pow` <span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span>](#std_u32_pow)
    -  [`range_do` (macro) <span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span>](#std_u32_range_do)
    -  [`range_do_eq` (macro) <span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span>](#std_u32_range_do_eq)
    -  [`sqrt` <span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span>](#std_u32_sqrt)
    -  [`to_string` <span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span>](#std_u32_to_string)
    -  [`try_as_u16` <span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span>](#std_u32_try_as_u16)
    -  [`try_as_u8` <span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span>](#std_u32_try_as_u8)
