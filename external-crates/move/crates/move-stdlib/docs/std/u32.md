...
-  [Module Functions](#@Module_Functions_0)
    -  [<span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span> `bitwise_not`](#std_u32_bitwise_not)
    -  [<span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span> `diff`](#std_u32_diff)
    -  [<span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span> `divide_and_round_up`](#std_u32_divide_and_round_up)
    -  [<span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span> `do` (macro)](#std_u32_do)
    -  [<span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span> `do_eq` (macro)](#std_u32_do_eq)
    -  [<span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span> `max`](#std_u32_max)
    -  [<span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span> `max_value` (macro)](#std_u32_max_value)
    -  [<span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span> `min`](#std_u32_min)
    -  [<span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span> `pow`](#std_u32_pow)
    -  [<span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span> `range_do` (macro)](#std_u32_range_do)
    -  [<span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span> `range_do_eq` (macro)](#std_u32_range_do_eq)
    -  [<span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span> `sqrt`](#std_u32_sqrt)
    -  [<span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span> `to_string`](#std_u32_to_string)
    -  [<span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span> `try_as_u16`](#std_u32_try_as_u16)
    -  [<span class="move-vis move-vis-public">pub</span> <span class="move-vis move-vis-module">module</span> `try_as_u8`](#std_u32_try_as_u8)
