...
-  [Public Functions](#@Public_Functions_0)
    -  [`bitwise_not`](#std_u32_bitwise_not)
    -  [`max`](#std_u32_max)
    -  [`min`](#std_u32_min)
    -  [`diff`](#std_u32_diff)
    -  [`divide_and_round_up`](#std_u32_divide_and_round_up)
    -  [`pow`](#std_u32_pow)
    -  [`sqrt`](#std_u32_sqrt)
    -  [`try_as_u8`](#std_u32_try_as_u8)
    -  [`try_as_u16`](#std_u32_try_as_u16)
    -  [`to_string`](#std_u32_to_string)
    -  [`max_value` (macro)](#std_u32_max_value)
    -  [`range_do` (macro)](#std_u32_range_do)
    -  [`range_do_eq` (macro)](#std_u32_range_do_eq)
    -  [`do` (macro)](#std_u32_do)
    -  [`do_eq` (macro)](#std_u32_do_eq)
