...
pkg_b = { local = "../pkg_b" }"#,
    ...
    /// This test creates a git repository with a Move package, and another
    /// package that depends on this package as a git dependency. It then
    /// tests the following
    ...
    /// - updating the git dependency in the manifest and re-pinning works as
    ///   expected, including
