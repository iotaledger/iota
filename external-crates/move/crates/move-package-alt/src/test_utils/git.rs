...
//!         .file(
//!             "sources/dep1.move",
//!             r#"module dep1::dep1 { public fun f() { } }"#,
//!         )
//! });
//!
...
//!     .file(
//!         "sources/a.move",
//!         "module a::a { public fun t() { dep1::f(); } }",
//!     )
//!     .build();
//! ```
//!
...
//! tags), you can use `git2::Repository::open()` to open the repository and
//! then use some of the helper functions in this file to interact with the
//! repository.
...
pub fn commits(repo: &git2::Repository) -> Vec<git2::Commit<'_>> {
