...
/// Create a project to run tests against but you need to add a manifest either
/// via basic_manifest or through your own content.
///
/// To get started, see:
/// - [`project`]
#[must_use]
...
impl Project {
    /// Try to get the git commits in the project, but it will panic if this is
