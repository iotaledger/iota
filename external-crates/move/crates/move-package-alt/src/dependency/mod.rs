...
/// Replace all dependencies with their pinned versions. The returned map is
/// guaranteed to have the same keys as [deps].
// TODO: this needs to change to support the fact that external resolvers return
