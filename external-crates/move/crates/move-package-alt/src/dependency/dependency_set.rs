...
// TODO: the API for this type is a bit of a historical artifact - it used to
// also have a notion of default dependencies and do merging. We now do that
// much earlier in the process. So this type could potentially safely expose
// more of its implementation to get a cleaner API

/// A set of all dependencies for a package - keyed by the package's
/// environments and the package names.
///
/// For convenience, iteration produces (EnvironmentName, PackageName, T)
/// triples
