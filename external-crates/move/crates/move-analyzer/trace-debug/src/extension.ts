 ...
 * was generated by the replay tool, it will return `undefined` as there
 ...
 * Returns `undefined` if thrace file was generated by the replay tool as in this case
 * trace info is ignored by the runtime.
 *
 * @param tracePath path to the trace file.
 * @returns string of the form `<package>::<module>::<function_name>` if trace
 * file was generated from a unit test, `undefined` if the trace file was
 * generated by the replay tool.
