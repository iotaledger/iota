...
// keep sizedness of integers in the serialized form and do not need a type
// layout in order to be deserialized into an annotated value.
//---------------------------------------------------------------------------
...
/// A simplified representation of Move values (that in particular drops integer
/// sizing information as this is lost during the serialization/deserialization
/// process to json).
