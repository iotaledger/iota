...
pub struct BuildConfig {
    ...
    /// Flags controlling how documentation is generated when
    /// `generate_docs` is enabled. Not exposed via the CLI; consumers
    /// driving the build programmatically can override the defaults.
    #[clap(skip)]
...
impl BuildConfig {
    ...
    /// Indicates if the package was built with configurations that mean it may
    /// be published, i.e., it was not built in test mode or similar.
