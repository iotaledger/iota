...
def run_experiment():
    """Runs the non-triangle stress test."""
    print(f"\n{'='*60}")
    print("=== Starting Non-Triangle Stress Test ===")
    print(f"{'='*60}\n")
    ...
    print("=== Finished Non-Triangle Stress Test ===")
...
def main():
    parser = argparse.ArgumentParser(description="Run Non-Triangle Stress Test")
    ...
    print("\nNon-triangle stress run completed.")
