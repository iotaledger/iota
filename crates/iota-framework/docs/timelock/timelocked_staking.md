...
<pre><code><b>public</b> entry <b>fun</b> <a href="timelocked_staking.md#0x10cf_timelocked_staking_request_add_stake">request_add_stake</a>(
    ...
    <a href="timelocked_staked_iota.md#0x10cf_timelocked_staked_iota_self_transfer">timelocked_staked_iota::self_transfer</a>(<a href="timelocked_staked_iota.md#0x10cf_timelocked_staked_iota">timelocked_staked_iota</a>, ctx);
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="timelocked_staking.md#0x10cf_timelocked_staking_request_add_stake_mul_bal">request_add_stake_mul_bal</a>(
    ...
    <b>while</b> (i &lt; len) {
        ...
        // Transfer the receipt <b>to</b> the sender.
        <a href="timelocked_staked_iota.md#0x10cf_timelocked_staked_iota_self_transfer">timelocked_staked_iota::self_transfer</a>(receipt, ctx);
