...
-  or you can call <code>receive</code> in other models to receive a <code><Link to="basic_output#0x107a_basic_output_BasicOutput">BasicOutput</Link></code>.
...
Since <code><Link to="basic_output#0x107a_basic_output_BasicOutput">BasicOutput</Link></code> only has <code>key</code>, it can not be received via <code>public_receive</code>.
