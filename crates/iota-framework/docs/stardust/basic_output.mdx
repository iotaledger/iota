...
store ability and there is no custom transfer function:
-  you can call 
extract_assets,
-  or you can call 
receive in other models to receive a 
<Link to="basic_output#0x107a_basic_output_BasicOutput">BasicOutput</Link>.
...
tag: <Link to="../move-stdlib/option#0x1_option_Option">option::Option</Link>&lt;<Link to="../move-stdlib/vector#0x1_vector">vector</Link>&lt;u8&gt;&gt;
</dt>
<dd>
 The tag feature.
</dd>
...
- The 
StorageDepositReturnUnlockCondition will return the deposit.
...
Since 
<Link to="basic_output#0x107a_basic_output_BasicOutput">BasicOutput</Link> only has 
key, it can not be received via 
public_receive.
