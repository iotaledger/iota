...
orders: <Link to="../move-stdlib/vector#0x1_vector">vector</Link>&lt;<Link to="clob_v2#0xdee9_clob_v2_Order">clob_v2::Order</Link>&gt;
</dt>
<dd>
...
next_tick_level: <Link to="../move-stdlib/option#0x1_option_Option">option::Option</Link>&lt;u64&gt;
</dt>
<dd>
...
next_order_id: <Link to="../move-stdlib/option#0x1_option_Option">option::Option</Link>&lt;u64&gt;
</dt>
<dd>
