...
<dt>
<code>owner: <Link to="../iota-framework/object#0x2_object_ID">object::ID</Link></code>
</dt>
<dd>
...
<dt>
<code>open_orders: <Link to="../iota-framework/linked_table#0x2_linked_table_LinkedTable">linked_table::LinkedTable</Link>&lt;u64, <Link to="clob#0xdee9_clob_Order">clob::Order</Link>&gt;</code>
</dt>
<dd>
...
<dt>
<code>bids: <Link to="critbit#0xdee9_critbit_CritbitTree">critbit::CritbitTree</Link>&lt;<Link to="clob#0xdee9_clob_TickLevel">clob::TickLevel</Link>&gt;</code>
</dt>
<dd>

</dd>
<dt>
<code>asks: <Link to="critbit#0xdee9_critbit_CritbitTree">critbit::CritbitTree</Link>&lt;<Link to="clob#0xdee9_clob_TickLevel">clob::TickLevel</Link>&gt;</code>
</dt>
<dd>
...
<dt>
<code>usr_open_orders: <Link to="../iota-framework/table#0x2_table_Table">table::Table</Link>&lt;<Link to="../iota-framework/object#0x2_object_ID">object::ID</Link>, <Link to="../iota-framework/linked_table#0x2_linked_table_LinkedTable">linked_table::LinkedTable</Link>&lt;u64, u64&gt;&gt;</code>
</dt>
<dd>
...
<dt>
<code>base_custodian: <Link to="custodian#0xdee9_custodian_Custodian">custodian::Custodian</Link>&lt;BaseAsset&gt;</code>
</dt>
<dd>

</dd>
<dt>
<code>quote_custodian: <Link to="custodian#0xdee9_custodian_Custodian">custodian::Custodian</Link>&lt;QuoteAsset&gt;</code>
</dt>
<dd>
...
Deprecated since v1.0.0, use <code><Link to="clob#0xdee9_clob_OrderPlacedV2">OrderPlacedV2</Link></code> instead.
...
Deprecated since v1.0.0, use <code><Link to="clob#0xdee9_clob_OrderFilledV2">OrderFilledV2</Link></code> instead.
