...
owner: <Link to="../iota-framework/object#0x2_object_ID">object::ID</Link>
</dt>
<dd>
 object ID of the 
...
open_orders: <Link to="../iota-framework/linked_table#0x2_linked_table_LinkedTable">linked_table::LinkedTable</Link>&lt;u64, <Link to="clob#0xdee9_clob_Order">clob::Order</Link>&gt;
</dt>
<dd>
...
bids: <Link to="critbit#0xdee9_critbit_CritbitTree">critbit::CritbitTree</Link>&lt;<Link to="clob#0xdee9_clob_TickLevel">clob::TickLevel</Link>&gt;
</dt>
<dd>
...
asks: <Link to="critbit#0xdee9_critbit_CritbitTree">critbit::CritbitTree</Link>&lt;<Link to="clob#0xdee9_clob_TickLevel">clob::TickLevel</Link>&gt;
</dt>
<dd>
...
usr_open_orders: <Link to="../iota-framework/table#0x2_table_Table">table::Table</Link>&lt;<Link to="../iota-framework/object#0x2_object_ID">object::ID</Link>, <Link to="../iota-framework/linked_table#0x2_linked_table_LinkedTable">linked_table::LinkedTable</Link>&lt;u64, u64&gt;&gt;
</dt>
<dd>
...
base_custodian: <Link to="custodian#0xdee9_custodian_Custodian">custodian::Custodian</Link>&lt;BaseAsset&gt;
</dt>
<dd>
...
quote_custodian: <Link to="custodian#0xdee9_custodian_Custodian">custodian::Custodian</Link>&lt;QuoteAsset&gt;
</dt>
<dd>
...
Deprecated since v1.0.0, use 
<Link to="clob#0xdee9_clob_OrderPlacedV2">OrderPlacedV2</Link> instead.
...
Deprecated since v1.0.0, use 
<Link to="clob#0xdee9_clob_OrderFilledV2">OrderFilledV2</Link> instead.
