...
pool_id: <Link to="../iota-framework/object#0x2_object_ID">object::ID</Link>
</dt>
<dd>
...
base_asset: <Link to="../move-stdlib/type_name#0x1_type_name_TypeName">type_name::TypeName</Link>
</dt>
<dd>
...
quote_asset: <Link to="../move-stdlib/type_name#0x1_type_name_TypeName">type_name::TypeName</Link>
</dt>
<dd>
...
<dd>
 owner ID of the 
AccountCap that placed the order
</dd>
<dt>
...
<dd>
 owner ID of the 
AccountCap that canceled the order
</dd>
<dt>
...
orders_canceled: <Link to="../move-stdlib/vector#0x1_vector">vector</Link>&lt;<Link to="clob_v2#0xdee9_clob_v2_AllOrdersCanceledComponent">clob_v2::AllOrdersCanceledComponent</Link>&lt;BaseAsset, QuoteAsset&gt;&gt;
</dt>
<dd>
...
<dd>
 owner ID of the 
AccountCap that filled the order
</dd>
<dt>
...
AccountCap that deposit the asset
</dd>
</dl>
...
<dd>
 owner ID of the 
AccountCap that withdrew the asset
</dd>
</dl>
...
<dd>
 Order can only be canceled by the 
AccountCap with this owner ID
</dd>
<dt>
...
open_orders: <Link to="../iota-framework/linked_table#0x2_linked_table_LinkedTable">linked_table::LinkedTable</Link>&lt;u64, <Link to="clob_v2#0xdee9_clob_v2_Order">clob_v2::Order</Link>&gt;
</dt>
<dd>
...
bids: <Link to="critbit#0xdee9_critbit_CritbitTree">critbit::CritbitTree</Link>&lt;<Link to="clob_v2#0xdee9_clob_v2_TickLevel">clob_v2::TickLevel</Link>&gt;
</dt>
<dd>
...
asks: <Link to="critbit#0xdee9_critbit_CritbitTree">critbit::CritbitTree</Link>&lt;<Link to="clob_v2#0xdee9_clob_v2_TickLevel">clob_v2::TickLevel</Link>&gt;
</dt>
<dd>
...
usr_open_orders: <Link to="../iota-framework/table#0x2_table_Table">table::Table</Link>&lt;<b>address</b>, <Link to="../iota-framework/linked_table#0x2_linked_table_LinkedTable">linked_table::LinkedTable</Link>&lt;u64, u64&gt;&gt;
</dt>
<dd>
...
base_custodian: <Link to="custodian_v2#0xdee9_custodian_v2_Custodian">custodian_v2::Custodian</Link>&lt;BaseAsset&gt;
</dt>
<dd>
...
quote_custodian: <Link to="custodian_v2#0xdee9_custodian_v2_Custodian">custodian_v2::Custodian</Link>&lt;QuoteAsset&gt;
</dt>
<dd>
...
creation_fee: <Link to="../iota-framework/balance#0x2_balance_Balance">balance::Balance</Link>&lt;<Link to="../iota-framework/iota#0x2_iota_IOTA">iota::IOTA</Link>&gt;
</dt>
<dd>
...
base_asset_trading_fees: <Link to="../iota-framework/balance#0x2_balance_Balance">balance::Balance</Link>&lt;BaseAsset&gt;
</dt>
<dd>
...
quote_asset_trading_fees: <Link to="../iota-framework/balance#0x2_balance_Balance">balance::Balance</Link>&lt;QuoteAsset&gt;
</dt>
<dd>
...
Capability granting permission to access an entry in 
<Link to="clob_v2#0xdee9_clob_v2_Pool">Pool</Link>.quote_asset_trading_fees.
