...
<dt>
<code>internal_nodes: <Link to="../iota-framework/table#0x2_table_Table">table::Table</Link>&lt;u64, <Link to="critbit#0xdee9_critbit_InternalNode">critbit::InternalNode</Link>&gt;</code>
</dt>
<dd>

</dd>
<dt>
<code>leaves: <Link to="../iota-framework/table#0x2_table_Table">table::Table</Link>&lt;u64, <Link to="critbit#0xdee9_critbit_Leaf">critbit::Leaf</Link>&lt;V&gt;&gt;</code>
</dt>
<dd>
