...
internal_nodes: <Link to="../iota-framework/table#0x2_table_Table">table::Table</Link>&lt;u64, <Link to="critbit#0xdee9_critbit_InternalNode">critbit::InternalNode</Link>&gt;
</dt>
<dd>
...
leaves: <Link to="../iota-framework/table#0x2_table_Table">table::Table</Link>&lt;u64, <Link to="critbit#0xdee9_critbit_Leaf">critbit::Leaf</Link>&lt;V&gt;&gt;
</dt>
<dd>
