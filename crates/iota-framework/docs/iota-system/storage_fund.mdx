...
<dl>
<dt>
<code>total_object_storage_rebates: <Link to="../iota-framework/balance#0x2_balance_Balance">balance::Balance</Link>&lt;<Link to="../iota-framework/iota#0x2_iota_IOTA">iota::IOTA</Link>&gt;</code>
</dt>
<dd>

</dd>
<dt>
<code>non_refundable_balance: <Link to="../iota-framework/balance#0x2_balance_Balance">balance::Balance</Link>&lt;<Link to="../iota-framework/iota#0x2_iota_IOTA">iota::IOTA</Link>&gt;</code>
</dt>
<dd>
...
Called by <code><Link to="iota_system#0x3_iota_system">iota_system</Link></code> at genesis time.
...
Called by <code><Link to="iota_system#0x3_iota_system">iota_system</Link></code> at epoch change times to process the inflows and outflows of storage fund.
