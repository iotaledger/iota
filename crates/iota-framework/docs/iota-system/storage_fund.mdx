...
Struct representing the storage fund, containing two 
Balances:
- 
total_object_storage_rebates has the invariant that it's the sum of 
storage_rebate of
all objects currently stored on-chain. To maintain this invariant, the only inflow of this
balance is storage charges collected from transactions, and the only outflow is storage rebates
of transactions, including both the portion refunded to the transaction senders as well as
the non-refundable portion taken out and put into 
...
total_object_storage_rebates: <Link to="../iota-framework/balance#0x2_balance_Balance">balance::Balance</Link>&lt;<Link to="../iota-framework/iota#0x2_iota_IOTA">iota::IOTA</Link>&gt;
</dt>
<dd>
...
non_refundable_balance: <Link to="../iota-framework/balance#0x2_balance_Balance">balance::Balance</Link>&lt;<Link to="../iota-framework/iota#0x2_iota_IOTA">iota::IOTA</Link>&gt;
</dt>
<dd>
...
Called by 
<Link to="iota_system#0x3_iota_system">iota_system</Link> at genesis time.
...
Called by 
<Link to="iota_system#0x3_iota_system">iota_system</Link> at epoch change times to process the inflows and outflows of storage fund.
