...
-  [Function `convert_to_fungible_staked_iota`](#0x3_iota_system_convert_to_fungible_staked_iota)
-  [Function `redeem_fungible_staked_iota`](#0x3_iota_system_redeem_fungible_staked_iota)
...
-  [Function `validator_address_by_pool_id`](#0x3_iota_system_validator_address_by_pool_id)
...
<a name="0x3_iota_system_convert_to_fungible_staked_iota"></a>
...
<pre><code><b>public</b> <b>fun</b> <a href="iota_system.md#0x3_iota_system_convert_to_fungible_staked_iota">convert_to_fungible_staked_iota</a>(
    wrapper: &<b>mut</b> <a href="iota_system.md#0x3_iota_system_IotaSystemState">IotaSystemState</a>,
    staked_iota: StakedIota,
    ctx: &<b>mut</b> TxContext,
): FungibleStakedIota {
    <b>let</b> self = <a href="iota_system.md#0x3_iota_system_load_system_state_mut">load_system_state_mut</a>(wrapper);
    self.<a href="iota_system.md#0x3_iota_system_convert_to_fungible_staked_iota">convert_to_fungible_staked_iota</a>(staked_iota, ctx)
}
</code></pre>
...
<a name="0x3_iota_system_redeem_fungible_staked_iota"></a>
...
<pre><code><b>public</b> <b>fun</b> <a href="iota_system.md#0x3_iota_system_redeem_fungible_staked_iota">redeem_fungible_staked_iota</a>(wrapper: &<b>mut</b> <a href="iota_system.md#0x3_iota_system_IotaSystemState">iota_system::IotaSystemState</a>, fungible_staked_iota: <a href="staking_pool.md#0x3_staking_pool_FungibleStakedIota">staking_pool::FungibleStakedIota</a>, ctx: &<a href="../iota-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): <a href="../iota-framework/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="../iota-framework/iota.md#0x2_iota_IOTA">iota::IOTA</a>&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="iota_system.md#0x3_iota_system_redeem_fungible_staked_iota">redeem_fungible_staked_iota</a>(
    wrapper: &<b>mut</b> <a href="iota_system.md#0x3_iota_system_IotaSystemState">IotaSystemState</a>,
    fungible_staked_iota: FungibleStakedIota,
    ctx: &TxContext,
): Balance&lt;IOTA&gt; {
    <b>let</b> self = <a href="iota_system.md#0x3_iota_system_load_system_state_mut">load_system_state_mut</a>(wrapper);
    self.<a href="iota_system.md#0x3_iota_system_redeem_fungible_staked_iota">redeem_fungible_staked_iota</a>(fungible_staked_iota, ctx)
}
</code></pre>
...
<a name="0x3_iota_system_validator_address_by_pool_id"></a>

## Function `validator_address_by_pool_id`



<pre><code><b>public</b> <b>fun</b> <a href="iota_system.md#0x3_iota_system_validator_address_by_pool_id">validator_address_by_pool_id</a>(wrapper: &<b>mut</b> <a href="iota_system.md#0x3_iota_system_IotaSystemState">iota_system::IotaSystemState</a>, pool_id: &<a href="../iota-framework/object.md#0x2_object_ID">object::ID</a>): <b>address</b>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="iota_system.md#0x3_iota_system_validator_address_by_pool_id">validator_address_by_pool_id</a>(wrapper: &<b>mut</b> <a href="iota_system.md#0x3_iota_system_IotaSystemState">IotaSystemState</a>, pool_id: &ID): <b>address</b> {
    <b>let</b> self = <a href="iota_system.md#0x3_iota_system_load_system_state_mut">load_system_state_mut</a>(wrapper);
    self.<a href="iota_system.md#0x3_iota_system_validator_address_by_pool_id">validator_address_by_pool_id</a>(pool_id)
}
</code></pre>
