...
<dt>
<code>exchange_rates: <a href="../iota-framework/table.md#0x2_table_Table">table::Table</a>&lt;u64, <a href="staking_pool.md#0x3_staking_pool_PoolTokenExchangeRate">staking_pool::PoolTokenExchangeRate</a>&gt;</code>
</dt>
<dd>
...
<pre><code><b>const</b> <a href="staking_pool.md#0x3_staking_pool_EDelegationOfZeroIota">EDelegationOfZeroIota</a>: u64 = 17;
</code></pre>
...
<pre><code><b>const</b> <a href="staking_pool.md#0x3_staking_pool_EIncompatibleStakedIota">EIncompatibleStakedIota</a>: u64 = 12;
</code></pre>
...
<pre><code><b>const</b> <a href="staking_pool.md#0x3_staking_pool_EStakedIotaBelowThreshold">EStakedIotaBelowThreshold</a>: u64 = 18;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_iota_balance">iota_balance</a>(pool: &<a href="staking_pool.md#0x3_staking_pool_StakingPool">staking_pool::StakingPool</a>): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_iota_balance">iota_balance</a>(pool: &<a href="staking_pool.md#0x3_staking_pool_StakingPool">StakingPool</a>): u64 { pool.iota_balance }
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_staked_iota_amount">staked_iota_amount</a>(staked_iota: &<a href="staking_pool.md#0x3_staking_pool_StakedIota">staking_pool::StakedIota</a>): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_staked_iota_amount">staked_iota_amount</a>(staked_iota: &<a href="staking_pool.md#0x3_staking_pool_StakedIota">StakedIota</a>): u64 { staked_iota.principal.value() }
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_stake_activation_epoch">stake_activation_epoch</a>(staked_iota: &<a href="staking_pool.md#0x3_staking_pool_StakedIota">staking_pool::StakedIota</a>): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_stake_activation_epoch">stake_activation_epoch</a>(staked_iota: &<a href="staking_pool.md#0x3_staking_pool_StakedIota">StakedIota</a>): u64 {
...
<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_split">split</a>(self: &<b>mut</b> <a href="staking_pool.md#0x3_staking_pool_StakedIota">staking_pool::StakedIota</a>, split_amount: u64, ctx: &<b>mut</b> <a href="../iota-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): <a href="staking_pool.md#0x3_staking_pool_StakedIota">staking_pool::StakedIota</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_split">split</a>(self: &<b>mut</b> <a href="staking_pool.md#0x3_staking_pool_StakedIota">StakedIota</a>, split_amount: u64, ctx: &<b>mut</b> TxContext): <a href="staking_pool.md#0x3_staking_pool_StakedIota">StakedIota</a> {
...
<pre><code><b>public</b> entry <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_split_staked_iota">split_staked_iota</a>(stake: &<b>mut</b> <a href="staking_pool.md#0x3_staking_pool_StakedIota">StakedIota</a>, split_amount: u64, ctx: &<b>mut</b> TxContext) {
...
<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_iota_amount">iota_amount</a>(exchange_rate: &<a href="staking_pool.md#0x3_staking_pool_PoolTokenExchangeRate">staking_pool::PoolTokenExchangeRate</a>): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_iota_amount">iota_amount</a>(exchange_rate: &<a href="staking_pool.md#0x3_staking_pool_PoolTokenExchangeRate">PoolTokenExchangeRate</a>): u64 {
...
<pre><code><b>fun</b> <a href="staking_pool.md#0x3_staking_pool_get_iota_amount">get_iota_amount</a>(exchange_rate: &<a href="staking_pool.md#0x3_staking_pool_PoolTokenExchangeRate">staking_pool::PoolTokenExchangeRate</a>, token_amount: u64): u64
</code></pre>
...
<pre><code><b>fun</b> <a href="staking_pool.md#0x3_staking_pool_get_iota_amount">get_iota_amount</a>(exchange_rate: &<a href="staking_pool.md#0x3_staking_pool_PoolTokenExchangeRate">PoolTokenExchangeRate</a>, token_amount: u64): u64 {
...
<pre><code><b>fun</b> <a href="staking_pool.md#0x3_staking_pool_get_token_amount">get_token_amount</a>(exchange_rate: &<a href="staking_pool.md#0x3_staking_pool_PoolTokenExchangeRate">staking_pool::PoolTokenExchangeRate</a>, iota_amount: u64): u64
</code></pre>
...
<pre><code><b>fun</b> <a href="staking_pool.md#0x3_staking_pool_get_token_amount">get_token_amount</a>(exchange_rate: &<a href="staking_pool.md#0x3_staking_pool_PoolTokenExchangeRate">PoolTokenExchangeRate</a>, iota_amount: u64): u64 {
    // When either amount is 0, that means we have no stakes <b>with</b> this pool.
    // The other amount might be non-zero when there's dust left in the pool.
    <b>if</b> (exchange_rate.iota_amount == 0 || exchange_rate.pool_token_amount == 0) {
