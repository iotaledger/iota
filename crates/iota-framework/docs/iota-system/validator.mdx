...
image_url: <Link to="../iota-framework/url#0x2_url_Url">url::Url</Link>
</dt>
<dd>
...
project_url: <Link to="../iota-framework/url#0x2_url_Url">url::Url</Link>
</dt>
<dd>
...
net_address: <Link to="../move-stdlib/string#0x1_string_String">string::String</Link>
</dt>
<dd>
...
next_epoch_protocol_pubkey_bytes: <Link to="../move-stdlib/option#0x1_option_Option">option::Option</Link>&lt;<Link to="../move-stdlib/vector#0x1_vector">vector</Link>&lt;u8&gt;&gt;
</dt>
<dd>
...
next_epoch_proof_of_possession: <Link to="../move-stdlib/option#0x1_option_Option">option::Option</Link>&lt;<Link to="../move-stdlib/vector#0x1_vector">vector</Link>&lt;u8&gt;&gt;
</dt>
<dd>
...
next_epoch_network_pubkey_bytes: <Link to="../move-stdlib/option#0x1_option_Option">option::Option</Link>&lt;<Link to="../move-stdlib/vector#0x1_vector">vector</Link>&lt;u8&gt;&gt;
</dt>
<dd>
...
next_epoch_worker_pubkey_bytes: <Link to="../move-stdlib/option#0x1_option_Option">option::Option</Link>&lt;<Link to="../move-stdlib/vector#0x1_vector">vector</Link>&lt;u8&gt;&gt;
</dt>
<dd>
...
next_epoch_net_address: <Link to="../move-stdlib/option#0x1_option_Option">option::Option</Link>&lt;<Link to="../move-stdlib/string#0x1_string_String">string::String</Link>&gt;
</dt>
<dd>
...
next_epoch_p2p_address: <Link to="../move-stdlib/option#0x1_option_Option">option::Option</Link>&lt;<Link to="../move-stdlib/string#0x1_string_String">string::String</Link>&gt;
</dt>
<dd>
...
next_epoch_primary_address: <Link to="../move-stdlib/option#0x1_option_Option">option::Option</Link>&lt;<Link to="../move-stdlib/string#0x1_string_String">string::String</Link>&gt;
</dt>
<dd>
...
next_epoch_worker_address: <Link to="../move-stdlib/option#0x1_option_Option">option::Option</Link>&lt;<Link to="../move-stdlib/string#0x1_string_String">string::String</Link>&gt;
</dt>
<dd>
...
metadata: <Link to="validator#0x3_validator_ValidatorMetadata">validator::ValidatorMetadata</Link>
</dt>
<dd>
...
operation_cap_id: <Link to="../iota-framework/object#0x2_object_ID">object::ID</Link>
</dt>
<dd>
...
<Link to="staking_pool#0x3_staking_pool">staking_pool</Link>: <Link to="staking_pool#0x3_staking_pool_StakingPool">staking_pool::StakingPool</Link>
</dt>
<dd>
...
Create a new 
UnverifiedValidatorOperationCap, transfer to the validator,
...
Create a new validator from the given 
<Link to="validator#0x3_validator_ValidatorMetadata">ValidatorMetadata</Link>, called by both 
new and 
new_for_testing.
