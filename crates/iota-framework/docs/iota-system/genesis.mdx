...
protocol_public_key: <Link to="../move-stdlib/vector#0x1_vector">vector</Link>&lt;u8&gt;
</dt>
<dd>
...
network_public_key: <Link to="../move-stdlib/vector#0x1_vector">vector</Link>&lt;u8&gt;
</dt>
<dd>
...
worker_public_key: <Link to="../move-stdlib/vector#0x1_vector">vector</Link>&lt;u8&gt;
</dt>
<dd>
...
allocations: <Link to="../move-stdlib/vector#0x1_vector">vector</Link>&lt;<Link to="genesis#0x3_genesis_TokenAllocation">genesis::TokenAllocation</Link>&gt;
</dt>
<dd>
...
staked_with_validator: <Link to="../move-stdlib/option#0x1_option_Option">option::Option</Link>&lt;<b>address</b>&gt;
</dt>
<dd>
...
staked_with_timelock_expiration: <Link to="../move-stdlib/option#0x1_option_Option">option::Option</Link>&lt;u64&gt;
</dt>
<dd>
...
The 
create function was called at a non-genesis epoch.
...
The 
create function was called with duplicate validators.
...
The 
create function was called with wrong pre-minted supply.
