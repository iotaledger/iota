...
staked_iota: <Link to="staking_pool#0x3_staking_pool_StakedIota">staking_pool::StakedIota</Link>
</dt>
<dd>
...
The non-entry version of 
request_add_stake, which returns the time-locked staked IOTA instead of transferring it to the sender.
...
Non-entry version of 
request_withdraw_stake that returns the withdrawn time-locked IOTA and reward
...
Split 
<Link to="timelocked_staking#0x3_timelocked_staking_TimelockedStakedIota">TimelockedStakedIota</Link> into two parts, one with principal 
split_amount,
and the remaining principal is left in 
self.
All the other parameters of the 
<Link to="timelocked_staking#0x3_timelocked_staking_TimelockedStakedIota">TimelockedStakedIota</Link> like 
...
Split the given 
<Link to="timelocked_staking#0x3_timelocked_staking_TimelockedStakedIota">TimelockedStakedIota</Link> to the two parts, one with principal 
split_amount,
...
A utility function to transfer multiple 
<Link to="timelocked_staking#0x3_timelocked_staking_TimelockedStakedIota">TimelockedStakedIota</Link>.
...
Function to get the pool id of a 
<Link to="timelocked_staking#0x3_timelocked_staking_TimelockedStakedIota">TimelockedStakedIota</Link>.
...
Function to get the staked iota amount of a 
<Link to="timelocked_staking#0x3_timelocked_staking_TimelockedStakedIota">TimelockedStakedIota</Link>.
...
Function to get the stake activation epoch of a 
<Link to="timelocked_staking#0x3_timelocked_staking_TimelockedStakedIota">TimelockedStakedIota</Link>.
...
Check if a 
<Link to="timelocked_staking#0x3_timelocked_staking_TimelockedStakedIota">TimelockedStakedIota</Link> is labeled with the type 
L.
...
A utility function to destroy a 
<Link to="timelocked_staking#0x3_timelocked_staking_TimelockedStakedIota">TimelockedStakedIota</Link>.
...
A utility function to transfer a 
<Link to="timelocked_staking#0x3_timelocked_staking_TimelockedStakedIota">TimelockedStakedIota</Link> to a receiver.
...
A utility function to transfer a vector of 
<Link to="timelocked_staking#0x3_timelocked_staking_TimelockedStakedIota">TimelockedStakedIota</Link> to a receiver.
