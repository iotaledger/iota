...
<pre><code><b>fun</b> <a href="../iota-framework/random.md#0x2_random_load_inner_mut">load_inner_mut</a>(self: &<b>mut</b> <a href="../iota-framework/random.md#0x2_random_Random">Random</a>): &<b>mut</b> <a href="../iota-framework/random.md#0x2_random_RandomInner">RandomInner</a> {
...
<pre><code><b>fun</b> <a href="../iota-framework/random.md#0x2_random_load_inner">load_inner</a>(self: &<a href="../iota-framework/random.md#0x2_random_Random">Random</a>): &<a href="../iota-framework/random.md#0x2_random_RandomInner">RandomInner</a> {
    <b>let</b> version = <a href="../iota-framework/versioned.md#0x2_versioned_version">versioned::version</a>(&self.inner);
