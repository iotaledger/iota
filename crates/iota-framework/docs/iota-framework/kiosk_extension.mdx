...
<code><Link to="kiosk_extension#0x2_kiosk_extension">kiosk_extension</Link></code> module, as it gives certain benefits such as using <code>Kiosk</code>
...
- <code><Link to="kiosk_extension#0x2_kiosk_extension">kiosk_extension</Link></code> is a friend module to <code><Link to="kiosk#0x2_kiosk">kiosk</Link></code> and has access to its
...
configuration for this extension. Stored under the <code><Link to="kiosk_extension#0x2_kiosk_extension_ExtensionKey">ExtensionKey</Link></code>
dynamic field.
...
<dl>
<dt>
<code>storage: <Link to="bag#0x2_bag_Bag">bag::Bag</Link></code>
</dt>
<dd>
...
The <code><Link to="kiosk_extension#0x2_kiosk_extension_ExtensionKey">ExtensionKey</Link></code> is a typed dynamic field key used to store the
