...
(e.g., <code><Link to="../iota-framework/address#0x2_address_to_u256">to_u256</Link>(0x1) == 1</code>)
...
Convert <code>n</code> into an address by encoding it as a big-endian integer (e.g., <code><Link to="../iota-framework/address#0x2_address_from_u256">from_u256</Link>(1) = @0x1</code>)
...
Aborts with <code><Link to="../iota-framework/address#0x2_address_EAddressParseError">EAddressParseError</Link></code> if the length of <code>bytes</code> is not 32
...
Aborts with <code><Link to="../iota-framework/address#0x2_address_EAddressParseError">EAddressParseError</Link></code> if the length of <code>s</code> is not 64,
