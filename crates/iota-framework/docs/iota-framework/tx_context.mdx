...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/tx_context.md#0x2_tx_context_epoch">epoch</a>(self: &<a href="../iota-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/tx_context.md#0x2_tx_context_epoch">epoch</a>(self: &<a href="../iota-framework/tx_context.md#0x2_tx_context_TxContext">TxContext</a>): u64 {
    self.epoch
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/tx_context.md#0x2_tx_context_epoch_timestamp_ms">epoch_timestamp_ms</a>(self: &<a href="../iota-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/tx_context.md#0x2_tx_context_epoch_timestamp_ms">epoch_timestamp_ms</a>(self: &<a href="../iota-framework/tx_context.md#0x2_tx_context_TxContext">TxContext</a>): u64 {
...
<pre><code><b>fun</b> <a href="../iota-framework/tx_context.md#0x2_tx_context_ids_created">ids_created</a>(self: &<a href="../iota-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): u64
</code></pre>
...
<pre><code><b>fun</b> <a href="../iota-framework/tx_context.md#0x2_tx_context_ids_created">ids_created</a>(self: &<a href="../iota-framework/tx_context.md#0x2_tx_context_TxContext">TxContext</a>): u64 {
    self.ids_created
}
</code></pre>
...
<pre><code><b>fun</b> <a href="../iota-framework/tx_context.md#0x2_tx_context_derive_id">derive_id</a>(tx_hash: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;, ids_created: u64): <b>address</b>
</code></pre>
...
<pre><code><b>native</b> <b>fun</b> <a href="../iota-framework/tx_context.md#0x2_tx_context_derive_id">derive_id</a>(tx_hash: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;, ids_created: u64): <b>address</b>;
</code></pre>
