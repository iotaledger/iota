...
<dl>
<dt>
<code>contents: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;<a href="../iota-framework/vec_map.md#0x2_vec_map_Entry">vec_map::Entry</a>&lt;K, V&gt;&gt;</code>
</dt>
<dd>
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/vec_map.md#0x2_vec_map_empty">empty</a>&lt;K: <b>copy</b>, V&gt;(): <a href="../iota-framework/vec_map.md#0x2_vec_map_VecMap">VecMap</a>&lt;K, V&gt; {
    <a href="../iota-framework/vec_map.md#0x2_vec_map_VecMap">VecMap</a> { contents: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>[] }
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/vec_map.md#0x2_vec_map_insert">insert</a>&lt;K: <b>copy</b>, V&gt;(self: &<b>mut</b> <a href="../iota-framework/vec_map.md#0x2_vec_map_VecMap">VecMap</a>&lt;K, V&gt;, key: K, value: V) {
    <b>assert</b>!(!self.<a href="../iota-framework/vec_map.md#0x2_vec_map_contains">contains</a>(&key), <a href="../iota-framework/vec_map.md#0x2_vec_map_EKeyAlreadyExists">EKeyAlreadyExists</a>);
    self.contents.push_back(<a href="../iota-framework/vec_map.md#0x2_vec_map_Entry">Entry</a> { key, value })
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/vec_map.md#0x2_vec_map_remove">remove</a>&lt;K: <b>copy</b>, V&gt;(self: &<b>mut</b> <a href="../iota-framework/vec_map.md#0x2_vec_map_VecMap">VecMap</a>&lt;K, V&gt;, key: &K): (K, V) {
    <b>let</b> idx = self.<a href="../iota-framework/vec_map.md#0x2_vec_map_get_idx">get_idx</a>(key);
    <b>let</b> <a href="../iota-framework/vec_map.md#0x2_vec_map_Entry">Entry</a> { key, value } = self.contents.<a href="../iota-framework/vec_map.md#0x2_vec_map_remove">remove</a>(idx);
    (key, value)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/vec_map.md#0x2_vec_map_pop">pop</a>&lt;K: <b>copy</b>, V&gt;(self: &<b>mut</b> <a href="../iota-framework/vec_map.md#0x2_vec_map_VecMap">VecMap</a>&lt;K, V&gt;): (K, V) {
    <b>assert</b>!(self.contents.length() != 0, <a href="../iota-framework/vec_map.md#0x2_vec_map_EMapEmpty">EMapEmpty</a>);
    <b>let</b> <a href="../iota-framework/vec_map.md#0x2_vec_map_Entry">Entry</a> { key, value } = self.contents.pop_back();
    (key, value)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/vec_map.md#0x2_vec_map_get_mut">get_mut</a>&lt;K: <b>copy</b>, V&gt;(self: &<b>mut</b> <a href="../iota-framework/vec_map.md#0x2_vec_map_VecMap">VecMap</a>&lt;K, V&gt;, key: &K): &<b>mut</b> V {
    <b>let</b> idx = self.<a href="../iota-framework/vec_map.md#0x2_vec_map_get_idx">get_idx</a>(key);
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/vec_map.md#0x2_vec_map_get">get</a>&lt;K: <b>copy</b>, V&gt;(self: &<a href="../iota-framework/vec_map.md#0x2_vec_map_VecMap">VecMap</a>&lt;K, V&gt;, key: &K): &V {
    <b>let</b> idx = self.<a href="../iota-framework/vec_map.md#0x2_vec_map_get_idx">get_idx</a>(key);
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/vec_map.md#0x2_vec_map_try_get">try_get</a>&lt;K: <b>copy</b>, V: <b>copy</b>&gt;(self: &<a href="../iota-framework/vec_map.md#0x2_vec_map_VecMap">VecMap</a>&lt;K, V&gt;, key: &K): Option&lt;V&gt; {
    <b>if</b> (self.<a href="../iota-framework/vec_map.md#0x2_vec_map_contains">contains</a>(key)) {
        <a href="../move-stdlib/option.md#0x1_option_some">option::some</a>(*<a href="../iota-framework/vec_map.md#0x2_vec_map_get">get</a>(self, key))
    } <b>else</b> {
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/vec_map.md#0x2_vec_map_contains">contains</a>&lt;K: <b>copy</b>, V&gt;(self: &<a href="../iota-framework/vec_map.md#0x2_vec_map_VecMap">VecMap</a>&lt;K, V&gt;, key: &K): bool {
    <a href="../iota-framework/vec_map.md#0x2_vec_map_get_idx_opt">get_idx_opt</a>(self, key).is_some()
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/vec_map.md#0x2_vec_map_size">size</a>&lt;K: <b>copy</b>, V&gt;(self: &<a href="../iota-framework/vec_map.md#0x2_vec_map_VecMap">VecMap</a>&lt;K, V&gt;): <a href="../move-stdlib/u64.md#0x1_u64">u64</a> {
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/vec_map.md#0x2_vec_map_is_empty">is_empty</a>&lt;K: <b>copy</b>, V&gt;(self: &<a href="../iota-framework/vec_map.md#0x2_vec_map_VecMap">VecMap</a>&lt;K, V&gt;): bool {
    self.<a href="../iota-framework/vec_map.md#0x2_vec_map_size">size</a>() == 0
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/vec_map.md#0x2_vec_map_destroy_empty">destroy_empty</a>&lt;K: <b>copy</b>, V&gt;(self: <a href="../iota-framework/vec_map.md#0x2_vec_map_VecMap">VecMap</a>&lt;K, V&gt;) {
    <b>let</b> <a href="../iota-framework/vec_map.md#0x2_vec_map_VecMap">VecMap</a> { contents } = self;
    <b>assert</b>!(contents.<a href="../iota-framework/vec_map.md#0x2_vec_map_is_empty">is_empty</a>(), <a href="../iota-framework/vec_map.md#0x2_vec_map_EMapNotEmpty">EMapNotEmpty</a>);
    contents.<a href="../iota-framework/vec_map.md#0x2_vec_map_destroy_empty">destroy_empty</a>()
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/vec_map.md#0x2_vec_map_into_keys_values">into_keys_values</a>&lt;K: <b>copy</b>, V&gt;(self: <a href="../iota-framework/vec_map.md#0x2_vec_map_VecMap">VecMap</a>&lt;K, V&gt;): (<a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;K&gt;, <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;V&gt;) {
    <b>let</b> <a href="../iota-framework/vec_map.md#0x2_vec_map_VecMap">VecMap</a> { <b>mut</b> contents } = self;
    ...
    <b>while</b> (i &lt; n) {
        <b>let</b> <a href="../iota-framework/vec_map.md#0x2_vec_map_Entry">Entry</a> { key, value } = contents.pop_back();
        keys.push_back(key);
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/vec_map.md#0x2_vec_map_from_keys_values">from_keys_values</a>&lt;K: <b>copy</b>, V&gt;(<b>mut</b> keys: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;K&gt;, <b>mut</b> values: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;V&gt;): <a href="../iota-framework/vec_map.md#0x2_vec_map_VecMap">VecMap</a>&lt;K, V&gt; {
    <b>assert</b>!(keys.length() == values.length(), <a href="../iota-framework/vec_map.md#0x2_vec_map_EUnequalLengths">EUnequalLengths</a>);
    keys.reverse();
    values.reverse();
    <b>let</b> <b>mut</b> map = <a href="../iota-framework/vec_map.md#0x2_vec_map_empty">empty</a>();
    <b>while</b> (keys.length() != 0) map.<a href="../iota-framework/vec_map.md#0x2_vec_map_insert">insert</a>(keys.pop_back(), values.pop_back());
    keys.<a href="../iota-framework/vec_map.md#0x2_vec_map_destroy_empty">destroy_empty</a>();
    values.<a href="../iota-framework/vec_map.md#0x2_vec_map_destroy_empty">destroy_empty</a>();
    map
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/vec_map.md#0x2_vec_map_keys">keys</a>&lt;K: <b>copy</b>, V&gt;(self: &<a href="../iota-framework/vec_map.md#0x2_vec_map_VecMap">VecMap</a>&lt;K, V&gt;): <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;K&gt; {
    <b>let</b> <b>mut</b> i = 0;
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/vec_map.md#0x2_vec_map_get_idx_opt">get_idx_opt</a>&lt;K: <b>copy</b>, V&gt;(self: &<a href="../iota-framework/vec_map.md#0x2_vec_map_VecMap">VecMap</a>&lt;K, V&gt;, key: &K): Option&lt;<a href="../move-stdlib/u64.md#0x1_u64">u64</a>&gt; {
    <b>let</b> <b>mut</b> i = 0;
    <b>let</b> n = <a href="../iota-framework/vec_map.md#0x2_vec_map_size">size</a>(self);
    <b>while</b> (i &lt; n) {
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/vec_map.md#0x2_vec_map_get_idx">get_idx</a>&lt;K: <b>copy</b>, V&gt;(self: &<a href="../iota-framework/vec_map.md#0x2_vec_map_VecMap">VecMap</a>&lt;K, V&gt;, key: &K): <a href="../move-stdlib/u64.md#0x1_u64">u64</a> {
    <b>let</b> idx_opt = self.<a href="../iota-framework/vec_map.md#0x2_vec_map_get_idx_opt">get_idx_opt</a>(key);
    <b>assert</b>!(idx_opt.is_some(), <a href="../iota-framework/vec_map.md#0x2_vec_map_EKeyDoesNotExist">EKeyDoesNotExist</a>);
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/vec_map.md#0x2_vec_map_get_entry_by_idx">get_entry_by_idx</a>&lt;K: <b>copy</b>, V&gt;(self: &<a href="../iota-framework/vec_map.md#0x2_vec_map_VecMap">VecMap</a>&lt;K, V&gt;, idx: <a href="../move-stdlib/u64.md#0x1_u64">u64</a>): (&K, &V) {
    <b>assert</b>!(idx &lt; <a href="../iota-framework/vec_map.md#0x2_vec_map_size">size</a>(self), <a href="../iota-framework/vec_map.md#0x2_vec_map_EIndexOutOfBounds">EIndexOutOfBounds</a>);
    <b>let</b> entry = &self.contents[idx];
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/vec_map.md#0x2_vec_map_get_entry_by_idx_mut">get_entry_by_idx_mut</a>&lt;K: <b>copy</b>, V&gt;(self: &<b>mut</b> <a href="../iota-framework/vec_map.md#0x2_vec_map_VecMap">VecMap</a>&lt;K, V&gt;, idx: <a href="../move-stdlib/u64.md#0x1_u64">u64</a>): (&K, &<b>mut</b> V) {
    <b>assert</b>!(idx &lt; <a href="../iota-framework/vec_map.md#0x2_vec_map_size">size</a>(self), <a href="../iota-framework/vec_map.md#0x2_vec_map_EIndexOutOfBounds">EIndexOutOfBounds</a>);
    <b>let</b> entry = &<b>mut</b> self.contents[idx];
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/vec_map.md#0x2_vec_map_remove_entry_by_idx">remove_entry_by_idx</a>&lt;K: <b>copy</b>, V&gt;(self: &<b>mut</b> <a href="../iota-framework/vec_map.md#0x2_vec_map_VecMap">VecMap</a>&lt;K, V&gt;, idx: <a href="../move-stdlib/u64.md#0x1_u64">u64</a>): (K, V) {
    <b>assert</b>!(idx &lt; <a href="../iota-framework/vec_map.md#0x2_vec_map_size">size</a>(self), <a href="../iota-framework/vec_map.md#0x2_vec_map_EIndexOutOfBounds">EIndexOutOfBounds</a>);
    <b>let</b> <a href="../iota-framework/vec_map.md#0x2_vec_map_Entry">Entry</a> { key, value } = self.contents.<a href="../iota-framework/vec_map.md#0x2_vec_map_remove">remove</a>(idx);
    (key, value)
}
