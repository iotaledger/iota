...
<pre><code>
<b>const</b> <a href="../iota-framework/hex.md#0x2_hex_EInvalidHexLength">EInvalidHexLength</a>: u64 = 0;
</code></pre>
...
<pre><code>
<b>const</b> <a href="../iota-framework/hex.md#0x2_hex_ENotValidHexCharacter">ENotValidHexCharacter</a>: u64 = 1;
</code></pre>
...
<pre><code>
<b>public</b> <b>fun</b> <a href="../iota-framework/hex.md#0x2_hex_encode">encode</a>(bytes: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;): <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;
</code></pre>
...
<pre><code>
<b>public</b> <b>fun</b> <a href="../iota-framework/hex.md#0x2_hex_decode">decode</a>(<a href="../iota-framework/hex.md#0x2_hex">hex</a>: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;): <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;
</code></pre>
...
<pre><code>
<b>fun</b> <a href="../iota-framework/hex.md#0x2_hex_decode_byte">decode_byte</a>(<a href="../iota-framework/hex.md#0x2_hex">hex</a>: u8): u8
</code></pre>
...
<pre><code>
<b>fun</b> <a href="../iota-framework/hex.md#0x2_hex_decode_byte">decode_byte</a>(<a href="../iota-framework/hex.md#0x2_hex">hex</a>: u8): u8 \{
    <b>if</b> (/* 0 .. 9 */ 48 &lt;= <a href="../iota-framework/hex.md#0x2_hex">hex</a> && <a href="../iota-framework/hex.md#0x2_hex">hex</a> &lt; 58) \{
        <a href="../iota-framework/hex.md#0x2_hex">hex</a> - 48
    } <b>else</b> <b>if</b> (/* A .. F */ 65 &lt;= <a href="../iota-framework/hex.md#0x2_hex">hex</a> && <a href="../iota-framework/hex.md#0x2_hex">hex</a> &lt; 71) \{
        10 + <a href="../iota-framework/hex.md#0x2_hex">hex</a> - 65
    } <b>else</b> <b>if</b> (/* a .. f */ 97 &lt;= <a href="../iota-framework/hex.md#0x2_hex">hex</a> && <a href="../iota-framework/hex.md#0x2_hex">hex</a> &lt; 103) \{
