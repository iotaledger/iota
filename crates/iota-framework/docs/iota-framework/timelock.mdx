...
<code><Link to="../iota-framework/timelock#0x2_timelock_TimeLock">TimeLock</Link></code> struct that holds a locked object.
...
<code><Link to="../iota-framework/timelock#0x2_timelock_SystemTimelockCap">SystemTimelockCap</Link></code> allows to <code>pack</code> and <code>unpack</code> TimeLocks
...
Function to unlock the object from a <code><Link to="../iota-framework/timelock#0x2_timelock_TimeLock">TimeLock</Link></code>.
...
Join two <code><Link to="../iota-framework/timelock#0x2_timelock_TimeLock">TimeLock</Link>&lt;Balance&lt;T&gt;&gt;</code> together.
...
Split a <code><Link to="../iota-framework/timelock#0x2_timelock_TimeLock">TimeLock</Link>&lt;Balance&lt;T&gt;&gt;</code> and take a sub balance from it.
...
Split the given <code><Link to="../iota-framework/timelock#0x2_timelock_TimeLock">TimeLock</Link>&lt;Balance&lt;T&gt;&gt;</code> into two parts, one with principal <code>value</code>,
...
A utility function to transfer a <code><Link to="../iota-framework/timelock#0x2_timelock_TimeLock">TimeLock</Link></code> to the sender.
...
A utility function to pack a <code><Link to="../iota-framework/timelock#0x2_timelock_TimeLock">TimeLock</Link></code> that can be invoked only by a system package.
...
An utility function to unpack a <code><Link to="../iota-framework/timelock#0x2_timelock_TimeLock">TimeLock</Link></code> that can be invoked only by a system package.
...
Function to get the expiration timestamp of a <code><Link to="../iota-framework/timelock#0x2_timelock_TimeLock">TimeLock</Link></code>.
...
Function to check if a <code><Link to="../iota-framework/timelock#0x2_timelock_TimeLock">TimeLock</Link></code> is locked.
...
Function to get the remaining time of a <code><Link to="../iota-framework/timelock#0x2_timelock_TimeLock">TimeLock</Link></code>.
...
Function to get the locked object of a <code><Link to="../iota-framework/timelock#0x2_timelock_TimeLock">TimeLock</Link></code>.
...
Function to get the label of a <code><Link to="../iota-framework/timelock#0x2_timelock_TimeLock">TimeLock</Link></code>.
...
Check if a <code><Link to="../iota-framework/timelock#0x2_timelock_TimeLock">TimeLock</Link></code> is labeled with the type <code>L</code>.
...
A utility function to pack a <code><Link to="../iota-framework/timelock#0x2_timelock_TimeLock">TimeLock</Link></code>.
...
An utility function to unpack a <code><Link to="../iota-framework/timelock#0x2_timelock_TimeLock">TimeLock</Link></code>.
...
A utility function to transfer a <code><Link to="../iota-framework/timelock#0x2_timelock_TimeLock">TimeLock</Link></code> to a receiver.
...
Create a <code><Link to="../iota-framework/timelock#0x2_timelock_SystemTimelockCap">SystemTimelockCap</Link></code>.
