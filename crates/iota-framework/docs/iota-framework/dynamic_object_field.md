...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/dynamic_object_field.md#0x2_dynamic_object_field_borrow">borrow</a>&lt;Name: <b>copy</b> + drop + store, Value: key + store&gt;(<a href="../iota-framework/object.md#0x2_object">object</a>: &UID, name: Name): &Value {
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/dynamic_object_field.md#0x2_dynamic_object_field_exists_">exists_</a>&lt;Name: <b>copy</b> + drop + store&gt;(<a href="../iota-framework/object.md#0x2_object">object</a>: &UID, name: Name): bool {
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/dynamic_object_field.md#0x2_dynamic_object_field_id">id</a>&lt;Name: <b>copy</b> + drop + store&gt;(<a href="../iota-framework/object.md#0x2_object">object</a>: &UID, name: Name): Option&lt;ID&gt; {
    <b>let</b> key = <a href="../iota-framework/dynamic_object_field.md#0x2_dynamic_object_field_Wrapper">Wrapper</a> { name };
