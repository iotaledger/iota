...
<pre><code>
<b>struct</b> <a href="../iota-framework/smr.md#0x2_smr_SMR">SMR</a> <b>has</b> drop
</code></pre>
...
<pre><code>
<b>const</b> <a href="../iota-framework/smr.md#0x2_smr_ENotSystemAddress">ENotSystemAddress</a>: u64 = 1;
</code></pre>
...
<pre><code>
<b>const</b> <a href="../iota-framework/smr.md#0x2_smr_EAlreadyMinted">EAlreadyMinted</a>: u64 = 0;
</code></pre>
...
<pre><code>
<b>const</b> <a href="../iota-framework/smr.md#0x2_smr_GLOW_PER_SMR">GLOW_PER_SMR</a>: u64 = 1000000;
</code></pre>
...
<pre><code>
<b>const</b> <a href="../iota-framework/smr.md#0x2_smr_TOTAL_SUPPLY_GLOWS">TOTAL_SUPPLY_GLOWS</a>: u64 = 1813620509061365;
</code></pre>
...
<pre><code>
<b>fun</b> <a href="../iota-framework/smr.md#0x2_smr_init">init</a>(witness: <a href="../iota-framework/smr.md#0x2_smr_SMR">smr::SMR</a>, ctx: &<b>mut</b> <a href="../iota-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code>
<b>fun</b> <a href="../iota-framework/smr.md#0x2_smr_init">init</a>(witness: <a href="../iota-framework/smr.md#0x2_smr_SMR">SMR</a>, ctx: &<b>mut</b> TxContext) \{
...
<pre><code>
<b>public</b> entry <b>fun</b> <a href="../iota-framework/transfer.md#0x2_transfer">transfer</a>(c: <a href="../iota-framework/coin.md#0x2_coin_Coin">coin::Coin</a>&lt;<a href="../iota-framework/smr.md#0x2_smr_SMR">smr::SMR</a>&gt;, recipient: <b>address</b>)
</code></pre>
...
<pre><code>
<b>public</b> entry <b>fun</b> <a href="../iota-framework/transfer.md#0x2_transfer">transfer</a>(c: <a href="../iota-framework/coin.md#0x2_coin_Coin">coin::Coin</a>&lt;<a href="../iota-framework/smr.md#0x2_smr_SMR">SMR</a>&gt;, recipient: <b>address</b>) \{
