...
Defines the <code><Link to="../iota-framework/deny_list#0x2_deny_list_DenyList">DenyList</Link></code> type. The <code><Link to="../iota-framework/deny_list#0x2_deny_list_DenyList">DenyList</Link></code> shared object is used to restrict access to
...
<dt>
<code>lists: <Link to="../iota-framework/bag#0x2_bag_Bag">bag::Bag</Link></code>
</dt>
<dd>
...
<dt>
<code>denied_count: <Link to="../iota-framework/table#0x2_table_Table">table::Table</Link>&lt;<b>address</b>, u64&gt;</code>
</dt>
<dd>
...
<dt>
<code>denied_addresses: <Link to="../iota-framework/table#0x2_table_Table">table::Table</Link>&lt;<Link to="../move-stdlib/vector#0x1_vector">vector</Link>&lt;u8&gt;, <Link to="../iota-framework/vec_set#0x2_vec_set_VecSet">vec_set::VecSet</Link>&lt;<b>address</b>&gt;&gt;</code>
</dt>
<dd>
...
Aborts with <code><Link to="../iota-framework/deny_list#0x2_deny_list_ENotDenied">ENotDenied</Link></code> if the address is not on the list.
