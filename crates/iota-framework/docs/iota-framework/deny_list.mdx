...
Defines the 
<Link to="../iota-framework/deny_list#0x2_deny_list_DenyList">DenyList</Link> type. The 
<Link to="../iota-framework/deny_list#0x2_deny_list_DenyList">DenyList</Link> shared object is used to restrict access to
...
lists: <Link to="../iota-framework/bag#0x2_bag_Bag">bag::Bag</Link>
</dt>
<dd>
...
denied_count: <Link to="../iota-framework/table#0x2_table_Table">table::Table</Link>&lt;<b>address</b>, u64&gt;
</dt>
<dd>
...
denied_addresses: <Link to="../iota-framework/table#0x2_table_Table">table::Table</Link>&lt;<Link to="../move-stdlib/vector#0x1_vector">vector</Link>&lt;u8&gt;, <Link to="../iota-framework/vec_set#0x2_vec_set_VecSet">vec_set::VecSet</Link>&lt;<b>address</b>&gt;&gt;
</dt>
<dd>
 Set of addresses that are banned for a given type.
 For example with 
iota::coin::Coin: If addresses A and B are banned from using
...
Aborts with 
<Link to="../iota-framework/deny_list#0x2_deny_list_ENotDenied">ENotDenied</Link> if the address is not on the list.
