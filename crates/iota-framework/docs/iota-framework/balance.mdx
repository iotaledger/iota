...
<Link id="0x2_balance"/>
A storable handler for Balances in general. Is used in the 
Coin
module to allow balance operations and can be used to implement
custom coins with 
<Link to="../iota-framework/balance#0x2_balance_Supply">Supply</Link> and 
<Link to="../iota-framework/balance#0x2_balance_Balance">Balance</Link>s.
...
<Link to="../iota-framework/balance#0x2_balance_Balance">Balance</Link>.
...
Get the 
<Link to="../iota-framework/balance#0x2_balance_Supply">Supply</Link> value.
...
Increase supply by 
value and create a new 
<Link to="../iota-framework/balance#0x2_balance_Balance">Balance</Link>&lt;T&gt; with this value.
...
Create a zero 
<Link to="../iota-framework/balance#0x2_balance_Balance">Balance</Link> for type 
T.
...
Split a 
<Link to="../iota-framework/balance#0x2_balance_Balance">Balance</Link> and take a sub balance from it.
...
<Link to="../iota-framework/balance#0x2_balance_Balance">Balance</Link> without increasing the supply.
...
<Link to="../iota-framework/balance#0x2_balance_Balance">Balance</Link> without decreasing the supply.
...
Destroy a 
<Link to="../iota-framework/balance#0x2_balance_Supply">Supply</Link> preventing any further minting and burning.
