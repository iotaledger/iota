...
custom coins with <code><Link to="../iota-framework/balance#0x2_balance_Supply">Supply</Link></code> and <code><Link to="../iota-framework/balance#0x2_balance_Balance">Balance</Link></code>s.
...
Get the amount stored in a <code><Link to="../iota-framework/balance#0x2_balance_Balance">Balance</Link></code>.
...
Get the <code><Link to="../iota-framework/balance#0x2_balance_Supply">Supply</Link></code> value.
...
Increase supply by <code>value</code> and create a new <code><Link to="../iota-framework/balance#0x2_balance_Balance">Balance</Link>&lt;T&gt;</code> with this value.
...
Create a zero <code><Link to="../iota-framework/balance#0x2_balance_Balance">Balance</Link></code> for type <code>T</code>.
...
Split a <code><Link to="../iota-framework/balance#0x2_balance_Balance">Balance</Link></code> and take a sub balance from it.
...
Destroy a zero <code><Link to="../iota-framework/balance#0x2_balance_Balance">Balance</Link></code>.
...
CAUTION: this function creates a <code><Link to="../iota-framework/balance#0x2_balance_Balance">Balance</Link></code> without increasing the supply.
...
CAUTION: this function destroys a <code><Link to="../iota-framework/balance#0x2_balance_Balance">Balance</Link></code> without decreasing the supply.
...
Destroy a <code><Link to="../iota-framework/balance#0x2_balance_Supply">Supply</Link></code> preventing any further minting and burning.
