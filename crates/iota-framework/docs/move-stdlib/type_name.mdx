...
name: <Link to="../move-stdlib/ascii#0x1_ascii_String">ascii::String</Link>
</dt>
<dd>
...
ASCII Character code for the 
c (lowercase c) symbol.
...
Return a value representation of the type 
T.  Package IDs
