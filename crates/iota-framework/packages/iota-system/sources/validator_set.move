...
public(package) fun request_remove_validator(self: &mut ValidatorSetV1, ctx: &TxContext) {
    let validator_address = ctx.sender();
...
fun effectuate_staged_metadata(self: &mut ValidatorSetV1) {
...
fun process_pending_validators(self: &mut ValidatorSetV1, new_epoch: u64) {
