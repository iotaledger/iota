...
module iota_system::voting_power {
    ...
    fun init_voting_power_info(
        ...
        validators.select_do_ref!(committee_members, |validator_index, validator| {
    ...
    public(package) fun total_committee_stake(validators: &vector<ValidatorV1>, committee_members: &vector<u64>): u64 {
        validators.select_fold_ref!(committee_members, 0, |stake, _, validator| stake + validator.total_stake())
    }
    ...
    fun check_invariants(committee_members: &vector<u64>, validators: &vector<ValidatorV1>) {
        ...
        let total_voting_power = validators.select_fold_ref!(committee_members, 0, |total, _, v| total + v.voting_power());
