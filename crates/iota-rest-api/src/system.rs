...
use iota_sdk_2::types::{Address, ObjectId, PublicKeyExt};
...
pub struct ValidatorSummary {
    // Metadata
    pub address: Address,
    pub authority_public_key: iota_sdk_2::types::Bls12381PublicKey,
    pub network_public_key: iota_sdk_2::types::Ed25519PublicKey,
    pub protocol_public_key: iota_sdk_2::types::Ed25519PublicKey,
    ...
    pub next_epoch_authority_public_key: Option<iota_sdk_2::types::Bls12381PublicKey>,
    pub next_epoch_network_public_key: Option<iota_sdk_2::types::Ed25519PublicKey>,
    pub next_epoch_protocol_public_key: Option<iota_sdk_2::types::Ed25519PublicKey>,
    ...
    for ValidatorSummary
{
    fn from(
        ...
        Self {
            ...
            authority_public_key: iota_sdk_2::types::Bls12381PublicKey::from_bytes(
                authority_pubkey_bytes,
            )
            .unwrap(),
            network_public_key: iota_sdk_2::types::Ed25519PublicKey::from_bytes(network_pubkey_bytes)
                .unwrap(),
            protocol_public_key: iota_sdk_2::types::Ed25519PublicKey::from_bytes(
                protocol_pubkey_bytes,
            )
            .unwrap(),
            proof_of_possession_bytes,
            ...
            next_epoch_authority_public_key: next_epoch_authority_pubkey_bytes
                .map(|bytes| iota_sdk_2::types::Bls12381PublicKey::from_bytes(bytes).unwrap()),
            next_epoch_network_public_key: next_epoch_network_pubkey_bytes
                .map(|bytes| iota_sdk_2::types::Ed25519PublicKey::from_bytes(bytes).unwrap()),
