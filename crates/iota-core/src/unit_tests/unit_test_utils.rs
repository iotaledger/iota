...
use iota_types::{
    base_types::{ObjectId, TransactionDigest, address_from_pub_key},
    crypto::{
...
async fn init_genesis(
    ...
    for i in 0..committee_size {
        ...
        let validator_info = ValidatorInfo {
            ...
            account_address: address_from_pub_key(&account_key_pair.public()),
        ...
        let pop = generate_proof_of_possession(
            &authority_key_pair,
            address_from_pub_key(&account_key_pair.public()),
        );
