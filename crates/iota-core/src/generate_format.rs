...
use iota_types::{
    ...
    effects::{
        IDOperation, ObjectIn, ObjectOut, TransactionEffects, TransactionEffectsAPIForTesting,
...
fn get_registry() -> Result<Registry> {
    ...
    let sample_effects = TransactionEffects::empty_for_testing(TransactionDigest::default());
