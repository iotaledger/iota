...
impl IndexStoreTables {
    ...
    /// Lists all Column Families that are known about in-code as defined in
    /// `IndexStoreTables`
    fn known_cfs() -> Vec<String> {
        IndexStoreTables::describe_tables().into_keys().collect()
    }

    /// Lists all Column Families that are present on-disk but not known by this
    /// version of code as defined in `IndexStoreTables`
