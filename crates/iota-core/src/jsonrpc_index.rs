...
use iota_types::{
    base_types::{ObjectInfo, ObjectType, TxSequenceNumber},
            ...
            Owner::Object(parent) => {
                ...
                .unwrap_or_else(|e| {
                    error!(
                        ...
                        e, object, ObjectType::from(object)
                    );
                    None
                }) else {
...
mod tests {
    ...
    use iota_sdk_types::{
        Address, CheckpointSummary, GasCostSummary, MoveStruct, ObjectDigest, ObjectId, Owner,
        StructTag, TransactionDigest, TransactionEvents, TypeTag, Version,
    };
    use iota_types::{
