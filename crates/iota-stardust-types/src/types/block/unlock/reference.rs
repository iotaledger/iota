...
/// An [`Unlock`](crate::types::block::unlock::Unlock) that refers to another
/// unlock.
...
impl ReferenceUnlock {
    ...
    pub fn new(index: u16) -> Result<Self, Error> {
        index
            .try_into()
            .map(Self)
            .map_err(Error::InvalidReferenceIndex)
    }
...
pub(crate) mod dto {
    ...
    /// References a previous unlock in order to substitute the duplication of
    /// the same unlock data for inputs which unlock through the same data.
