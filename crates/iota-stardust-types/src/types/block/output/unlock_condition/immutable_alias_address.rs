...
impl ImmutableAliasAddressUnlockCondition {
    ...
    pub fn address(&self) -> &Address {
        ...
        // It has already been validated at construction that the address is an
        // `AliasAddress`.
        debug_assert!(&self.0.is_alias());
        &self.0
    }

    /// Returns the alias address of an
