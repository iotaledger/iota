...
use packable::{Packable, packer::SlicePacker};
...
impl FoundryId {
    ...
    pub fn alias_address(&self) -> AliasAddress {
        ...
        AliasAddress::from(AliasId::new(
            self.0[1..AliasId::LENGTH + 1].try_into().unwrap(),
        ))
    }
    ...
    /// Returns the [`TokenScheme`](crate::types::block::output::TokenScheme)
