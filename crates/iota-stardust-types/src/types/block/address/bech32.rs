...
//! Bech32 encoding/decoding for addresses.
...
impl Hrp {
    ...
    /// Parse a string into an Hrp, returning a Result.
    pub fn from_str_result(hrp: &str) -> Result<Self, Error> {
        hrp.parse()
    }
}
...
#[cfg(feature = "serde")]
impl<'de> serde::Deserialize<'de> for Hrp {
