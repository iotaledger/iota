...
/// Represents the different reasons why a transaction can conflict with the
/// ledger state.
#[repr(u8)]
...
pub enum ConflictReason {
    ...
    /// The semantic validation failed for a reason not covered by the previous
    /// variants.
