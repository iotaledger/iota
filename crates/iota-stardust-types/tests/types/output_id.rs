...
use iota_stardust_types::types::block::{
    Error, output::OutputId, payload::transaction::TransactionId,
};
...
const OUTPUT_ID_INVALID_INDEX: &str =
    "0x52fdfc072182654f163f5f0f9a621d729566c74d10037c4d7bbb0407d1e2c6498000";
...
#[test]
fn try_from_invalid() {
    let output_id_bytes: [u8; OutputId::LENGTH] =
        prefix_hex::decode(OUTPUT_ID_INVALID_INDEX).unwrap();
...
fn pack_unpack_invalid() {
    let bytes = vec![
        ...
        3, 124, 77, 123, 187, 4, 7, 209, 226, 198, 73, 128, 0,
    ];
