...
fn pack_unpack_valid() {
    ...
    .unwrap();
    let mfe_2 =
        MigratedFundsEntry::unpack_verified(mfe_1.pack_to_vec().as_slice(), &protocol_parameters)
            .unwrap();
...
fn pack_unpack_invalid_amount() {
    ...
    let bytes = vec![
        ...
        42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42,
        42, 42, 42, 0, 82, 253, 252, 7, 33, 130, 101, 79, 22, 63, 95, 15, 154, 98, 29, 114, 149,
        102, 199, 77, 16, 3, 124, 77, 123, 187, 4, 7, 209, 226, 198, 73, 42, 42, 42, 42, 42, 42,
        42, 42,
    ];
    ...
    assert!(matches!(
        ...
        Err(UnpackError::Packable(
            Error::InvalidMigratedFundsEntryAmount(3_038_287_259_199_220_266)
        ))
    ));
}
