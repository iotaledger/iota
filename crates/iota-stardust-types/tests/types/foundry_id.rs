...
fn getters() {
    let alias_address = AliasAddress::from(
        AliasId::from_str("0x52fdfc072182654f163f5f0f9a621d729566c74d10037c4d7bbb0407d1e2c649")
            .unwrap(),
    );
    ...
    assert_eq!(
        foundry_id,
        FoundryId::from_str(
            "0x0852fdfc072182654f163f5f0f9a621d729566c74d10037c4d7bbb0407d1e2c6492a00000000"
        )
        .unwrap()
    );
}
