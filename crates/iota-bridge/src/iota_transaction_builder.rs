...
// TODO: this should be hardcoded once we have bridge package on iota framework.
...
pub fn get_iota_token_type_tag(token_id: TokenId) -> TypeTag {
    ...
    if claim {
        builder.programmable_move_call(
            *get_bridge_package_id(),
            ...
            vec![get_iota_token_type_tag(token_type)],
