...
// Devnet values
pub const IOTA_NAMES_PACKAGE: &str =
    "0x20c890da38609db67e2713e6b33b4e4d3c6a8e9f620f9bb48f918d2337e31503";
pub const IOTA_NAMES_OBJECT_ID: &str =
...
pub const REGISTRY_TABLE_ID: &str =
    "0xd48c0a882059036ca8c21dcc8d8bcaefc923aa678f225d3d515b79e3094e5616";
pub const REVERSE_REGISTRY_TABLE_ID: &str =
...
impl NameServiceConfig {
    ...
    pub fn devnet() -> Self {
        const DEVNET_IOTA_NAMES_PACKAGE_ADDRESS: &str = IOTA_NAMES_PACKAGE;
        const DEVNET_IOTA_NAMES_REGISTRY_ID: &str = REGISTRY_TABLE_ID;
        const DEVNET_IOTA_NAMES_REVERSE_REGISTRY_ID: &str = REVERSE_REGISTRY_TABLE_ID;

        let package_address = IotaAddress::from_str(DEVNET_IOTA_NAMES_PACKAGE_ADDRESS).unwrap();
        let registry_id = ObjectID::from_str(DEVNET_IOTA_NAMES_REGISTRY_ID).unwrap();
        let reverse_registry_id =
            ObjectID::from_str(DEVNET_IOTA_NAMES_REVERSE_REGISTRY_ID).unwrap();
