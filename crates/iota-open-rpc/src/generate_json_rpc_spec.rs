...
use iota_json_rpc_api::{
    CoinReadApiOpenRpc, ExtendedApiOpenRpc, GovernanceReadApiOpenRpc, IndexerApiOpenRpc,
    MoveUtilsOpenRpc, ReadApiOpenRpc, TransactionBuilderOpenRpc, WriteApiOpenRpc,
};
...
async fn main() {
    ...
    open_rpc.add_module(ReadApiOpenRpc::module_doc());
    open_rpc.add_module(CoinReadApiOpenRpc::module_doc());
    open_rpc.add_module(IndexerApiOpenRpc::module_doc());
    open_rpc.add_module(WriteApiOpenRpc::module_doc());
    open_rpc.add_module(TransactionBuilderOpenRpc::module_doc());
    open_rpc.add_module(GovernanceReadApiOpenRpc::module_doc());
