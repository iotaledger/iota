...
mod _field_impls {
    ...
    use crate::v0::coin::CoinMetadata;
    #[allow(unused_imports)]
    use crate::v0::coin::CoinMetadataFieldPathBuilder;
    #[allow(unused_imports)]
    use crate::v0::coin::CoinTreasury;
    #[allow(unused_imports)]
    use crate::v0::coin::CoinTreasuryFieldPathBuilder;
    #[allow(unused_imports)]
    use crate::v0::coin::RegulatedCoinMetadata;
    #[allow(unused_imports)]
    use crate::v0::coin::RegulatedCoinMetadataFieldPathBuilder;
    #[allow(unused_imports)]
