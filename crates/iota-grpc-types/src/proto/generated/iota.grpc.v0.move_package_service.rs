        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/iota.grpc.v0.move_package_service.MovePackageService/ListPackageVersions",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "iota.grpc.v0.move_package_service.MovePackageService",
                        "ListPackageVersions",
                    ),
                );
...
pub mod move_package_service_server {
    ...
    pub const SERVICE_NAME: &str = "iota.grpc.v0.move_package_service.MovePackageService";
