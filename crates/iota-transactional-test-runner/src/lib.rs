...
pub trait TransactionalAdapter: Send + Sync + ReadStoreFallible {
...
impl ReadStoreFallible for ValidatorWithFullnode {
...
impl ObjectStoreNonFallible for ValidatorWithFullnode {
