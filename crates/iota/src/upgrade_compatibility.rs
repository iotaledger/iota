...
use move_binary_format::{
    ...
    file_format::{
        AbilitySet, EnumDefinitionIndex, FunctionDefinitionIndex, StructDefinitionIndex,
...
// WARNING: you should add new codes to the END of each category to avoid
...
///
/// A function signature does not match if the number of parameters is
/// different, or if corresponding parameters are different.
