...
| **10. Epoch commit latency**                                           | `checkpoint_db_commit_latency_epoch`                                                                                                               | `≤ 5 sec`                                                            |
| **11. DB Connection Pool Size**                                        | Time in `sec` where `pool_size = 0`.<br><br>`pool_size` is defined as `db_conn_pool_size`                                                          | - **Genesis sync**: `≤ 10 sec` <br><br>- **Post-genesis**: `≤ 5 sec` |
| 12. **JSON RPC latency**                                               | `req_latency_by_route`                                                                                                                             | `≤ 1 second`                                                         |
