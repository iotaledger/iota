...
/// Struct for inserting values into `tx_insertion_order` without providing the
/// `insertion_order` value, which is autogenerated by the database.
#[derive(Clone, Debug, Insertable)]
#[diesel(table_name = tx_insertion_order)]
pub struct NewTxInsertionOrder {
    pub tx_digest: Vec<u8>,
}
