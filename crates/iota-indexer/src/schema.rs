...
diesel::table! {
    optimistic_event_emit_module (package, module, global_sequence_number, event_sequence_number) {
        package -> Bytea,
        module -> Text,
...
diesel::table! {
    optimistic_event_emit_package (package, global_sequence_number, event_sequence_number) {
        package -> Bytea,
        global_sequence_number -> Int8,
        event_sequence_number -> Int8,
        sender -> Bytea,
...
diesel::table! {
    optimistic_event_senders (sender, global_sequence_number, event_sequence_number) {
        sender -> Bytea,
        global_sequence_number -> Int8,
        event_sequence_number -> Int8,
    }
...
diesel::table! {
    optimistic_event_struct_instantiation (package, module, type_instantiation, global_sequence_number, event_sequence_number) {
        package -> Bytea,
        module -> Text,
        type_instantiation -> Text,
        global_sequence_number -> Int8,
...
diesel::table! {
    optimistic_event_struct_module (package, module, global_sequence_number, event_sequence_number) {
        package -> Bytea,
        module -> Text,
        global_sequence_number -> Int8,
        event_sequence_number -> Int8,
...
diesel::table! {
    optimistic_event_struct_name (package, module, type_name, global_sequence_number, event_sequence_number) {
        package -> Bytea,
        module -> Text,
        type_name -> Text,
        global_sequence_number -> Int8,
...
diesel::table! {
    optimistic_event_struct_package (package, global_sequence_number, event_sequence_number) {
        package -> Bytea,
        global_sequence_number -> Int8,
        event_sequence_number -> Int8,
        sender -> Bytea,
...
diesel::table! {
    optimistic_events (global_sequence_number, event_sequence_number) {
        global_sequence_number -> Int8,
        event_sequence_number -> Int8,
        transaction_digest -> Bytea,
        senders -> Array<Nullable<Bytea>>,
...
diesel::table! {
    optimistic_tx_calls_fun (package, module, func, global_sequence_number) {
        global_sequence_number -> Int8,
        package -> Bytea,
        module -> Text,
        func -> Text,
...
diesel::table! {
    optimistic_tx_calls_mod (package, module, global_sequence_number) {
        global_sequence_number -> Int8,
        package -> Bytea,
        module -> Text,
        sender -> Bytea,
...
diesel::table! {
    optimistic_tx_calls_pkg (package, global_sequence_number) {
        global_sequence_number -> Int8,
        package -> Bytea,
        sender -> Bytea,
    }
...
diesel::table! {
    optimistic_tx_changed_objects (object_id, global_sequence_number) {
        global_sequence_number -> Int8,
        object_id -> Bytea,
        sender -> Bytea,
    }
...
diesel::table! {
    optimistic_tx_input_objects (object_id, global_sequence_number) {
        global_sequence_number -> Int8,
        object_id -> Bytea,
        sender -> Bytea,
    }
...
diesel::table! {
    optimistic_tx_kinds (tx_kind, global_sequence_number) {
        global_sequence_number -> Int8,
        tx_kind -> Int2,
    }
}
...
diesel::table! {
    optimistic_tx_recipients (recipient, global_sequence_number) {
        global_sequence_number -> Int8,
        recipient -> Bytea,
        sender -> Bytea,
    }
...
diesel::table! {
    optimistic_tx_senders (sender, global_sequence_number) {
        global_sequence_number -> Int8,
        sender -> Bytea,
    }
}
...
diesel::joinable!(optimistic_event_emit_module -> optimistic_transactions (global_sequence_number));
diesel::joinable!(optimistic_event_emit_package -> optimistic_transactions (global_sequence_number));
diesel::joinable!(optimistic_event_senders -> optimistic_transactions (global_sequence_number));
diesel::joinable!(optimistic_event_struct_instantiation -> optimistic_transactions (global_sequence_number));
diesel::joinable!(optimistic_event_struct_module -> optimistic_transactions (global_sequence_number));
diesel::joinable!(optimistic_event_struct_name -> optimistic_transactions (global_sequence_number));
diesel::joinable!(optimistic_event_struct_package -> optimistic_transactions (global_sequence_number));
diesel::joinable!(optimistic_events -> optimistic_transactions (global_sequence_number));
diesel::joinable!(optimistic_tx_calls_fun -> optimistic_transactions (global_sequence_number));
diesel::joinable!(optimistic_tx_calls_mod -> optimistic_transactions (global_sequence_number));
diesel::joinable!(optimistic_tx_calls_pkg -> optimistic_transactions (global_sequence_number));
diesel::joinable!(optimistic_tx_changed_objects -> optimistic_transactions (global_sequence_number));
diesel::joinable!(optimistic_tx_input_objects -> optimistic_transactions (global_sequence_number));
diesel::joinable!(optimistic_tx_kinds -> optimistic_transactions (global_sequence_number));
diesel::joinable!(optimistic_tx_recipients -> optimistic_transactions (global_sequence_number));
diesel::joinable!(optimistic_tx_senders -> optimistic_transactions (global_sequence_number));
