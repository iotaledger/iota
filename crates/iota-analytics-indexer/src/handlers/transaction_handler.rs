...
impl TransactionHandler {
    ...
    fn process_transaction(
        ...
        let entry = TransactionEntry {
            ...
            gas_object_id: gas_object.reference.object_id.to_string(),
            gas_object_sequence: gas_object.reference.version.as_u64(),
            gas_object_digest: gas_object.reference.digest.to_string(),
