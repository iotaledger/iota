...
mod tests {
    ...
    fn verify_allowall() {
        ...
        let random_cert_bob = SelfSignedCertificate::new(allowed, IOTA_VALIDATOR_SERVER_NAME);
        let random_cert_alice = SelfSignedCertificate::new(disallowed, IOTA_VALIDATOR_SERVER_NAME);
    ...
    fn verify_hashset() {
        ...
        let disallowed_cert = SelfSignedCertificate::new(disallowed, IOTA_VALIDATOR_SERVER_NAME);
    ...
    fn extra_certificates_are_rejected() {
        let allowed_cert =
            SelfSignedCertificate::new(Ed25519PrivateKey::random(), IOTA_VALIDATOR_SERVER_NAME);
        let extra_cert =
            SelfSignedCertificate::new(Ed25519PrivateKey::random(), IOTA_VALIDATOR_SERVER_NAME);
