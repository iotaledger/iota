    ...
    fn fmt(&self, f: &mut Formatter<'_>) -> fmt::Result {
        ...
        builder.push_record(vec![format!(
            "Gas Cost Summary:\n   \
             ...
             Non-refundable Storage Fee: {} MICROS",
...
impl Display for IotaGasData {
    fn fmt(&self, f: &mut Formatter<'_>) -> fmt::Result {
        ...
        writeln!(f, "Gas Budget: {} MICROS", self.budget)?;
        writeln!(f, "Gas Price: {} MICROS", self.price)?;
...
pub struct IotaLoadedChildObject {
    object_id: ObjectID,
    #[schemars(with = "AsSequenceNumber")]
    #[serde_as(as = "AsSequenceNumber")]
    sequence_number: SequenceNumber,
...
pub struct IotaLoadedChildObjectsResponse {
    pub loaded_child_objects: Vec<IotaLoadedChildObject>,
}
