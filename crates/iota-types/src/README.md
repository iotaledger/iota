...
`messages.rs`). See [IOTA Signatures](https://docs.iota.org/developer/cryptography/transaction-auth/signatures) for supported signature schemes and its requirements for user and authority signatures. See [fastcrypto](https://github.com/MystenLabs/fastcrypto) for concrete implementation of various cryptography libraries.
