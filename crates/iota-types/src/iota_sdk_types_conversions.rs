...
// Self::Success,             crate::execution_status::ExecutionStatus::Failure
// { error, command } => Self::Failure {                 error: error.into(),
...
//             },
//             _ => unreachable!("a new enum variant was added and needs to be
// handled"),         }
//     }
// }
...
// Self::FeatureNotYetSupported,
// ExecutionFailureStatus::MoveObjectTooBig {                 object_size,
//                 max_object_size,
//             } => Self::ObjectTooBig {
//                 object_size,
//                 max_object_size,
...
// ExecutionFailureStatus::IotaMoveVerificationError =>
...
//                 }
//             }
//             ExecutionFailureStatus::MoveAbort(move_location, code) =>
// Self::MoveAbort {                 location: move_location.into(),
//                 code,
//             },
...
//                 use crate::execution_status::CommandArgumentError as
// InternalCmdArgErr;                 Self::CommandArgumentError {
//                     argument: arg_idx,
//                     kind: match kind {
//                         InternalCmdArgErr::TypeMismatch =>
...
// => {                             CommandArgumentError::InvalidResultArity {
// result: result_idx }                         }
...
// => {                 use crate::execution_status::TypeArgumentError as
// InternalTypeArgErr;                 Self::TypeArgumentError {
//                     type_argument: argument_idx,
//                     kind: match kind {
//                         InternalTypeArgErr::TypeNotFound =>
// TypeArgumentError::TypeNotFound,
...
// ExecutionFailureStatus::EffectsTooLarge {                 current_size,
//                 max_size,
...
// {                 use crate::execution_status::PackageUpgradeError as
// InternalPkgUpgradeErr;                 Self::PackageUpgradeError {
...
//                                 digest:
// Digest::from_bytes(digest).expect("invalid digest bytes"),
// }                         }
//                         InternalPkgUpgradeErr::UnknownUpgradePolicy { policy
// } => {                             PackageUpgradeError::UnknownUpgradePolicy
// { policy }                         }
...
//                 congested_objects:
// congested_objects.0.into_iter().map(Into::into).collect(),             },
...
// Self::FeatureNotYetSupported,             ExecutionError::ObjectTooBig {
//                 object_size,
//                 max_object_size,
...
// Self::MoveAbort(location.into(), code),
// ExecutionError::VmVerificationOrDeserializationError => {
// Self::VMVerificationOrDeserializationError             }
//             ExecutionError::VmInvariantViolation =>
// Self::VMInvariantViolation,             ExecutionError::FunctionNotFound =>
// Self::FunctionNotFound,             ExecutionError::ArityMismatch =>
// Self::ArityMismatch,             ExecutionError::TypeArityMismatch =>
// Self::TypeArityMismatch,             ExecutionError::NonEntryFunctionInvoked
// => Self::NonEntryFunctionInvoked,
...
// result, subresult } => {
// InternalCmdArgErr::SecondaryIndexOutOfBounds {
// result_idx: result,                                 secondary_idx: subresult,
//                             }
//                         }
//                         CommandArgumentError::InvalidResultArity { result }
// => {                             InternalCmdArgErr::InvalidResultArity {
// result_idx: result }                         }
//                         CommandArgumentError::InvalidGasCoinUsage => {
//                             InternalCmdArgErr::InvalidGasCoinUsage
//                         }
...
//                             InternalCmdArgErr::InvalidArgumentArity
//                         }
//                         _ => unreachable!("a new enum variant was added and
// needs to be handled"),                     },
//                 }
//             }
...
// Self::InvalidTransferObject,             ExecutionError::EffectsTooLarge {
//                 current_size,
//                 max_size,
//             } => Self::EffectsTooLarge {
//                 current_size,
...
// => {                             InternalPkgUpgradeErr::UnknownUpgradePolicy
// { policy }                         }
//                         PackageUpgradeError::PackageIdDoesNotMatch {
//                             package_id,
//                             ticket_id,
