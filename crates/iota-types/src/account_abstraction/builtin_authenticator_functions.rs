...
use crate::{
    IOTA_FRAMEWORK_ADDRESS, IOTA_FRAMEWORK_PACKAGE_ID,
    account_abstraction::{
...
pub const BUILTIN_AUTHENTICATOR_FUNCTIONS_MODULE_NAME: &IdentStr =
    ident_str!("builtin_authenticator_functions");
...
impl PublicKeyFieldName {
    pub fn tag() -> StructTag {
        StructTag {
            ...
            module: BUILTIN_AUTHENTICATOR_FUNCTIONS_MODULE_NAME.to_owned(),
