...
// DKG types and helpers pull in `fastcrypto-tbls` (BLS12-381 threshold
// signatures), which isn't available on wasm32. Group them in a single
// gated sub-module so the rest of the file stays cfg-free.
...
mod dkg {
    ...
    impl ConsensusTransaction {
        ...
        pub fn new_randomness_dkg_confirmation(
            ...
            let confirmation = bcs::to_bytes(versioned_confirmation)
...
#[cfg(not(target_arch = "wasm32"))]
pub use dkg::{VersionedDkgConfirmation, VersionedDkgMessage};
