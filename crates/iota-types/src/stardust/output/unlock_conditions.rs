...
use iota_stardust_types::types::block::address::Address;
...
impl ExpirationUnlockCondition {
    pub(crate) fn new(
        ...
        expiration_unlock_condition: &iota_stardust_types::types::block::output::unlock_condition::ExpirationUnlockCondition,
    ) -> anyhow::Result<Self> {
...
impl TryFrom<&iota_stardust_types::types::block::output::unlock_condition::StorageDepositReturnUnlockCondition>
    for StorageDepositReturnUnlockCondition
{
    type Error = anyhow::Error;

    fn try_from(
        unlock: &iota_stardust_types::types::block::output::unlock_condition::StorageDepositReturnUnlockCondition,
...
impl From<&iota_stardust_types::types::block::output::unlock_condition::TimelockUnlockCondition>
    for TimelockUnlockCondition
{
    fn from(
        unlock: &iota_stardust_types::types::block::output::unlock_condition::TimelockUnlockCondition,
    ) -> Self {
        Self {
