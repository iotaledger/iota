...
pub trait ReadStoreFallible: ObjectStore {
    // Committee Getters
    //
...
impl<T: ReadStoreFallible + ?Sized> ReadStoreFallible for &T {
    fn try_get_committee(&self, epoch: EpochId) -> Result<Option<Arc<Committee>>> {
...
impl<T: ReadStoreFallible + ?Sized> ReadStoreFallible for Box<T> {
    fn try_get_committee(&self, epoch: EpochId) -> Result<Option<Arc<Committee>>> {
        (**self).try_get_committee(epoch)
    }
...
impl<T: ReadStoreFallible + ?Sized> ReadStoreFallible for Arc<T> {
    fn try_get_committee(&self, epoch: EpochId) -> Result<Option<Arc<Committee>>> {
        (**self).try_get_committee(epoch)
    }
...
pub trait ReadStoreNonFallible: ObjectStore {
    // Committee Getters
    //
...
impl<T: ReadStoreNonFallible + ?Sized> ReadStoreNonFallible for &T {
    fn get_committee(&self, epoch: EpochId) -> Option<Arc<Committee>> {
...
impl<T: ReadStoreNonFallible + ?Sized> ReadStoreNonFallible for Box<T> {
    fn get_committee(&self, epoch: EpochId) -> Option<Arc<Committee>> {
        (**self).get_committee(epoch)
    }
...
impl<T: ReadStoreNonFallible + ?Sized> ReadStoreNonFallible for Arc<T> {
    fn get_committee(&self, epoch: EpochId) -> Option<Arc<Committee>> {
        (**self).get_committee(epoch)
    }
...
pub trait RestStateReader: ObjectStore + ReadStoreFallible + Send + Sync {
