...
use crate::{
    ...
    storage::{ReadStoreNonFallible, WriteStore},
...
impl ReadStoreNonFallible for SharedInMemoryStore {
...
impl ReadStoreNonFallible for SingleCheckpointSharedInMemoryStore {
    fn get_checkpoint_by_digest(&self, digest: &CheckpointDigest) -> Option<VerifiedCheckpoint> {
