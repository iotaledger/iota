...
/// itself somewhere we'll conservitively cap this to ~80% of that.
...
pub(crate) mod tests {
    ...
    use A::{MoveTypeLayout as L, MoveValue as V};
    ...
    use super::*;
    use crate::object::bounded_visitor::tests::{layout_, serialize, value_};
    ...
    #[test]
    fn json_balance() {
        let l = struct_layout!("0x2::balance::Balance<0x2::iota::IOTA>" {
            "value": L::U64,
        });
