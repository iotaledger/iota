...
///
/// The API is inspired by tokio-retry::strategy::ExponentialBackoff for ease of
/// use. But bugs in the original implementation have been fixed.
///
/// ```rust,no_run
...
impl ExponentialBackoff {
    /// Constructs a new exponential backoff generator, specifying the maximum
    /// delay.
    ...
    /// Sets the approximate ratio of consecutive backoff delays, before jitters
    /// are applied. Setting this to Duration::ZERO disables jittering.
    ///
    /// Default is 1.2.
