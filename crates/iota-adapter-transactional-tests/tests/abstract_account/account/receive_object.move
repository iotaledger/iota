...
//# set-address a_account object(2,0)

//# programmable --sender A --inputs 2000000000 @a_account
//> 0: SplitCoins(Gas, [Input(0)]);
//> 1: TransferObjects([Result(0)], Input(1));

//# abstract --account immshared(2,0) --ptb-inputs object(2,0) receiving(5,0)
//> 0: aa::abstract_account::receive_object(Input(0), Input(1));
