...
//# programmable --sender A --inputs object(3,1) "abstract_account" "authenticate"
...
//# set-address account_addr object(4,1)

// use a `REGULATED_COIN` coin as an authenticator input, which is allowed
//# abstract --account immshared(4,1) --auth-inputs immshared(1,0) --ptb-inputs 100 @A
