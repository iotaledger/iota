...
//# programmable --inputs object(1,2) "account" "authenticate"
//> 0: test::account::create();
//> 1: iota::authenticator_function::create_auth_function_ref_v1_from_package_metadata_v2<test::account::Account>(Input(0), Input(1), Input(2));
