...
module test::test_module {
    ...
    public fun simple_fx_ptb(single_data: Option<Data<DecimalValue>>, micros_amount: u64, ctx: &mut TxContext) {
        ...
        let amount = micros_amount * value;
        let usd = MockUSD {
            id: object::new(ctx),
            amount,
            decimals,
    ...
    public fun trusted_fx(
        ...
        let meta_oracle = meta_oracle::new<DecimalValue>(3, 60000, string::utf8(b"IOTAUSD"));
