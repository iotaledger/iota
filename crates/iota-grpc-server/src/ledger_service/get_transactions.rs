...
///  - `signatures.signatures` - the list of signatures
///   - `signatures.signatures.bcs` - the full BCS-encoded signature
...
///    - `events.events.events.bcs` - the full BCS-encoded event`
///    - `events.events.events.package_id` - the ID of the package that emitted the event
///    - `events.events.events.module` - the module that emitted the event
///    - `events.events.events.sender` - the sender that triggered the event
///    - `events.events.events.event_type` - the type of the event
///    - `events.events.events.bcs_contents` - the full BCS-encoded contents of the event
///    - `events.events.events.json_contents` - the JSON-encoded contents of the event
...
///   - `input_objects.objects.reference` - includes all reference fields
///    - `input_objects.objects.reference.object_id` - the ID of the input object
///    - `input_objects.objects.reference.version` - the version of the input object, which can be used to fetch a specific historical version or the latest version if not provided
///    - `input_objects.objects.reference.digest` - the digest of the input object contents, which can be used for integrity verification
///   - `input_objects.objects.bcs` - the full BCS-encoded object
/// - `output_objects` - includes all output object fields
/// - `output_objects.objects`
///  - `output_objects.objects.reference` - includes all reference fields
///   - `output_objects.objects.reference.object_id` - the ID of the output object
///   - `output_objects.objects.reference.version` - the version of the output object, which can be used to fetch a specific historical version or the latest version if not provided
///   - `output_objects.objects.reference.digest` - the digest of the output object contents, which can be used for integrity verification
///  - `output_objects.objects.bcs` - the full BCS-encoded object
