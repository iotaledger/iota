...
///     transaction
///  - `executed_transaction.signatures` - the list of signatures
...
///    - `executed_transaction.events.events.package_id` - the ID of the package
///      that emitted the event
///    - `executed_transaction.events.events.module` - the module that emitted
///      the event
///    - `executed_transaction.events.events.sender` - the sender that triggered
///      the event
...
///  - `executed_transaction.input_objects` - the list of input objects
...
///      the input object
///    - `executed_transaction.input_objects.reference.version` - the version of
///      the input object
...
///  - `executed_transaction.output_objects` - the list of output objects
...
///  - `execution_result.command_results` - the list of per-command results if
///    execution succeeded
///   - `execution_result.command_results.mutated_by_ref` - the list of objects
///     mutated by reference
///    - `execution_result.command_results.mutated_by_ref.argument` - the
///      argument reference
///    - `execution_result.command_results.mutated_by_ref.type_tag` - the Move
///      type tag
///    - `execution_result.command_results.mutated_by_ref.bcs` - the BCS-encoded
///      value
///    - `execution_result.command_results.mutated_by_ref.json` - the
///      JSON-encoded value
///   - `execution_result.command_results.return_values` - the list of values
...
///      type tag
///    - `execution_result.command_results.return_values.bcs` - the BCS-encoded
///      value
///    - `execution_result.command_results.return_values.json` - the
///      JSON-encoded value
///  - `execution_result.execution_error` - the execution error if execution
///    failed
