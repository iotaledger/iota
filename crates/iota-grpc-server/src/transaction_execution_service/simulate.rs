...
///  - `execution_result.command_results` - the command results if execution succeeded
///   - `execution_result.command_results.results` - the list of per-command results
///    - `execution_result.command_results.results.mutated_by_ref` - objects mutated by reference
///     - `execution_result.command_results.results.mutated_by_ref.outputs` - the list of mutated outputs
///      - `execution_result.command_results.results.mutated_by_ref.outputs.argument` - the argument reference
///      - `execution_result.command_results.results.mutated_by_ref.outputs.type_tag` - the Move type tag
///      - `execution_result.command_results.results.mutated_by_ref.outputs.bcs` - the BCS-encoded value
///      - `execution_result.command_results.results.mutated_by_ref.outputs.json` - the JSON-encoded value
///    - `execution_result.command_results.results.return_values` - values returned by the command
///     - `execution_result.command_results.results.return_values.outputs` - the list of return value outputs
///      - `execution_result.command_results.results.return_values.outputs.argument` - the argument reference
///      - `execution_result.command_results.results.return_values.outputs.type_tag` - the Move type tag
///      - `execution_result.command_results.results.return_values.outputs.bcs` - the BCS-encoded value
///      - `execution_result.command_results.results.return_values.outputs.json` - the JSON-encoded value
///  - `execution_result.execution_error` - the execution error if execution failed
