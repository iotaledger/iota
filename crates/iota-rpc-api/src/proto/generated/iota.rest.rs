...
/// Iota `TransactionData` type serialized as Bcs
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Transaction {
    #[prost(bytes = "bytes", tag = "1")]
    pub transaction: ::prost::bytes::Bytes,
}
/// Iota `TransactionEffects` type serialized as Bcs
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct TransactionEffects {
    #[prost(bytes = "bytes", tag = "1")]
    pub effects: ::prost::bytes::Bytes,
}
/// Iota `TransactionEvents` type serialized as Bcs
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct TransactionEvents {
    #[prost(bytes = "bytes", tag = "1")]
    pub events: ::prost::bytes::Bytes,
}
/// Iota `Object` type serialized as Bcs
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Object {
    #[prost(bytes = "bytes", tag = "1")]
    pub object: ::prost::bytes::Bytes,
}
/// Iota `CheckpointSummary` type serialized as Bcs
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct CheckpointSummary {
    #[prost(bytes = "bytes", tag = "1")]
    pub summary: ::prost::bytes::Bytes,
}
/// Iota `CheckpointContents` type serialized as Bcs
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct CheckpointContents {
    #[prost(bytes = "bytes", tag = "1")]
    pub contents: ::prost::bytes::Bytes,
}
/// Iota `UserSignature` type serialized as bytes
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct UserSignature {
    #[prost(bytes = "bytes", tag = "1")]
    pub signature: ::prost::bytes::Bytes,
}
/// Iota `ValidatorAggregatedSignature` type serialized as Bcs
#[derive(Clone, PartialEq, ::prost::Message)]
