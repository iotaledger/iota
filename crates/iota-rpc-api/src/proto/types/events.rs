...
impl From<iota_sdk_types::types::Event> for super::Event {
    fn from(value: iota_sdk_types::types::Event) -> Self {
        Self {
...
impl TryFrom<&super::Event> for iota_sdk_types::types::Event {
...
impl From<iota_sdk_types::types::TransactionEvents> for super::TransactionEvents {
    fn from(value: iota_sdk_types::types::TransactionEvents) -> Self {
        Self {
...
impl TryFrom<&super::TransactionEvents> for iota_sdk_types::types::TransactionEvents {
    type Error = TryFromProtoError;
