...
/// A ConsensusV2 object is an object that is automatically versioned by the
/// consensus protocol and allows different authentication modes based on the
/// chosen authenticator. (Initially, only single-owner authentication is
/// supported.)
#[derive(SimpleObject, Clone)]
