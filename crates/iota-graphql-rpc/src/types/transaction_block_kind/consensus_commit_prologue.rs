...
/// Other transaction kinds are usually represented by directly wrapping their
/// native representation. This kind has two native versions in the protocol, so
/// the same cannot be done. V2 has all the fields of V1 and one extra
/// (consensus commit digest). The GraphQL representation of this type is a
/// struct containing all the common fields, as they are in the native type, and
