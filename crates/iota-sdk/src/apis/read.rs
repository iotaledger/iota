...
impl ReadApi {
    ...
    /// use iota_sdk::{
    ///     IotaClientBuilder,
    ///     types::base_types::{Address, ObjectId},
    /// };
    ///
    /// #[tokio::main]
    /// async fn main() -> Result<(), anyhow::Error> {
    ...
    ///
    /// use iota_sdk::{
    ///     IotaClientBuilder, rpc_types::IotaObjectDataOptions, types::base_types::Address,
    /// };
    ///
    /// #[tokio::main]
    /// async fn main() -> Result<(), anyhow::Error> {
    ...
    pub async fn get_latest_checkpoint_sequence_number(&self) -> IotaRpcResult<Version> {
        Ok(*self
            .api
            .http
