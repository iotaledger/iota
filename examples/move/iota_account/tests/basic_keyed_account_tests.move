...
// use iota_account::basic_keyed_account;
...
//         let public_key_df_name = basic_keyed_account::create_owner_public_key_for_testing();
...
//         account.add_field(basic_keyed_account::create_owner_public_key_for_testing(), 42, ctx);
...
//         account.remove_field<_, vector<u64>>(
//             basic_keyed_account::create_owner_public_key_for_testing(),
//             ctx,
//         );
...
//         assert_ref_eq(
//             account.borrow_field(basic_keyed_account::create_owner_public_key_for_testing()),
...
//         account.borrow_field_mut<_, vector<u64>>(
//             basic_keyed_account::create_owner_public_key_for_testing(),
//             ctx,
//         );
...
//         assert!(account.has_field(basic_keyed_account::create_owner_public_key_for_testing()));
...
//         basic_keyed_account::authenticate_ed25519(
//             &account,
...
//         basic_keyed_account::authenticate_secp256k1(
//             &account,
//             hex::encode(signature),
//             &auth_ctx,
//             &ctx,
...
//         basic_keyed_account::authenticate_secp256r1(
//             &account,
//             hex::encode(signature),
//             &auth_ctx,
//             &ctx,
...
// fun create_basic_keyed_account_for_testing(scenario: &mut Scenario): address {
//     create_basic_keyed_account_for_testing_impl(scenario, option::none())
// }
...
// ): address {
//     create_basic_keyed_account_for_testing_impl(scenario, option::some(public_key))
// }

// fun create_basic_keyed_account_for_testing_impl(
//     scenario: &mut Scenario,
...
//     basic_keyed_account::create(public_key, authenticator, ctx);
