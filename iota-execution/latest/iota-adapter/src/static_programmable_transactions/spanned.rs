...
//! This module provides a shared API amongst the ASTs for original command and
//! argument locations. Some translations might reorder or move
//! commands/arguments, and as such we need to annotate the values with the
//! original location
