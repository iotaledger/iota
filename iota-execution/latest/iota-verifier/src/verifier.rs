...
use crate::{
    authenticate_one_time_witness_verifier, entry_points_verifier, global_storage_access_verifier,
    id_leak_verifier, one_time_witness_verifier, private_generics, struct_with_key_verifier,
};
...
pub fn iota_verify_module_metered(
    ...
    authenticate_one_time_witness_verifier::verify_module(module, fn_info_map)
}
