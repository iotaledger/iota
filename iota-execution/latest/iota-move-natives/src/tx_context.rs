...
use crate::{
    NativesCostTable, object_runtime::ObjectRuntime, transaction_context::TransactionContext,
};
...
/// Implementation of the Move native function `fun native_epoch_timestamp_ms():
/// u64` ***********************************************************************
/// ************************
...
/// Implementation of the Move native function `fun native_sponsor():
/// vector<address>` ***********************************************************
/// ************************************
pub fn sponsor(
    context: &mut NativeContext,
