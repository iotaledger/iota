...
use iota_types::{
    IOTA_ACCOUNT_REGISTRY_OBJECT_ID, IOTA_AUTHENTICATOR_STATE_OBJECT_ID, IOTA_BRIDGE_OBJECT_ID,
    IOTA_CLOCK_OBJECT_ID, IOTA_DENY_LIST_OBJECT_ID, IOTA_RANDOMNESS_STATE_OBJECT_ID,
...
impl<'a> ObjectRuntime<'a> {
    ...
    pub fn transfer(
        ...
        let is_framework_obj = [
            ...
            IOTA_ACCOUNT_REGISTRY_OBJECT_ID,
        ]
        .contains(&id);
