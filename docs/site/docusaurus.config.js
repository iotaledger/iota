  ...
  plugins: [
    ...
    [
      ...
      // Options
      {
        ...
        out: "../generated-docs/ts-sdk/typescript",
        githubPages: false,
        readme: "none",
        hideGenerator: true,
        sort: ["source-order"],
    ...
    [
      'docusaurus-plugin-typedoc',
      {
        ...
        plugin: ['typedoc-plugin-markdown'],
        out: "../generated-docs/ts-sdk/dapp-kit",
        githubPages: false,
        readme: 'none',
        hideGenerator: true,
        sort: ['source-order'],
    ...
    [
      'docusaurus-plugin-typedoc',
      {
        ...
        plugin: ['typedoc-plugin-markdown'],
        out: "../generated-docs/ts-sdk/kiosk",
        githubPages: false,
        readme: 'none',
        hideGenerator: true,
        sort: ['source-order'],
    ...
    [
      'docusaurus-plugin-typedoc',
      {
        ...
        plugin: ['typedoc-plugin-markdown'],
        out: "../generated-docs/ts-sdk/signers",
        githubPages: false,
        readme: 'none',
        hideGenerator: true,
        sort: ['source-order'],
    ...
    [
      'docusaurus-plugin-typedoc',
      {
        ...
        plugin: ['typedoc-plugin-markdown'],
        out: "../generated-docs/ts-sdk/isc-sdk",
        githubPages: false,
        readme: 'none',
        hideGenerator: true,
        sort: ['source-order'],
    ...
    [
      'docusaurus-plugin-typedoc',
      {
        ...
        plugin: ['typedoc-plugin-markdown'],
        out: "../generated-docs/ts-sdk/graphql-transport",
        githubPages: false,
        readme: 'none',
        hideGenerator: true,
        sort: ['source-order'],
    ...
    [
      'docusaurus-plugin-typedoc',
      {
        ...
        plugin: ['typedoc-plugin-markdown'],
        out: "../generated-docs/ts-sdk/wallet-standard",
        githubPages: false,
        readme: 'none',
        hideGenerator: true,
        sort: ['source-order'],
    ...
    [
      'docusaurus-plugin-typedoc',
      {
        ...
        plugin: ['typedoc-plugin-markdown'],
        out: "../generated-docs/ts-sdk/ledgerjs-hw-app-iota",
        githubPages: false,
        readme: 'none',
        hideGenerator: true,
        sort: ['source-order'],
