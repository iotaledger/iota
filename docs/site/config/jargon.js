module.exports = {
    ...
    transaction: `
        ...
        More <i>complex transactions</i> affecting objects that are shared or owned by multiple addresses, such as asset management and other DeFi use cases, go through the DAG - based mempool and efficient Byzantine Fault Tolerant(BFT) consensus.
    `,
