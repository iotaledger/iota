...
```typescript
import { parseZkLoginSignature } '@iota/iota.js/zklogin';
...
```typescript
import { getZkLoginSignature } '@iota/iota.js/zklogin';
...
```typescript
import { computeZkLoginAddressFromSeed } '@iota/iota.js/zklogin';
