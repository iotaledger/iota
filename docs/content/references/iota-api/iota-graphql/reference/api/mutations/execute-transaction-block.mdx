...
#### [<code style={{ fontWeight: 'normal' }}>executeTransactionBlock.<b>txBytes</b></code>](#)<Bullet />[`String!`](/references/iota-api/iota-graphql/reference/types/scalars/string) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="scalar"/> 
> 
> 
> 
> 

#### [<code style={{ fontWeight: 'normal' }}>executeTransactionBlock.<b>signatures</b></code>](#)<Bullet />[`[String!]!`](/references/iota-api/iota-graphql/reference/types/scalars/string) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="scalar"/> 
> 
> 
> 
> 
...
#### [`ExecutionResult`](/references/iota-api/iota-graphql/reference/types/objects/execution-result) <Badge class="badge badge--secondary" text="object"/> 
> 
> 
