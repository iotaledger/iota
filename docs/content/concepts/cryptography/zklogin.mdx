...
1. Use the [Iota Keytool CLI](../../references/cli/keytool.mdx). This is recommended for debug usage. 
   ...
   ```sh
   $IOTA_BINARY keytool zk-login-sig-verify --sig $ZKLOGIN_SIG --bytes $BYTES --intent-scope 3 --network devnet --curr-epoch 3
   ```
...
Yes. See the [Multisig Guide](https://docs.iota.org/references/ts-sdk/typescript/cryptography/multisig#multisig-with-zklogin) for more details.
