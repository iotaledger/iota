...
```ts reference
https://github.com/iotaledger/identity.rs/blob/v1.6.0-alpha/bindings/wasm/identity_wasm/examples/src/0_basic/2_resolve_did.ts#L49-L53
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/v1.6.0-alpha/bindings/wasm/identity_wasm/examples/src/0_basic/2_resolve_did.ts#L34-L35
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/v1.6.0-alpha/bindings/wasm/identity_wasm/examples/src/1_advanced/4_custom_resolution.ts
```
