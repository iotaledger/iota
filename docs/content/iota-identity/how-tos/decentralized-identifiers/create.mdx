...
```ts reference
https://github.com/iotaledger/identity.rs/blob/v1.6.0-alpha/examples/utils/utils.rs#L38
```
...
```rust reference
https://github.com/iotaledger/identity.rs/blob/v1.6.0-alpha/examples/utils/utils.rs#L60
```
