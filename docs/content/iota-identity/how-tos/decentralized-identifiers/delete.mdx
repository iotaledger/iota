...
```ts reference
https://github.com/iotaledger/identity.rs/blob/wasm-v1.6.0-alpha/bindings/wasm/examples/src/0_basic/3_deactivate_did.ts
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/wasm-v1.6.0-alpha/bindings/wasm/examples/src/0_basic/4_delete_did.ts
```
