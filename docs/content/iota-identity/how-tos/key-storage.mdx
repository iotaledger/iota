...
```ts reference
https://github.com/iotaledger/identity.rs/blob/v1.6.0-alpha/bindings/wasm/identity_wasm/lib/jwk_storage.ts
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/v1.6.0-alpha/bindings/wasm/identity_wasm/lib/key_id_storage.ts
```
