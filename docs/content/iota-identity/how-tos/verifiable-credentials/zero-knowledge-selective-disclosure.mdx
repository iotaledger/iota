...
```ts reference
https://github.com/iotaledger/identity.rs/blob/wasm-v1.6.0-alpha/bindings/wasm/examples/src/1_advanced/8_zkp.ts#L109-L133
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/wasm-v1.6.0-alpha/bindings/wasm/examples/src/1_advanced/8_zkp.ts#L178-L199
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/wasm-v1.6.0-alpha/bindings/wasm/examples/src/1_advanced/8_zkp.ts#L217-L225
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/wasm-v1.6.0-alpha/bindings/wasm/examples/src/1_advanced/8_zkp.ts
```
