...
```ts reference
https://github.com/iotaledger/identity.rs/blob/wasm-v1.6.0-alpha/bindings/wasm/examples/src/0_basic/7_revoke_vc.ts#L156
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/wasm-v1.6.0-alpha/bindings/wasm/examples/src/1_advanced/7_status_list_2021.ts#L72-L76
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/wasm-v1.6.0-alpha/bindings/wasm/examples/src/1_advanced/7_status_list_2021.ts#L147
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/wasm-v1.6.0-alpha/bindings/wasm/examples/src/0_basic/7_revoke_vc.ts#L192C1-L195
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/wasm-v1.6.0-alpha/bindings/wasm/examples/src/0_basic/7_revoke_vc.ts
```
