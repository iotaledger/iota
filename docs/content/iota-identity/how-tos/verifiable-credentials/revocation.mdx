...
```ts reference
https://github.com/iotaledger/identity.rs/blob/v1.6.0-alpha/bindings/wasm/identity_wasm/examples/src/0_basic/7_revoke_vc.ts#L130
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/v1.6.0-alpha/bindings/wasm/identity_wasm/examples/src/1_advanced/7_status_list_2021.ts#L56-L60
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/v1.6.0-alpha/bindings/wasm/identity_wasm/examples/src/1_advanced/7_status_list_2021.ts#L131
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/v1.6.0-alpha/bindings/wasm/identity_wasm/examples/src/0_basic/7_revoke_vc.ts#L157-L160
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/v1.6.0-alpha/bindings/wasm/identity_wasm/examples/src/0_basic/7_revoke_vc.ts
```
