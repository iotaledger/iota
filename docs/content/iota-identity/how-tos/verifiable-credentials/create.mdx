...
```rust reference
https://github.com/iotaledger/identity.rs/blob/v1.6.0-alpha/examples/0_basic/5_create_vc.rs#L36-L74
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/wasm-v1.6.0-alpha/bindings/wasm/examples/src/0_basic/5_create_vc.ts#L51-L74
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/wasm-v1.6.0-alpha/bindings/wasm/examples/src/0_basic/5_create_vc.ts#L83-L88
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/wasm-v1.6.0-alpha/bindings/wasm/examples/src/0_basic/5_create_vc.ts
```
