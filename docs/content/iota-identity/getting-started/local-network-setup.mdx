...
Publish the identity package to your local test network:
...
The examples ([here](../how-tos/decentralized-identifiers/create.mdx) and following) fetch this value from the environment variable `IOTA_IDENTITY_PKG_ID`, so in order to run them, set this variable, e.g. for package id "0x20f640b0dc01c50c04a84443d4320d7a77a15ed94f9bc19ebb6d0a5805045ddc" with:
