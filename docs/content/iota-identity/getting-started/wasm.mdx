...
Alternatively, you can build the bindings yourself, e.g. if you want to want to work currently unreleased features. You can find instructions for this in `identity.rs` repository [here](https://github.com/iotaledger/identity.rs/blob/wasm-v1.6.0-alpha/bindings/wasm/identity_wasm#build).
