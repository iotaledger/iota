...
2. Set the `AWS_SNAPSHOT_ENDPOINT` environment variable to the target snapshot URL. If not set, the default values are endpoints provided by the IOTA Foundation with public access:
  ...
  <TabItem label="RocksDB" value="rocksdb-default-snapshot-endpoint">
      <Tabs groupId="rocksdb-snapshot-endpoint">
         <TabItem label="Mainnet" value="rocksdb-mainnet">
         https://rocksdb-snapshot.mainnet.iota.cafe
         </TabItem>
         <TabItem label="Testnet" value="rocksdb-testnet">
         https://rocksdb-snapshot.testnet.iota.cafe
         </TabItem>
         <TabItem label="Devnet" value="rocksdb-devnet">
...
2. Set the `AWS_SNAPSHOT_ENDPOINT` environment variable to the target snapshot URL. If not set, the default values are endpoints provided by the IOTA Foundation with public access:
   ...
   <TabItem label="Formal" value="formal-default-snapshot-endpoint">
      <Tabs groupId="formal-snapshot-endpoint">
         <TabItem label="Mainnet" value="formal-mainnet">
         https://formal-snapshot.mainnet.iota.cafe
         </TabItem>
         <TabItem label="Testnet" value="formal-testnet">
         https://formal-snapshot.testnet.iota.cafe
         </TabItem>
         <TabItem label="Devnet" value="formal-devnet">
