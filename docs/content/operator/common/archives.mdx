...
state-archive-read-config:
    # Use https://checkpoints.mainnet.iota.cafe for mainnet
    # Use https://checkpoints.testnet.iota.cafe for testnet
    - ingestion-url: "https://checkpoints.<mainnet|testnet>.iota.cafe"
      concurrency: 5
```
