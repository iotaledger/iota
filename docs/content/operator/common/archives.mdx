...
state-archive-read-config:
    # Use https://checkpoints.mainnet.iota.io for mainnet
    # Use https://checkpoints.testnet.iota.io for testnet
    - ingestion-url: "https://checkpoints.<mainnet|testnet>.iota.io"
      concurrency: 5
```
