...
Currently, we do not have an official Grafana setup guide.
However, you can try out a setup prepared by the community: https://github.com/stakeme-team/grafana-iota.

Also, there is a Grafana setup for the [local private network](https://github.com/iotaledger/iota/tree/develop/dev-tools/grafana-local), which might be a good example of how to build your own setup. Officially supported dashboards can be found [here](https://github.com/iotaledger/iota/tree/develop/setups/grafana) in the IOTA repository.
