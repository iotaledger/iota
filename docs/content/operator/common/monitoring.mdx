...
```sh
highest_known_checkpoint 59675325
highest_synced_checkpoint 2357101
last_executed_checkpoint 2079478
last_executed_checkpoint_age_ms{pct="50"} 12920312362
last_executed_checkpoint_age_ms{pct="95"} 12924548836
last_executed_checkpoint_age_ms{pct="99"} 12924925894
last_executed_checkpoint_age_ms_count 2063700
last_executed_checkpoint_age_ms_sum 27190533202683796
last_executed_checkpoint_timestamp_ms 1732397544761
uptime{chain_identifier="2304aa97",is_docker="false",os_version="Linux (Ubuntu 24.04)",process="fullnode",version="0.12.0-rc-8e554870d787"} 2844
```

You can run the command above and convert the `last_executed_checkpoint_timestamp_ms` value from Unix timestamp to human-readable UTC time. Compare it with the current time - a difference of 10-30 seconds indicates normal operation.
