...
The `iota-graphql-rpc` binary serves a GraphQL endpoint backed by the IOTA Indexer database. See the [Extended Data Services overview](./overview.mdx) for how it fits together with the indexer and the JSON-RPC service.
