...
<img src={require('../../../site/static/img/operator/indexer-functions/indexer-arch.png').default} alt="Indexer architecture" style={{maxWidth: 'min(100%, 800px)', height: 'auto'}} />
...
<img src={require('../../../site/static/img/operator/indexer-functions/graphql-rpc-arch.png').default} alt="GraphQL server architecture" style={{maxWidth: 'min(100%, 500px)', height: 'auto'}} />
