...
This guide focuses on using the [IOTA CLI `validator` commands](../../reference/cli/validator.mdx).
...
Operation Cap allows a validator to authorizer another account to perform certain actions on behalf of this validator. Read about [Operation Cap here](./validator-node/validator-tasks#operation-cap).
