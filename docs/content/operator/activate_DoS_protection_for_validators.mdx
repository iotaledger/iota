...
If you're unsure about the correct number of proxies to configure, you can use the [`config-traffic-control.sh`](https://github.com/iotaledger/iota/blob/develop/scripts/config-traffic-control.sh) script included in the IOTA codebase. This script analyzes your node logs to determine the correct configuration.
