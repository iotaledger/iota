...
# how the TrafficController identifies clients and applies rate limiting policies. # The struct provides configuration for both direct client connections and proxied # connections through load balancers.
policy-config:
