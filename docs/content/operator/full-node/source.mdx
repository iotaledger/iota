...
You can also lower the log level by editing your service definition file (changing RUST_LOG inside `/etc/systemd/system/iota-node.service`), in order to produce less logs.
:::
