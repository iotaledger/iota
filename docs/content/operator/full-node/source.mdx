...
```shell
NETWORK="testnet"  bash -i <(curl https://raw.githubusercontent.com/iotaledger/iota.js/master/installer.sh)
```

:::info
Re-use the same network (testnet, mainnet, devnet) that your node is already running on.
:::
