...
Learn how to set snapshot settings [here](configs/snapshots.mdx).
...
Make sure your node stays on the same network (testnet, mainnet, ...) it was previously connected to.
