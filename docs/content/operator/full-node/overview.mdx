...
No matter, which way you choose, firstly, you need to configure the node by preparing the [`fullnode.yaml` file](./configuration.mdx) and downloading the genesis blob.

### Monitoring & Troubleshooting

Running full node with `iota-node` CLI tool doesn't require user interaction.
