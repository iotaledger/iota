...
curl -sL https://github.com/iotaledger/iota/actions/runs/14622677057/artifacts/2995312346 -o fullnode-docker-setup.tar.gz
cat fullnode-docker-setup.tar.gz | tar -xf - --strip-components=1
```
