...
Depending on the network you want to connect to, you need to adjust the peering configuration in the configuration file and download a correct genesis blob (for more details see [genesis](configs/genesis.mdx)) page.
