...
<Tabs groupId="setup-method">
    <TabItem label="Systemd" value="systemd">
      #### 1. Restart the full node
      {/* TODO in 6017 make script update node using script */}
      ```shell
    ...
    <TabItem label="Docker" value="docker">
      ...
      ##### 3.1 Pull the latest version of the container
      ```shell
      docker compose pull
      ```

      ##### 3.2 Run the respective prepare script again depending on your network.
