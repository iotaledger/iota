...
```ts
import { Ed25519Keypair, Ed25519PublicKey } from '@iota/iota/keypairs/ed25519';
...
import { NANO_PER_IOTA } from '@iota/iota/utils';
...
const balance = (balance) => {
	return Number.parseInt(balance.totalBalance) / Number(NANO_PER_IOTA);
};
...
Content below wasn't checked yet and needs changes
