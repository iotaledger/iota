...
For more information on the Iota TypeScript SDK, see the [Iota TypeScript SDK documentation](https://docs.iota.org/references/ts-sdk/typescript).

## What is dApp Kit?

dApp Kit (@iota/dapp-kit) is a collection of React hooks, components, and utilities that make building dApps on Iota straightforward. For more information on dApp Kit, see the [dApp Kit documentation](https://docs.iota.org/references/ts-sdk/dapp-kit).
