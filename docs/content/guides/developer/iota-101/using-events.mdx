...
The TypeScript SDK provides a wrapper for the `iotax_queryEvents` method: [`client.queryEvents`](https://docs.iota.org/references/ts-sdk/typedoc/classes/_iota_iota.client.IotaClient.html#queryEvents).
...
{@inject: crates/iota-graphql-rpc/examples/event_connection/filter_by_emitting_package_module_and_event_type.graphql}
</details>

The [TypeScript SDK](https://docs.iota.org/references/ts-sdk/typedoc/modules/_iota_iota.graphql.html) provides functionality to interact with the Iota GraphQL service.
