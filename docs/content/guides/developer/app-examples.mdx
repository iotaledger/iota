...
import WarnMlRpcs from "../../snippets/warn-ml-rpcs.mdx";
...
- [Trustless Token Swap](./app-examples/trustless-token-swap.mdx): This example demonstrates trustless token swaps on the Sui blockchain using a shared object as an escrow account.
