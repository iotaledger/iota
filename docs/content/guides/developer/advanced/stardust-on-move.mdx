...
[`TreasuryCap`](../../../references/framework/iota-framework/coin.md#resource-treasurycap). The two main goals of the
foundry migration are to convert it to a [`CoinManager`](../../../references/framework/iota-framework/coin_manager.md),
...
[`Balance`](../../../references/framework/iota-framework/balance.md#struct-balance)) as its maximum supply. Since
...
[`iota::transfer::receive`](../../../references/framework/iota-framework/transfer#function-receive). There are
