...
part of a sub directory in the [`iota-genesis-builder`](https://github.com/iotaledger/iota/tree/develop/crates/iota-genesis-builder/src/stardust) crate. This
...
defaults. As much as possible though, the migration attemps to do as little modifications to the UTXO as possible.
...
`Storage Deposit Return` are enforced. For instance, if a time-locked basic output's assets are attempted to be extracted,
