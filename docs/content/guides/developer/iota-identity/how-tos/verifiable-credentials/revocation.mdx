...
### Revocation Bitmap
[RevocationBitmap2022](../../../../../standards/iota-identity/revocation-bitmap-2022.mdx) is the default credential revocation method used in the IOTA Identity Framework. It allows
