...
Note that the Iota Identity Framework follows [IOTA DID Method Specification](../../../../../standards/iota-identity/iota-did-method-spec.mdx).
...
since the DID's [Tag](../../../../../standards/iota-identity/iota-did-method-spec.mdx#iota-tag) contains the
