...
As detailed in the [IOTA DID Method Specification](../../../../../standards/iota-identity/iota-did-method-spec.mdx#deactivate),
...
Alternatively, you can [destroy](../../../../../standards/iota-identity/iota-did-method-spec.mdx#destroy) an IOTA Identity can be permanently.
...
This is achieved by the governor of a DID publishing a transaction consuming the [Alias Output](../../../../../standards/iota-identity/iota-did-method-spec.mdx#alias-output)
