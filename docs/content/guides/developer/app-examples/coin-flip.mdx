...
- The [`init` function](concepts/iota-move-concepts/init.mdx) creates and sends the `Publisher` and `HouseCap` objects to the sender.
...
- Tooling: [Iota TypeScript SDK](https://docs.iota.org/references/ts-sdk/typescript) for basic usage on how to interact with Iota using TypeScript.
- Tooling: [Iota dApp Kit](https://docs.iota.org/references/ts-sdk/dapp-kit) to learn basic building blocks for developing a dApp in the Iota ecosystem with React.js.
- Tooling: [`@iota/dapp`](https://docs.iota.org/references/ts-sdk/dapp-kit/create-dapp), used within this project to quickly scaffold a React-based Iota dApp.
  ...
  onSubmit={(e) => {
    ...
    txb.moveCall({
      ...
      arguments: [
        ...
        // https://docs.iota.org/references/ts-sdk/typescript/transaction-building/basics#pure-values
        txb.pure(
          bcs
            .vector(bcs.U8)
