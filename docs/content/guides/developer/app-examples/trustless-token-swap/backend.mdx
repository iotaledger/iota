...
import InitializeSuiClientCli from "../../../../snippets/initialize-sui-client-cli.mdx";
import PublishToDevnetWithCoins from "../../../../snippets/publish-to-devnet-with-coins.mdx";
import AppExamplesSwapSource from "../../../../snippets/app-examples-swap-source.mdx";

:::note Multi-Page Guide

This is the first in a [three-part guide](../trustless-token-swap.mdx) on how to build a trustless atomic swap on Sui.
