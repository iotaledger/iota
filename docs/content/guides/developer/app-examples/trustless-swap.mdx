...
- Tooling: [Iota Typescript SDK](https://docs.iota.org/references/ts-sdk/typescript). For basic usage on how to interact with Iota with TypeScript.
...
- Tooling: [`@iota/dapp`](https://docs.iota.org/references/ts-sdk/dapp-kit/create-dapp). This is used within this project to quickly scaffold a React-based Iota dApp.
