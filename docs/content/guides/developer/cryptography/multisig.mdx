...
To learn more about how to create multisig addresses and create multisig transactions using the TypeScript SDK, see the [SDK documentation](https://docs.iota.org/references/ts-sdk/typescript/cryptography/multisig) for details. 
...
- [Multisig Typescript SDK](https://docs.iota.org/references/ts-sdk/typescript/cryptography/multisig): How to create multisig addresses and sign transactions using the Iota SDK.