...
**Mysticeti** is a **Byzantine Fault Tolerant (BFT) consensus protocol** optimized for **low latency** and **high throughput**. It operates on a **Directed Acyclic Graph (DAG)** structure and ensures finality in a short time.
