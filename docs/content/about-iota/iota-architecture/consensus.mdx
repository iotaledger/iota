...
The following figure represents five rounds of constructing such a DAG (1 to 5), with authorities A, B, C, and D
...
Generic cryptography implemented in [fastcrypto](https://github.com/MystenLabs/fastcrypto).
