...
The primary goal of consensus in distributed systems is to establish a consistent order of transactions and ensure their availability. In IOTA, consensus is achieved through a combination of Delegated Proof-of-Stake (dPoS) and a Byzantine Fault Tolerant (BFT) protocol. Currently, the Testnet and Mainnet validators employ the Mysticeti BFT protocol, but they switch to the Starfish BFT protocol in the future if validators will accept the protocol upgrade.
