...
3. See: [Getting Started with the IOTA Wallet](https://docs.iota.org/about-iota/iota-wallet/getting-started)
...
3. See: [Use IOTA Wallet with a Ledger Device](https://docs.iota.org/about-iota/iota-wallet/ledger)

If you're using a **Ledger Nano S**, follow this [specific guide](https://docs.iota.org/about-iota/iota-wallet/ledger).
...
2. Use the **Balance Finder** to search for all your addresses:
   - [How to use Balance Finder](https://docs.iota.org/about-iota/iota-wallet/getting-started)

3. After finding your addresses, go to the [IOTA Wallet Dashboard](https://wallet.iota.org) and check:
   - **Migration Tab**: For unmigrated Stardust balances  
     [Migrate Stardust Assets](https://docs.iota.org/about-iota/iota-wallet/migrate-assets)
   - **Vesting Tab**: For airdropped or locked funds from the October 2024 upgrade  
     [Manage Vesting and Time-Locked Assets](https://docs.iota.org/about-iota/iota-wallet/vesting)

## 15. I'm Sure My Funds Are in a Specific Address But They’re Not Showing

1. Connect that address to the [Wallet Dashboard](https://wallet.iota.org).
2. Navigate to the **Migration** tab and copy your legacy address.
3. Paste it into the [Archived Tangle Explorer](https://explorer.iota.org/mainnet) to check past balances.
...
1. Use **Firefly v2.1.0+** to extract the seed.
   - [Restore From Seed or Stronghold](https://docs.iota.org/about-iota/iota-wallet/how-to/restore-account)
2. Import the extracted mnemonic into the new wallet:
   - [Getting Started with the IOTA Wallet](https://docs.iota.org/about-iota/iota-wallet/getting-started)
...
- Follow this guide to export the seed:  
  [Back up a Seed from a Firefly Profile](https://docs.iota.org/about-iota/iota-wallet/how-to/restore-account#back-up-a-seed-from-a-firefly-profile)
...
3. Log out and export the seed:  
   [Guide to Exporting Seed](https://docs.iota.org/about-iota/iota-wallet/how-to/restore-account#back-up-a-seed-from-a-firefly-profile)
