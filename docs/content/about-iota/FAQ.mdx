...
If you're using a **Ledger Nano S**, follow this [specific guide](../about-iota/iota-wallet/how-to/integrate-ledger.mdx).
...
2. Use the **Balance Finder** to search for all your addresses:
   - [How to use Balance Finder](../about-iota/iota-wallet/getting-started.mdx)

3. After finding your addresses, go to the [IOTA Wallet Dashboard](../about-iota/iota-wallet-dashboard/getting-started.mdx) and check:
   - **Migration Tab**: For unmigrated Stardust balances  
     [Migrate Stardust Assets](../about-iota/iota-wallet-dashboard/how-to/migration.mdx)
   - **Vesting Tab**: For airdropped or locked funds from the October 2024 upgrade  
     [Manage Vesting and Time-Locked Assets](../about-iota/iota-wallet-dashboard/how-to/vesting.mdx)

## 15. I'm Sure My Funds Are in a Specific Address But They’re Not Showing

1. Connect that address to the [Wallet Dashboard](../about-iota/iota-wallet-dashboard/getting-started.mdx).
...
1. Use **Firefly v2.1.0+** to extract the seed.
   - [Restore From Seed or Stronghold](../about-iota/iota-wallet/how-to/restore-account.mdx)
2. Import the extracted mnemonic into the new wallet:
   - [Getting Started with the IOTA Wallet](../about-iota/iota-wallet/getting-started.mdx)
...
- Follow this guide to export the seed:  
  [Back up a Seed from a Firefly Profile](../about-iota/iota-wallet/how-to/restore-account.mdx)
...
3. Log out and export the seed:  
   [Guide to Exporting Seed](../about-iota/iota-wallet/how-to/restore-account.mdx)
...
:::info
**We recommend** moving your funds out of legacy addresses to ensure compatibility and accessibility. See [Migrate Stardust Asset](../about-iota/iota-wallet-dashboard/how-to/migration.mdx)
:::
