...
New tokens are minted each epoch, totaling **767,000** IOTA per year. As a result, IOTA has no fixed maximum supply — the total supply fluctuates over time based on the balance between token inflation and fee burning.
