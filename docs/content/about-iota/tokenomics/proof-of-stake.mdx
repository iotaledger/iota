...
Staking IOTA implies the staked IOTA tokens are locked for the entire epoch.
...
For each transaction, users pay the associated computation fees and storage deposits.
