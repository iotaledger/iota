...
The main benefit of using EVM/Solidity is its sheer amount of resources from years of development. The [IOTA Smart Contracts](../developer/iota-evm/introduction.mdx) implementation is fully compatible with all of them. If you have experience developing other EVM-based chains, you will feel right at home. Any existing contracts you've written will need no changes to function on IOTA Smart Contracts.
