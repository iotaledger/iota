...
action to migrate all your funds, ot that you have vested tokens.
...
The IOTA Wallet now each address individually.
...
Restoring a wallet account using a seed is not an industry standard, it may not work on wallets that are not maintained
by the IOTA Foundation. Once you restore your account using the seed, make sure to [export your mnemonic](./how-to/multi-account.mdx#export-a-mnemonic-for-an-account).
