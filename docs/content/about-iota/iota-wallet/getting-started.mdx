...
Once you have [accessed the Balance Finder](#how-to-acccess-the-balance-finder), hit the `Search` button and the
...
If you have NFTs, native tokens, or time-locked tokens, you will see a button indicating that you need to migrate
them.
...
The IOTA Web Wallet does not support Stronghold. If you have your mnemonic, private key or seed, you can use them to
