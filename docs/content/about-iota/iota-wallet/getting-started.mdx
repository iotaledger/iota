...
* **Import private keys:** Transfer assets seamlessly from other wallets using a 32 or 64-byte address. (TODO CONFIRM)
...
1. Open a Chromium-based browser and visit the [IOTA Wallet page](#TODO ADD LINK) in the Chrome Web Store.
