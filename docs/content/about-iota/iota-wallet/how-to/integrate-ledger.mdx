...
8. Install the app on your device `ledgerctl install -f app_nanos.json`.
   If you get this error message error: `ledgerwallet.client.CommException: Exception : Invalid status 5103 (Unknown reason)`, then it means that you have not enough space left for the app.
