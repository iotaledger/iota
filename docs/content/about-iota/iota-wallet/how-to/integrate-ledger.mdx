# Use IOTA Wallet with a Ledger Wallet
...
2. [Install the IOTA app on your Ledger device](#install-the-IOTA-app-on-your-ledger-device)
3. [Import accounts from your device to IOTA Wallet](#import-accounts-from-your-device-to-IOTA-wallet)
4. [View account balance](#view-account-balance)
5. [Receive digital assets using IOTA Wallet](#receive-digital-assets-using-IOTA-wallet)
6. [Send digital assets using IOTA Wallet](#send-digital-assets-using-IOTA-wallet)
7. [Stake IOTA using IOTA Wallet](#stake-IOTA-using-IOTA-wallet)
8. [Support for IOTA Wallet](#support-for-IOTA-wallet)
...
For more information or assistance, visit the official IOTA Wallet support page.
