...
These Terms and Conditions (“Terms”) govern your participation in the IOTA Bounty Program (“Campaign”) operated by the IOTA Ecosystem DLT Foundation (“we”, “us”, or “our”). By participating in the Campaign you confirm that you have read, understood, and agreed to these Terms.
...
Choosing a Task: Browse the open issues on the GitHub Project board and find a task that aligns with your skillset. Once you have chosen a task, add a comment to it asking for it to be assigned to you. 
Contributing and Submitting: Work on the selected task and submit your contribution via the linked repository.
Raising a New Issue: IOTA community members are also welcome to create new issues and link them to the board for others to work on.
...
Participation in the Campaign requires the processing of certain personal data. By participating, you acknowledge that your data will be processed in accordance with the Privacy Policy.
