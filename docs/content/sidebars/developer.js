                        ...
                        items: [
                            {
                                type: 'category',
                                label: 'Mainnet',
                                items: [{ type: 'autogenerated', dirName: 'developer/references/iota-api/iota-graphql/reference/mainnet' }],
                            },
                            {
                                type: 'category',
                                label: 'Testnet',
                                items: [{ type: 'autogenerated', dirName: 'developer/references/iota-api/iota-graphql/reference/testnet' }],
                            },
                            {
                                type: 'category',
                                label: 'Devnet',
                                items: [{ type: 'autogenerated', dirName: 'developer/references/iota-api/iota-graphql/reference/devnet' }],
                            },
                        ],
                    },
                ],
