...
1. Open your IOTA Wallet and navigate to the Dashboard Home screen and click the `Staking` button on the left hand menu.
   ...
   ![Click Staking](/img/users/iota-wallet-dashboard/how-to/stake/click-staking.png)

2. Click `Stake`.

   ![Click Stake](/img/users/iota-wallet-dashboard/how-to/stake/click-stake.png)

3. Choose a validator and click `Select Amount`.

   ![Select Validator](/img/users/iota-wallet-dashboard/how-to/stake/select-validator.png)
...
4. Enter the amount of IOTA you want to stake. Make sure to leave enough IOTA in your wallet for potential transaction fees, then confirm by clicking `Stake`.
   ...
   ![Set Stake Amount](/img/users/iota-wallet-dashboard/how-to/stake/set-stake-amount.png)

5. Track the transaction in the [Explorer](https://explorer.iota.org/) by clicking `View on Explorer`.

   ![View on Explorer](/img/users/iota-wallet-dashboard/how-to/stake/view-on-explorer.png)
...
1. Open your IOTA Wallet and navigate to the Dashboard Home screen and click the `Staking` button on the left hand menu.
   ...
   ![Current Stake](/img/users/iota-wallet-dashboard/how-to/stake/click-staking.png)

2. Select a validator where your funds are currently staked.

   ![Current Stake List](/img/users/iota-wallet-dashboard/how-to/stake/current-stake-list.png)

3. View detailed information such as the amount staked, the number of epochs, and other relevant details.

   ![Current Stake Detail](/img/users/iota-wallet-dashboard/how-to/stake/current-stake-detail.png)
...
3. Click on the `Unstake` button.
   ...
   ![Unstake Button](/img/users/iota-wallet-dashboard/how-to/stake/current-stake-detail.png)

4. Review the details, click `Unstake`, and confirm the transaction in your wallet.

   ![Unstake](/img/users/iota-wallet-dashboard/how-to/stake/unstake-button.png)
