...
Alternatively, you can access the Migration View from the left side menu.
   ...
   ![Access Migration](/img/users/iota-wallet-dashboard/how-to/migration/access-migration.png)

## View Migration Details

Once in the [Migration view](#access-the-migration-view), you will see an overview of any assets you need to migrate. 

   ![Migration Overview](/img/users/iota-wallet-dashboard/how-to/migration/see-all.png)

You can click on the `See All` button to get a detailed view of the assets by type.

   ![Asset Details](/img/users/iota-wallet-dashboard/how-to/migration/migration-details.png)
...
will be rebated and the [gas fees](../../../about-iota/tokenomics/gas-pricing.mdx) for the transaction.

   ![Migration Confirmation](/img/users/iota-wallet-dashboard/how-to/migration/migration-confirmation.png)
