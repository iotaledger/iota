...
1. Open your IOTA Wallet and navigate to the `Home` tab.
   ...
   ![Home Tab](/img/users/iota-wallet/how-to/basics/home-tab.png)

2. Click `Start Staking`.

   ![Start Staking](/img/users/iota-wallet/how-to/stake/start-staking.png)

3. Choose a validator and click `Select Amount`.

   ![Select Validator](/img/users/iota-wallet/how-to/stake/select-validator.png)
...
4. Enter the amount of IOTA you want to stake. Make sure to leave enough IOTA in your wallet for potential transaction fees, then confirm by clicking `Stake`.
   ...
   ![Set Stake Amount](/img/users/iota-wallet/how-to/stake/set-stake-amount.png)

5. Track the transaction in the [Explorer](https://explorer.iota.org/) by clicking `View on Explorer`.

   ![View on Explorer](/img/users/iota-wallet/how-to/stake/view-on-explorer.png)
...
1. Open the `Home` tab and click `Current Stake`.
   ...
   ![Current Stake](/img/users/iota-wallet/how-to/stake/current-stake.png)

2. Select a validator where your funds are currently staked.

   ![Current Stake List](/img/users/iota-wallet/how-to/stake/current-stake-list.png)

3. View detailed information such as the amount staked, the number of epochs, and other relevant details.

   ![Current Stake Detail](/img/users/iota-wallet/how-to/stake/current-stake-detail.png)
...
3. Click on the `Unstake` button.
   ...
   ![Unstake Button](/img/users/iota-wallet/how-to/stake/unstake-button.png)

4. Review the details and click `Unstake`.

   ![Unstake](/img/users/iota-wallet/how-to/stake/unstake.png)
