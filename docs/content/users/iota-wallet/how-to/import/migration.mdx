...
them.
   ...
   ![Migration Button](/img/users/iota-wallet/getting-started/migration-button.png)
...
Dashboard](../../../iota-wallet-dashboard/getting-started.mdx) to migrate them.
   ...
   ![Migration Pop In](/img/users/iota-wallet/getting-started/migration-pop-in.png)
...
If your account has vested tokens, you will see a button indicating that you can access Vested Staking
   ...
   ![Migration Button](/img/users/iota-wallet/getting-started/vested-staking-button.png)

When you click on it, it prompt you to use the [IOTA Wallet
Dashboard](../../../iota-wallet-dashboard/getting-started.mdx) to manage your vested tokens.

   ![Migration Pop In](/img/users/iota-wallet/getting-started/vested-staking-pop-in.png)
