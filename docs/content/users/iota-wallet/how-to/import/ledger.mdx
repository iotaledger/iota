...
![Import From Ledger](/img/users/iota-wallet/how-to/ledger/import-from-ledger.png)

8. On the `Connect Ledger Wallet` screen, click `Continue`.

![Connect Ledger Wallet](/img/users/iota-wallet/how-to/ledger/connect-ledger-wallet.png)

9. Choose the wallets you want to import into IOTA Wallet, then click `Next`.

![Select Wallets](/img/users/iota-wallet/how-to/ledger/select-wallets.png)

10. Enter your password and click `Verify`.

![Verify Password](/img/users/iota-wallet/how-to/ledger/verify-password.png)
