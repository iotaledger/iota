...
If you are importing a profile, you will be prompted to use the Balance Finder as part of the import process.
   ...
   ![Balance Finder in Prompt](/img/users/iota-wallet/getting-started/access-balance-finder-prompt.png)

You can also access the balance finder by clicking on the `Balance Finder` button in the `Manage Accounts` view.

   ![Balance Finder in Accounts View](/img/users/iota-wallet/how-to/manage-accounts.png)
...
Balance Finder will retrieve any sub-accounts related to your main account. 
   ...
   ![Balance Finder Search](/img/users/iota-wallet/getting-started/balance-finder-hit-search.png)
