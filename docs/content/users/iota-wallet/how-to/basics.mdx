...
4. Input the recipient’s address and click `Review` to confirm.
   ...
   ![Review](/img/users/iota-wallet/how-to/basics/send-review.png)

5. Once you verify the transaction details, click `Send Now ->` to complete the transfer.

   ![Send Review](/img/users/iota-wallet/how-to/basics/send-now.png)
...
1. Click the `Activity` tab located in the lower-left corner of the wallet.
   ...
   ![Review activity](/img/users/iota-wallet/how-to/basics/activity.png)

2. Select a transaction to see further details about it.

   ![Transaction Details](/img/users/iota-wallet/how-to/basics/transactions.png)
...
2. Choose the `Auto Lock Profile` option.
   ...
   ![Auto lock profile](/img/users/iota-wallet/how-to/basics/autolock.png)

3. Set the desired auto-lock time by specifying the idle duration in minutes, then click `Save`.

   ![Auto lock timer](/img/users/iota-wallet/how-to/basics/autolock-time.png)
...
1. On the unlock screen, click `Forgot password?`.
   ...
   ![Forgot Password](/img/users/iota-wallet/how-to/basics/forgot-password.png)

2. Enter your 24-word mnemonic recovery phrase and click `Next`.

   ![Enter Mnemonic](/img/users/iota-wallet/how-to/basics/enter-mnemonic.png)

3. Create and confirm your new password, then click `Reset Password`.

   ![New Password](/img/users/iota-wallet/how-to/basics/new-password.png)
...
## Using Keystone Wallet

If you are using a [Keystone hardware wallet](https://keyst.one), the way you interact with the IOTA Wallet is mostly the same,
but to sign transactions there will be a few extra steps involved.
Once you initiate a transaction in the IOTA Wallet, you will need to confirm it on your Keystone device.
To do that, the Wallet will generate a QR code that you will need to scan with your Keystone device:

![Keystone QR Code](/img/users/iota-wallet/how-to/basics/keystone-step-1.png)

After confirming the transaction on your Keystone device, it will generate another QR code that you will need to scan with the IOTA Wallet to complete the transaction:

![Keystone Scan QR Code](/img/users/iota-wallet/how-to/basics/keystone-step-2.png)

For more information on using the Keystone wallet, please refer to the [Keystone Guides](https://guide.keyst.one/docs/category/keystone-3-pro/).
