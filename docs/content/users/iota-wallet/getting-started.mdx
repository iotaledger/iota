...
3. Enter your desired nickname and passkey storage and access.
...
6. On the pop-up, choose one of the available options to store your passkey and follow the instructions.
You can either use a Synced Passkey by storing it on your Phone/Tablet and corresponding accounts,
or use Device Bound Passkey and store it on your security key.
