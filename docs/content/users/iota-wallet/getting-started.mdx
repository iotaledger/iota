...
2. Choose **New Mnemonic Profile**.

   ![New Mnemonic Profile](/img/users/iota-wallet/how-to/multi-account/select-profile-type.png)
...
2. Choose **New Passkey Profile**.

   ![New Passkey Profile](/img/users/iota-wallet/how-to/multi-account/select-profile-type.png)
