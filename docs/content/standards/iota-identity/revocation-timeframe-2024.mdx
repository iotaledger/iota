...
## Concepts
`RevocationTimeframe2024` should be used together with selectively disclosable credentials - either [SD-JWT](../../guides/developer/iota-identity/how-tos/verifiable-credentials/selective-disclosure)
or [ZK-SD](../../guides/developer/iota-identity/how-tos/verifiable-credentials/zero-knowledge-selective-disclosure) - in order to conceal to the verifier
