...
This specification describes a mechanism for publishing the revocation status of [verifiable credentials](../../guides/developer/iota-identity/explanations/verifiable-credentials.mdx) embedded in an issuer's DID document.
