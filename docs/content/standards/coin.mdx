...
We highly recommend you to use the [Coin Manager](./coin-manager.mdx) functionality to manage your `Coin` instead of just keeping the `TreasuryCap`. This will provide more clarity to the end-user and will open up more functionality.
