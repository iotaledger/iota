...
IOTA Foundation offers a bare bones scaffold for React-based applications called `@iota/dapp-kit`. See the [dApp Kit documentation](https://docs.iota.org/references/ts-sdk/dapp-kit) for more informqtion.
