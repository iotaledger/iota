...
See the [coin module](/references/framework/iota/coin.mdx) documentation for all available options when creating a coin-type token on IOTA. 
...
- [`coin` module documentation](../../references/framework/iota/coin.mdx): Automated documentation output for the IOTA framework `coin` module.
- [`token` module documentation](../../references/framework/iota/token.mdx): Automated documentation output for the IOTA framework `token` module.
