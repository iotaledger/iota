...
See the [coin module](/references/framework/testnet/iota-framework/coin.mdx) documentation for all available options when creating a coin-type token on IOTA. 
...
- [`coin` module documentation](../../references/framework/testnet/iota-framework/coin.mdx): Automated documentation output for the IOTA framework `coin` module.
- [`token` module documentation](../../references/framework/testnet/iota-framework/token.mdx): Automated documentation output for the IOTA framework `token` module.
