...
IOTA is also supported by Nightly Connect to use you dApp with the Nightly wallet. Check their docs for more information: https://connect.nightly.app/docs/iota/iota/start
