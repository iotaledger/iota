...
```move file=<rootDir>/docs/examples/move/clt-tutorial/sources/clt_tutorial.move#L24
```
```move file=<rootDir>/docs/examples/move/clt-tutorial/sources/clt_tutorial.move#L25-L33
```
...
```move file=<rootDir>/docs/examples/move/clt-tutorial/sources/clt_tutorial.move#L79-L84
```

in which we check if we have enough voucher token for a LED bulb and then transfer it to the shop:

```move file=<rootDir>/docs/examples/move/clt-tutorial/sources/clt_tutorial.move#L85-L88
```
...
```move file=<rootDir>/docs/examples/move/clt-tutorial/sources/clt_tutorial.move#L37-L39
```
