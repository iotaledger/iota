...
```typescript file=<rootDir>/docs/examples/typescript/src/standards/kiosk/create-kiosk.ts
```
...
```typescript file=<rootDir>/docs/examples/typescript/src/standards/kiosk/create-kiosk-advanced.ts
```
...
```typescript file=<rootDir>/docs/examples/typescript/src/standards/kiosk/place-item.ts
```
...
```typescript file=<rootDir>/docs/examples/typescript/src/standards/kiosk/take-item.ts
```
...
```typescript file=<rootDir>/docs/examples/typescript/src/standards/kiosk/lock-item.ts
```
...
```typescript file=<rootDir>/docs/examples/typescript/src/standards/kiosk/list-item.ts
```
...
```typescript file=<rootDir>/docs/examples/typescript/src/standards/kiosk/delist-item.ts
```
...
```typescript file=<rootDir>/docs/examples/typescript/src/standards/kiosk/borrow-val.ts
```
...
```typescript file=<rootDir>/docs/examples/typescript/src/standards/kiosk/withdraw.ts
```
