...
Move's ownership and scope management was inspired from [Rust](https://doc.rust-lang.org/book/ch04-00-understanding-ownership.html): Every variable in Move has a scope and an owner. The scope is the range of code where the variable
...
There exists scenarions where we want to pass a variable to a function without transferring the ownership.
In this case, we can use references. To complete the understanding of ownership and scope, we recommend reading about:
- [Local variables and scope](https://github.com/move-language/move/blob/main/language/documentation/book/src/variables.md)
