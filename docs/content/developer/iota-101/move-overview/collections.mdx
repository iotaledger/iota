...
The [`Bag`](../../../references/framework/testnet/iota-framework/bag.mdx) module functions as a versatile, map-like collection.
...
incorporating [`iota::dynamic_field`](../../../references/framework/testnet/iota-framework/dynamic_field.mdx)s post-construction.
...
The [`iota::dynamic_object_field`](../../../references/framework/testnet/iota-framework/dynamic_object_field.mdx) module is similar
...
The [`Table`](../../../references/framework/testnet/iota-framework/table.mdx) module operates as a map-like collection but with a twist. 
...
[`LinkedTable`](../../../references/framework/testnet/iota-framework/linked_table.mdx) extends the functionality of the `Table` module by linking values together, allowing for ordered insertion
and removal.
This feature is particularly useful for scenarios where the order of elements is important.

## Table Vec

[`TableVec`](../../../references/framework/testnet/iota-framework/table_vec.mdx) is a scalable vector library implemented using the `Table` module, providing a flexible way to manage
sequential data.

## Object Table

[`ObjectTable<K, V>`](../../../references/framework/testnet/iota-framework/object_table.mdx)  is akin to the `Table` module, but with a requirement that all associated values are objects. This
...
The [`PriorityQueue`](../../../references/framework/testnet/iota-framework/priority_queue.mdx) module is implemented using a max heap,
providing an efficient way to manage prioritized elements.


## Vec Map

The [`VecMap`](../../../references/framework/testnet/iota-framework/vec_map.mdx) module provides a map-like structure backed by a vector.
...
[`VecSet`](../../../references/framework/testnet/iota-framework/vec_set.mdx) is a set-like data structure backed by a vector,
