...
* The [`std::string`](../../../references/framework/move-stdlib/string) module defines a `String` type and methods for working with UTF-8 encoded strings.
* The [`std::ascii`](../../../references/framework/move-stdlib/ascii) module provides an ASCII `String` type along with its methods.
...
* [`append`](../../../references/framework/move-stdlib/string#function-append).
* [`append_utf8`](../../../references/framework/move-stdlib/string#function-append_utf8).
* [`substring`](../../../references/framework/move-stdlib/string#function-sub_string).
* [`length`](../../../references/framework/move-stdlib/string#function-length).
* [`is_empty`](../../../references/framework/move-stdlib/string#function-is_empty).
...
The default `utf8` method may abort if the bytes passed into it are not valid UTF-8. If you're unsure whether the bytes are valid, you should use the [`try_utf8`](../../../references/framework/move-stdlib/string#function-try_utf8) method instead. It returns an [`Option<String>`](../../../references/framework/move-stdlib/option.mdx#0x1_option_Option), which contains no value if the bytes are not valid UTF-8, and a `String` otherwise.
