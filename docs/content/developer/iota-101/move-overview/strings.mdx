...
```move file=<rootDir>/crates/iota-framework/packages/move-stdlib/sources/string.move#L16-L19
```
...
```move file=<rootDir>/docs/examples/move/move-overview/string.move#L65-L73
```
