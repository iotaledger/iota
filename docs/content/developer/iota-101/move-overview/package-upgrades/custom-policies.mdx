...
These policies secure access to the [`UpgradeCap`](../../../../references/framework/iota-framework/package#resource-upgradecap) and issue [`UpgradeTicket`](../../../../references/framework/iota-framework/package#struct-upgradeticket) objects,
...
The [`UpgradeCap`](../../../../references/framework/iota-framework/package#resource-upgradecap) type is crucial for managing package upgrades:
...
An [`UpgradeTicket`](../../../../references/framework/iota-framework/package#struct-upgradeticket) is a proof of authorization for an upgrade,
specific to:
...
An [`UpgradeReceipt`](../../../../references/framework/iota-framework/package#struct-upgradereceipt) confirms
...
You should use the IOTA Client CLI to call [`iota::package::make_immutable`](../../../../references/framework/iota-framework/package#function-make_immutable) on the
