...
These policies secure access to the [`UpgradeCap`](../../../../references/framework/Testnet/iota-framework/package.mdx#resource-upgradecap) and issue [`UpgradeTicket`](../../../../references/framework/Testnet/iota-framework/package.mdx#struct-upgradeticket) objects,
...
The [`UpgradeCap`](../../../../references/framework/Testnet/iota-framework/package.mdx#resource-upgradecap) type is crucial for managing package upgrades:
...
An [`UpgradeTicket`](../../../../references/framework/Testnet/iota-framework/package.mdx#struct-upgradeticket) is a proof of authorization for an upgrade,
specific to:
...
An [`UpgradeReceipt`](../../../../references/framework/Testnet/iota-framework/package.mdx#struct-upgradereceipt) confirms
...
You should use the IOTA Client CLI to call [`iota::package::make_immutable`](../../../../references/framework/Testnet/iota-framework/package.mdx#function-make_immutable) on the
