...
These policies secure access to the [`UpgradeCap`](../../../../references/framework/iota-framework/package.mdx#struct-upgradecap) and issue [`UpgradeTicket`](../../../../references/framework/iota-framework/package.mdx#struct-upgradeticket) objects,
...
The [`UpgradeCap`](../../../../references/framework/iota-framework/package.mdx#struct-upgradecap) type is crucial for managing package upgrades:
