...
These policies secure access to the [`UpgradeCap`](../../../../references/framework/iota/package.mdx#resource-upgradecap) and issue [`UpgradeTicket`](../../../../references/framework/iota/package.mdx#struct-upgradeticket) objects,
...
The [`UpgradeCap`](../../../../references/framework/iota/package.mdx#resource-upgradecap) type is crucial for managing package upgrades:
