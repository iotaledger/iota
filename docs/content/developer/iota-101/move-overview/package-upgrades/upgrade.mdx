...
The [`make_immutable` function](../../../../references/framework/iota-framework/package#function-make_immutable) allows you 
to enforce this behavior.
For more complex policies, you can leverage types like [`UpgradeTicket`](../../../../references/framework/iota-framework/package#struct-upgradeticket) and [`UpgradeReceipt`](../../../../references/framework/iota-framework/package#struct-upgradereceipt).

### CLI-Driven Upgrade Process

When you use the IOTA Client CLI,
the `upgrade` command simplifies the [package](../../../../references/framework/iota-framework/package) upgrade process.
