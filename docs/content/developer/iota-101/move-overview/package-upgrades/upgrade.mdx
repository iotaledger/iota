...
The [`make_immutable` function](../../../../references/framework/testnet/iota-framework/package.mdx#function-make_immutable) allows you 
to enforce this behavior.
For more complex policies, you can leverage types like [`UpgradeTicket`](../../../../references/framework/testnet/iota-framework/package.mdx#struct-upgradeticket) and [`UpgradeReceipt`](../../../../references/framework/testnet/iota-framework/package.mdx#struct-upgradereceipt).

### CLI-Driven Upgrade Process

When you use the IOTA Client CLI,
the `upgrade` command simplifies the [package](../../../../references/framework/testnet/iota-framework/package.mdx) upgrade process.
