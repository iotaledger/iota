...
To use this command, the CLI's active address must own the [`UpgradeCap`](../../../../references/framework/iota-framework/package) object
...
You can do this with the [`iota::package::make_immutable`](../../../../references/framework/iota-framework/package#function-make_immutable) function,
