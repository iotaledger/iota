...
To use this command, the CLI's active address must own the [`UpgradeCap`](../../../../references/framework/testnet/iota-framework/package.mdx) object
...
You can do this with the [`iota::package::make_immutable`](../../../../references/framework/testnet/iota-framework/package.mdx#function-make_immutable) function,
