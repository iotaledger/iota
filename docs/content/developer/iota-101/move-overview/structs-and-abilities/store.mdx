...
- bool
- unsigned integers
- [vector](../../../../references/framework/Testnet/move-stdlib/vector.mdx)
- [address](../../../../references/framework/Testnet/move-stdlib/address.mdx)

All of the types defined in the standard library have the `store` ability as well. This includes:

- [Option](../../../../references/framework/Testnet/move-stdlib/option.mdx)
- [String](../../../../references/framework/Testnet/move-stdlib/string.mdx)
- [TypeName](../../../../references/framework/Testnet/move-stdlib/type_name.mdx)