...
`key` ability, nor can any of the [Standard Library](../../../../references/framework/Testnet/move-stdlib/_category_.json) types.
The `key` ability is only present in the [IOTA Framework](../../../../references/framework/Testnet/iota-framework/_category_.json) and
custom types.
