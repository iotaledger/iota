...
In previous tutorial we have discussed about comparision of shared object with owned object. In this tutorial we will write an contract to understand more about shared objects.
