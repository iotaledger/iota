...
- Can be transferred by anyone using the[ `iota::transfer::public_transfer`](../../../../references/framework/Testnet/iota-framework/transfer.mdx#function-public_transfer) function.
...
typically using the [`iota::transfer::transfer`](../../../../references/framework/Testnet/iota-framework/transfer.mdx#function-transfer) function.
...
these custom rules are the only ways to transfer `O`—the [`iota::transfer::public_transfer`](../../../../references/framework/Testnet/iota-framework/transfer.mdx#function-public_transfer) function cannot be used.
