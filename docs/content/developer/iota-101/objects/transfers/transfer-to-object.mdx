...
The core of the receiving interface is defined in the [`iota::transfer`](../../../../references/framework/iota-framework/transfer) module in the IOTA framework:
...
- **Receiving Argument:** Each `Receiving` argument in a PTB refers to an object of type `T` and is represented by [`iota::transfer::Receiving<T>`](../../../../references/framework/iota-framework/transfer#struct-receiving).
- **Receiving an Object:** To receive the object, call the [`iota::transfer::receive`](../../../../references/framework/iota-framework/transfer#function-receive) function with a mutable reference to the parent object's `UID`. The module defining the parent object controls access and sets any restrictions on receiving the child object.
...
Because [`iota::transfer::Receiving`](../../../../references/framework/iota-framework/transfer#struct-receiving) has only the `drop` ability,
...
- **Module-Specific Reception:** You can use the [`iota::transfer::receive`](../../../../references/framework/iota-framework/transfer#function-receive)  function only on objects defined in the same module where the `receive` call is made, similar to the [`iota::transfer::transfer`](../../../../references/framework/iota-framework/transfer#function-transfer)  function.
- **Public Reception:** For objects that also have the `store` ability, anyone can use the [`iota::transfer::public_receive`](../../../../references/framework/iota-framework/transfer#function-public_receive)  function to receive them, akin to the [`iota::transfer::public_transfer`](../../../../references/framework/iota-framework/transfer#function-public_transfer) function.
...
`receive_object` must also use the [`iota::transfer::public_receive`](../../../../references/framework/iota-framework/transfer#function-public_receive)
function to receive the object and not [`iota::transfer::receive`](../../../../references/framework/iota-framework/transfer#function-receive)
