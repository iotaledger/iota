...
see [`iota::object_table::ObjectTable`](../../../../references/framework/iota-framework/object_table.mdx#struct-objecttable).
...
see [`iota::object_bag::ObjectBag`](../../../../references/framework/iota-framework/object_bag.mdx#struct-objectbag).
