...
[`Table`](../../../../references/framework/iota/table.mdx) and 
[`Bag`](../../../../references/framework/iota/bag.mdx)—built on dynamic fields but equipped with mechanisms to count entries and prevent accidental deletion when non-empty.

IOTA also offers [`ObjectTable`](../../../../references/framework/iota/object_table.mdx)
and [`ObjectBag`](../../../../references/framework/iota/object_bag.mdx) for scenarios
...
A [`Table<K, V>`](../../../../references/framework/iota/table.mdx) is a homogeneous map where all keys
(`K`) and values (`V`) share the same type. 
These tables are created using [`iota::table::new`](../../../../references/framework/iota/table.mdx#function-new),
...
see [`iota::object_table::ObjectTable`](../../../../references/framework/iota/object_table.mdx#resource-objecttable).
...
Unlike `Table`, [`Bag`](../../../../references/framework/iota/bag.mdx) is a heterogeneous map capable of holding key-value pairs of different types.
...
see [`iota::object_bag::ObjectBag`](../../../../references/framework/iota/object_bag.mdx#resource-objectbag).
