...
To work with these fields, you can use the modules provided by IOTA: [`dynamic_field`](../../../../references/framework/testnet/iota-framework/dynamic_field.mdx) and [`dynamic_object_field`](../../../../references/framework/testnet/iota-framework/dynamic_object_field.mdx).
...
using the [`borrow_mut`](../../../../references/framework/testnet/iota-framework/dynamic_field.mdx#function-borrow_mut) function. 
...
The [`iota::dynamic_object_field`](../../../../references/framework/testnet/iota-framework/dynamic_object_field.mdx) module also offers an equivalent function for object fields.

:::

Once removed, the value can be used like any other value. 
For instance, you can [`delete`](../../../../references/framework/testnet/iota-framework/object.mdx#function-delete)
or [`transfer`](../../../../references/framework/testnet/iota-framework/transfer.mdx) a removed object:
...
IOTA offers [`Table`](../../../../references/framework/testnet/iota-framework/table.mdx) and [`Bag`](../../../../references/framework/testnet/iota-framework/bag.mdx) collections 
