...
use the [`transfer::public_freeze_object`](../../../../references/framework/Testnet/iota-framework/transfer.mdx#function-public_freeze_object) function:
...
The [`public_freeze_object`](../../../../references/framework/Testnet/iota-framework/transfer.mdx#function-public_freeze_object) function requires the object
...
Alternatively, you can create an immutable object directly upon its creation using the [`transfer::public_freeze_object`](../../../../references/framework/Testnet/iota-framework/transfer.mdx#function-public_freeze_object) function:
