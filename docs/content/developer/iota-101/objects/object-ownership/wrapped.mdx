...
The example also uses [`coin::into_balance`](../../../../references/framework/testnet/iota-framework/coin.mdx#function-into_balance)
to wrap the fee's [`Coin`](../../../../references/framework/testnet/iota-framework/coin.mdx) into a
[`Balance`](../../../../references/framework/testnet/iota-framework/balance.mdx).
...
This flexibility can be achieved using [`Option`](../../../../references/framework/testnet/move-stdlib/option.mdx).
...
If you call [`option::fill`](../../../../references/framework/testnet/move-stdlib/option.mdx#function-fill) without checking and taking out the existing sword,
an error will occur.
...
Another approach is wrapping objects in a [`vector`](../../../../references/framework/testnet/move-stdlib/vector.mdx),
