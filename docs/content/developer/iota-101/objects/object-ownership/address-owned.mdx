...
use one of the following functions from the [transfer module](../../../../references/framework/testnet/iota-framework/transfer.mdx):
...
- Use [`iota::transfer::transfer`](../../../../references/framework/testnet/iota-framework/transfer.mdx#function-transfer) when defining a [custom transfer policy](../transfers/custom-rules.mdx) for the object.
- Use [`iota::transfer::public_transfer`](../../../../references/framework/testnet/iota-framework/transfer.mdx#function-public_transfer) if the object has the `store` capability and you do not need a custom policy.
...
A common example of an address-owned object is a [Coin object](../../../../references/framework/testnet/iota-framework/coin.mdx).
