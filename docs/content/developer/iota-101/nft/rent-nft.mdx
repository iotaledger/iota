...
- Creator-defined royalties are respected by encompassing [transfer policy rules](../objects/transfers/custom-rules.mdx).
...
- [Temporary assets and subscriptions](#temporary-assets-and-subscriptions)
