...
The [`borrow` module](../../../../references/framework/testnet/iota-framework/borrow.mdx) in the IOTA framework offers valuable features for working with objects by reference within your PTBs.
