...
This guide illustrates how to build a [programmable transaction block (PTB)](programmable-transaction-blocks) on IOTA using the [TypeScript SDK](../../../../references/ts-sdk/typescript/install.mdx). 
...
With PTBs, you can use the gas payment coin to create coins with a specific balance using [`splitCoin`](prog-txn-blocks.mdx#splitcoins.
