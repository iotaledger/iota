...
:::info
For the most up to date and complete list of [protocol configuration values](https://github.com/iotaledger/iota/blob/mainnet/crates/iota-protocol-config/src/lib.rs#L1581) (including any newly added limits), refer to the source in the IOTA repository.
:::
