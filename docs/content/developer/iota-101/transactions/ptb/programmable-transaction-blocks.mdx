...
- **Commands**: A list of commands `[Command]` that specify the actions to execute. Possible commands include:
  ...
  - [`Upgrade`](#upgrade): Upgrade an existing package, gated by [`iota::package::UpgradeCap`](../../../../references/framework/iota/package.mdx#resource-upgradecap).
...
- `Publish`: Returns the [upgrade capability](../../../../references/framework/iota/package.mdx#resource-upgradecap) for the new package.
...
- **Notes**:
  ...
  - Produces an [`iota::package::UpgradeCap`](../../../../references/framework/iota/package.mdx#resource-upgradecap).
...
- **Usage**:
  ...
  - `UpgradeTicket`: Obtained from [`iota::package::UpgradeCap`](../../../../references/framework/iota/package.mdx#resource-upgradecap).
- **Notes**:
