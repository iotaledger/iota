...
:::tip 
You can follow the [Sponsored Transaction Tutorial](../../../tutorials/sponsored-transactions/sponsored-txs.mdx) for a step-by-step guide on building a gas station server.
:::
