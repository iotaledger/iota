...
On the IOTA network, executing a transaction requires a gas payment, which is a list of [`0x2::coin::Coin<0x2::iota::IOTA>`](../../../../references/framework/testnet/iota-framework/coin.mdx) objects that get burned.
