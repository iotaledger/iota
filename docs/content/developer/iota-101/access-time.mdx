...
**Note**: The `Clock` timestamp changes at the rate the network generates checkpoints, which is **every 0.2 to 0.25 seconds** with Mysticeti and Starfish consensus.
