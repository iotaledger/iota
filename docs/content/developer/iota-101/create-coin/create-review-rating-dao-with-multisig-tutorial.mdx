...
Welcome to this beginner-friendly tutorial on [Move](https://move-language.github.io/move/) programming! We will build a Review Rating DAO with Multisig that allows customers to buy, claim, and transfer coffee tokens. The example demonstrates an implementation of a review rating platform for the food service industry using multisig on Sui.
