...
This function not only creates the coin but also generates a [`DenyCap`](../../../references/framework/iota/coin.mdx#resource-denycapv1) object,
...
Notice that a [`RegulatedCoinMetadata`](../../../references/framework/iota/coin.mdx#resource-regulatedcoinmetadata) object 
is created alongside the standard [`CoinMetadata`](../../../references/framework/iota/coin.mdx#resource-coinmetadata) object.
...
- [`UpgradeCap`](../../../references/framework/iota/package.mdx#resource-upgradecap) for [package upgrades](../move-overview/package-upgrades/upgrade.mdx).
- [`TreasuryCap`](../../../references/framework/iota/coin.mdx#resource-treasurycap) for minting or burning coins.
- [`DenyCap`](../../../references/framework/iota/coin.mdx#resource-denycapv1) for managing the deny list associated with this coin.
