...
The IOTA [Coin](../../standards/coin.mdx) standard offers the [`create_regulated_currency`](../../../references/framework/Testnet/iota-framework/coin.mdx#function-create_regulated_currency_v1) function
to create such coins.
This function not only creates the coin but also generates a [`DenyCap`](../../../references/framework/Testnet/iota-framework/coin.mdx#resource-denycapv1) object,
\enabling you to manage a deny list via a [`DenyList`](../../../references/framework/Testnet/iota-framework/deny_list.mdx) object.
The process is akin to using [`create_currency`](../../../references/framework/Testnet/iota-framework/coin.mdx#function-create_currency),
...
Notice that a [`RegulatedCoinMetadata`](../../../references/framework/Testnet/iota-framework/coin.mdx#resource-regulatedcoinmetadata) object 
is created alongside the standard [`CoinMetadata`](../../../references/framework/Testnet/iota-framework/coin.mdx#resource-coinmetadata) object.
...
- [`UpgradeCap`](../../../references/framework/Testnet/iota-framework/package.mdx#resource-upgradecap) for [package upgrades](../move-overview/package-upgrades/upgrade.mdx).
- [`TreasuryCap`](../../../references/framework/Testnet/iota-framework/coin.mdx#resource-treasurycap) for minting or burning coins.
- [`DenyCap`](../../../references/framework/Testnet/iota-framework/coin.mdx#resource-denycapv1) for managing the deny list associated with this coin.
...
For a complete list of available `Coin` functions, refer to the IOTA framework [`coin` module documentation](../../../references/framework/Testnet/iota-framework/coin.mdx).
