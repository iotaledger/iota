...
The IOTA [Coin](../../standards/coin.mdx) standard offers the [`create_regulated_currency`](../../../references/framework/iota-framework/coin.mdx#function-create_regulated_currency) function
to create such coins.
This function not only creates the coin but also generates a [`DenyCap`](../../../references/framework/iota-framework/coin.mdx#resource-denycap) object,
...
- [`DenyCap`](../../../references/framework/iota-framework/coin.mdx#resource-denycap) for managing the deny list associated with this coin.
