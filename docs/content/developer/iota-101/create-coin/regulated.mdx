...
This function not only creates the coin but also generates a [`DenyCap`](../../../references/framework/iota-framework/coin.mdx#struct-denycapv1) object,
...
Notice that a [`RegulatedCoinMetadata`](../../../references/framework/iota-framework/coin.mdx#struct-regulatedcoinmetadata) object 
is created alongside the standard [`CoinMetadata`](../../../references/framework/iota-framework/coin.mdx#struct-coinmetadata) object.
...
- [`UpgradeCap`](../../../references/framework/iota-framework/package.mdx#struct-upgradecap) for [package upgrades](../move-overview/package-upgrades/upgrade.mdx).
- [`TreasuryCap`](../../../references/framework/iota-framework/coin.mdx#struct-treasurycap) for minting or burning coins.
- [`DenyCap`](../../../references/framework/iota-framework/coin.mdx#struct-denycapv1) for managing the deny list associated with this coin.
