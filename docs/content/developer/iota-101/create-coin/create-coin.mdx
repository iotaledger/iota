...
By accessing the [`TreasuryCap`](../../../references/framework/iota/coin.mdx#resource-treasurycap),
...
and also produces a [`DenyCap`](../../../references/framework/iota/coin.mdx#resource-denycapv1) object.
...
Tokens reuse the [`TreasuryCap`](../../../references/framework/iota/coin.mdx#resource-denycapv1) defined in the `iota::coin` module
