...
By accessing the [`TreasuryCap`](../../../references/framework/iota-framework/coin.mdx#struct-treasurycap),
...
and also produces a [`DenyCap`](../../../references/framework/iota-framework/coin.mdx#struct-denycapv1) object.
...
Tokens reuse the [`TreasuryCap`](../../../references/framework/iota-framework/coin.mdx#struct-treasurycap) defined in the `iota::coin` module
