...
It also sets up a policy by sending both the [policy capability](../../../references/framework/iota/token.mdx#resource-tokenpolicycap) 
and the [treasury capability](../../../references/framework/iota/coin.mdx#resource-treasurycap) to the address associated with the publish event.
