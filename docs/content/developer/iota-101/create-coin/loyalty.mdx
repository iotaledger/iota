...
```move file=<rootDir>/examples/move/token/sources/loyalty.move#L24
```
...
```move file=<rootDir>/examples/move/token/sources/loyalty.move#L38-L64
```
...
```move file=<rootDir>/examples/move/token/sources/loyalty.move#L72-L82
```
...
```move file=<rootDir>/examples/move/token/sources/loyalty.move#L86-L99
```
