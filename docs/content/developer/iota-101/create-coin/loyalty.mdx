...
to create [tokens](../../../references/framework/Testnet/iota-framework/token.mdx) that are valid only within a specific service.
...
The initializer function calls [`create_currency`](../../../references/framework/Testnet/iota-framework/coin.mdx#function-create_currency)
using the `LOYALTY` type defined earlier.
It also sets up a policy by sending both the [policy capability](../../../references/framework/Testnet/iota-framework/token.mdx#resource-tokenpolicycap) 
and the [treasury capability](../../../references/framework/Testnet/iota-framework/coin.mdx#resource-treasurycap) to the address associated with the publish event.
...
It uses the [`token::mint`](../../../references/framework/Testnet/iota-framework/token.mdx#function-mint) function
to create the tokens and [`token::transfer`](../../../references/framework/Testnet/iota-framework/token.mdx#function-transfer) to deliver them to the intended recipients.
...
It uses the [`token::spend`](../../../references/framework/Testnet/iota-framework/token.mdx#function-spend) function to manage the treasury bookkeeping.
