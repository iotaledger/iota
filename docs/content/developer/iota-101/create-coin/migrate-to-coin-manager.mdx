...
```bash
iota client call --package <COIN-MANAGER-PACKAGE-ID> --module my_coin_manager --function migrate_to_manager --gas-budget 100000000 --type-args <MYCOIN-PACKAGE-ID>::my_coin::MY_COIN <COIN-MANAGER-PACKAGE-ID>::my_coin_manager::my_coin_manager --args <Guardian-OBJECT-ID> <TreasuryCap-OBJECT-ID> <CoinMetadata-OBJECT-ID>
```
