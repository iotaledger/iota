---
title: Transaction Data Cryptographic Protection in Authenticators
tags: [move-sc, account-abstraction, how-to]
teams:
  - iotaledger/vm-language
description: Learn how to properly implement transaction data cryptographic protection in authenticator functions to prevent transaction tampering attacks.
---

This guide explains the importance of cryptographic protection for the transaction data when building authenticator functions and demonstrates a critical vulnerability that can occur when it's missing.
...
```rust file=<rootDir>/docs/examples/rust/abstract_account/authenticator-tx-data-cryptographic-protection.rs#L229-L244
```
