...
```rust file=<rootDir>/docs/examples/rust/abstract_account/authenticator-shared-object-swap.rs#L192-L217
```

The swap function replaces the shared object reference in the transaction:

```rust file=<rootDir>/docs/examples/rust/abstract_account/authenticator-shared-object-swap.rs#L438-L466
```
