...
IOTA DID Documents according to the read procedure defined in the [IOTA DID Method Specification](../../../../developer/references/iota-identity/iota-did-method-spec.mdx#read).
It fetches the `Identity` from the network specified in the DID (see [DID Format](../../../../developer/references/iota-identity/iota-did-method-spec.mdx#did-format)),
