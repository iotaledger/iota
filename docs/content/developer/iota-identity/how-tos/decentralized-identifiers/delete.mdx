...
As detailed in the [IOTA DID Method Specification](../../../../developer/references/iota-identity/iota-did-method-spec.mdx#deactivate),
...
Alternatively, you can [delete](../../../../developer/references/iota-identity/iota-did-method-spec.mdx) an IOTA DID permanently.
