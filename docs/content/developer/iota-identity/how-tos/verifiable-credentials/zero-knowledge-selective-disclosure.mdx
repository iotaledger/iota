...
```rust reference
https://github.com/iotaledger/identity.rs/tree/beta/examples/1_advanced/9_zkp.rs#L95-L122
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/beta/bindings/wasm/identity_wasm/examples/src/1_advanced/8_zkp.ts#L51-L75
```
...
```rust reference
https://github.com/iotaledger/identity.rs/tree/beta/examples/1_advanced/9_zkp.rs#L178-L204
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/beta/bindings/wasm/identity_wasm/examples/src/1_advanced/8_zkp.ts#L123-L144
```
...
```rust reference
https://github.com/iotaledger/identity.rs/tree/beta/examples/1_advanced/9_zkp.rs#L219-L238
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/beta/bindings/wasm/identity_wasm/examples/src/1_advanced/8_zkp.ts#L156-L170
```
...
```rust reference
https://github.com/iotaledger/identity.rs/tree/beta/examples/1_advanced/9_zkp.rs
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/beta/bindings/wasm/identity_wasm/examples/src/1_advanced/8_zkp.ts
```
