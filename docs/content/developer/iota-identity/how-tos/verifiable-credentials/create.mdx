...
In the IOTA Identity Library, you can create a Verifiable Credential with the following properties:
...
The IOTA Identity Library supports the following checks during credential validation:
