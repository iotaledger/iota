...
```rust reference
https://github.com/iotaledger/identity.rs/blob/beta/examples/1_advanced/7_sd_jwt.rs
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/beta/bindings/wasm/identity_wasm/examples/src/1_advanced/6_sd_jwt.ts
```
