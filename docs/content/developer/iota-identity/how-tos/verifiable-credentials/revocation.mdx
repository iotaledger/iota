...
using the IOTA Identity Library:
...
The IOTA Identity Library supports two different revocation methods: `RevocationBitmap2022` and `StatusList2021`.

### Revocation Bitmap

[RevocationBitmap2022](../../references/revocation-bitmap-2022.mdx) is the default credential revocation method used in the IOTA Identity Library. It allows
...
```rust reference
https://github.com/iotaledger/identity.rs/tree/beta/examples/0_basic/7_revoke_vc.rs#L132
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/beta/bindings/wasm/identity_wasm/examples/src/0_basic/7_revoke_vc.ts#L130
```
...
```rust reference
https://github.com/iotaledger/identity.rs/tree/beta/examples/1_advanced/8_status_list_2021.rs#L57-L61
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/beta/bindings/wasm/identity_wasm/examples/src/1_advanced/7_status_list_2021.ts#L56-L60
```
...
```rust reference
https://github.com/iotaledger/identity.rs/tree/beta/examples/1_advanced/8_status_list_2021.rs#L144
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/beta/bindings/wasm/identity_wasm/examples/src/1_advanced/7_status_list_2021.ts#L131
```
...
```rust reference
https://github.com/iotaledger/identity.rs/tree/beta/examples/0_basic/7_revoke_vc.rs#L159-L166
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/beta/bindings/wasm/identity_wasm/examples/src/0_basic/7_revoke_vc.ts#L157-L160
```
...
```rust reference
https://github.com/iotaledger/identity.rs/tree/beta/examples/0_basic/7_revoke_vc.rs
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/beta/bindings/wasm/identity_wasm/examples/src/0_basic/7_revoke_vc.ts
```
