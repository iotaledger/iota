...
```rust reference
https://github.com/iotaledger/identity.rs/tree/v1.6.0-alpha/examples/0_basic/7_revoke_vc.rs#L133
```
...
```rust reference
https://github.com/iotaledger/identity.rs/tree/v1.6.0-alpha/examples/1_advanced/8_status_list_2021.rs#L58-L62
```
...
```rust reference
https://github.com/iotaledger/identity.rs/tree/v1.6.0-alpha/examples/1_advanced/8_status_list_2021.rs#L145
```
...
```rust reference
https://github.com/iotaledger/identity.rs/tree/v1.6.0-alpha/examples/0_basic/7_revoke_vc.rs#L197-L206
```
