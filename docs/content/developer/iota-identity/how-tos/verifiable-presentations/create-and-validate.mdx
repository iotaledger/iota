...
```rust reference
https://github.com/iotaledger/identity.rs/blob/beta/examples/0_basic/6_create_vp.rs
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/beta/bindings/wasm/identity_wasm/examples/src/0_basic/6_create_vp.ts
```
