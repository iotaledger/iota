...
For detailed information about the IOTA DID method, refer to the [IOTA DID Method Specification](../../../developer/references/iota-identity/iota-did-method-spec.mdx).
