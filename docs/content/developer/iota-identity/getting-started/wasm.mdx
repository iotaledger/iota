...
You can find more usage examples and tutorials in the [identity examples repository](https://github.com/iotaledger/identity.rs/blob/v1.6.0-beta/bindings/wasm/identity_wasm/examples/README.md).