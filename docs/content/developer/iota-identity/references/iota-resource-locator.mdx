...
first path segment MUST be an IOTA object ID canonically encoded as a 64 lowercase-hex characters preceeded
by the "0x" prefix.
...
within the context of the `fields` object, to obtain the resoution result.
