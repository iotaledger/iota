...
The IOTA method is a specific implementation following the [IOTA DID Method Specification](../../../developer/references/iota-identity/iota-did-method-spec.mdx).
