...
![Full Page](./images/fullimage1.png)
...
<Tabs groupId="os-install" defaultValue="macos">
  <TabItem value="macos" label="macOS">
    <h3>Step 1: Install `rustup` (The Rust Installer)</h3>
    ...
    <h3>Step 2: Configure Your Shell Environment</h3>
    ...
    <h3>Step 4: Update (Maintenance)</h3>
...
<Tabs groupId="os-install" defaultValue="macos">
  <TabItem value="macos" label="macOS">
    <h3>Install VS Code on macOS</h3>
  ...
  <TabItem value="windows" label="Windows">
    <h3>Install VS Code on Windows</h3>
...
<h3>Step 1.1: Project Initialization</h3>
...
<h3> Helper Function: `get_stronghold_storage`</h3>
...
<h3>Helper Function: `get_funded_client`</h3>
...
<h3>Helper Function: `create_did_document`</h3>
...
<h3>Integration with `create_or_load_did`</h3>
...
![Full Page](./images/issuedegree.png)

<h3>Frontend (`src/App.jsx`):</h3>
...
<h3>1. Create/Load University Decentralized Identifier (DID):</h3>
...
<h3>2. Load Student Decentralized Identifier:</h3>
...
<h3>3. Build Verifiable Credential:</h3>
...
<h3>4. Sign Verifiable Credential:</h3>
...
<h3>5. Return Verifiable Credential JWT:</h3>
...
<h3>Integration with the Workshop</h3>
...
![Full Page](./images/showdegree.png)
...
<h3>Backend: `holder_create_vp` Function</h3>
...
![Full Page](./images/validatedegree.png)
...
<h3>Backend: `verifier_validate` Function</h3>
...
3. <h3>Validate Verifiable Presentation Signature and Challenge:</h3>
...
4. <h3>Extract and Validate Embedded Credentials:</h3>
    - Code:
```rust
let jwt_credentials: &Vec<Jwt> = &decoded_vp.presentation.verifiable_credential;
output.push_str(&format!("📦 VP contains {} credential(s)\n", jwt_credentials.len()));
...
5. <h3>Return Validation Result:</h3>
    - Code:
