...
Universities can issue tamper-proof Verifiable Credentials (VCs) that students control using the IOTA Identity. Students present these credentials to employers, who can instantly verify them on the IOTA network without intermediaries, cutting costs and eliminating fraud.
...
### Step 2.2: Step 1: Student Creates Decentralized Identifier (DID)
...
![Create DID output](./images/CreateDID.png)

### Step 2.3: Step 2: University Issues Verifiable Credential
...
Output after a successful creation of the student’s VC.

![Create DID output](./images/IssueVC.png)

### Step 2.4: Step 3: Student Creates Verifiable Presentation
...
Output after a successful creation of the student’s VP.
![Create DID output](./images/CreateVP.png)

### Step 2.5: Step 4: Employer Validates VP (The Final Proof)
...
Output after a successful validation of the student’s VP.
![Create DID output](./images/VerifyVP2.png)
