...
- **Holder (Student)**: Creates a Decentralized Identifier (DID) and stores it securely.
...
<Tabs groupId="os-install" defaultValue="macos">
  <TabItem value="macos" label="macOS">
    ...
    > **Note**: If using Bash, the command might be `source $HOME/.bashrc`. The `rustup` installer will display the correct command upon completion. Restart your terminal if needed.
  ...
  <TabItem value="windows" label="Windows">
    ...
    > **Note**: If you encounter permission issues, right-click `rustup-init.exe` and select "Run as administrator".
...
Visit the [Scaffold Code](/developer/tutorials/identity-workshop-scaffold) page to copy the code for `main.rs` and `App.jsx`. The page provides instructions for macOS and Windows to set up the files correctly.
...
### Step 2.3: Step 2: Issuer Issues Verifiable Credential
...
2. ## Load Holder Decentralized Identifier:
...
### Step 2.4: Step 3: Holder Creates Verifiable Presentation
