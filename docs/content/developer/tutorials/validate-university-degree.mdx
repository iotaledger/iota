...
You need a local IOTA environment so your DIDs and credentials can be anchored, this is because your code will publish DIDs and resolve them on-chain.

:::info
See how to set up a local [IOTA Network](https://docs.iota.org/developer/iota-identity/getting-started/local-network-setup)
:::
