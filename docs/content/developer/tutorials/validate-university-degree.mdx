...
- **How it works**: Each DID has a corresponding DID Document, which is a public document published on a decentralized ledger (like IOTA in this case). This document contains:
...
- These DIDs are anchored and publicly discoverable on **IOTA**.
