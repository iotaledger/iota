...
To build the architecture, we are going to create three parts:
-   [The Move package for the sponsored transactions](./media-platform-package.mdx) 
-   [The Gas Station server](./gas-station-server.mdx) 
-   [The Transaction Builder](./transaction-builder.mdx) 
