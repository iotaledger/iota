...
:::info
We strictly recommend using the IOTA's Gas Station server for production use cases. However, building your own Gas Station server can be a good learning experience.
:::
