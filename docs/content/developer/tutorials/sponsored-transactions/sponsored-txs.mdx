...
In this tutorial, we will learn how to create a [sponsored transaction](../../iota-101/transactions/sponsored-transactions/about-sponsored-transactions.mdx) on the IOTA network using the [IOTA Rust SDK](../../../developer/iota-sdk/getting-started/rust.mdx).
