...
{/* ![IOTA Smart Contacts multichain architecture](https://docs.iota.org/img/iota-evm/multichain.png 'Click to see the full-size image.') */}
...
supports [EVM/Solidity](getting-started/languages-and-vms.mdx#what-is-evmsolidity)
smart contracts.
