...
!["Set the initial owner" img.png](https://docs.iota.org/img/iota-evm/evm/how-tos/ERC721/set-initial-owner.png)
...
2. Insert your target IOTA EVM in beside the `safeMint` button and then click the button.
    ...
    ![Safe mint](https://docs.iota.org/img/iota-evm/evm/how-tos/ERC721/safe-mint.png)

3. Confirm the transaction on Metamask.

    ![Confirm in metamask](https://docs.iota.org/img/iota-evm/evm/how-tos/ERC721/confirm-in-metamask.png)
