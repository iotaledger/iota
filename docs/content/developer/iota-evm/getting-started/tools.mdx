...
![Select Injected Provider from the Environment dropdown](https://docs.iota.org/img/iota-evm/evm/remix-injected-provider-metamask.png)
...
![Environment will be set to Injected Web3](https://docs.iota.org/img/iota-evm/evm/remix-injected-provider-set.png)]
