...
[`deposit`](../../../../../references/iota-evm/core-contracts/accounts.md#deposit) request to the
[`accounts` core contract](../../../../../references/iota-evm/core-contracts/accounts.md) on the chain.

Finally, it sends a [`withdraw`](../../../../../references/iota-evm/core-contracts/accounts.md#withdraw) request to the `accounts` core
