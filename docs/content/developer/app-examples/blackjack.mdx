...
A deployed version of the blackjack game is online at [IOTA Blackjack](https://blackjack-iota.vercel.app/).
...
- **Randomness and Fair Play:** Both games emphasize randomness for fairness. Blackjack uses a Counter NFT and player mouse movements to generate randomness, while Satoshi Coin Flip only uses a Counter NFT as a unique input for the [Verifiable Random Function (VRF)](../cryptography/how-to/ecvrf.mdx) in each game.
