...
- Check out [IOTA dApp Kit](https://sdk.iota.com/dapp-kit) to learn basic building blocks for developing a dApp in the IOTA ecosystem with React.js.
...
- This project is bootstrapped through `pnpm create @iota/dapp`. Please check out [@iota/create-dapp](https://sdk.iota.com/dapp-kit/create-dapp) for how to scaffold a React.js IOTA dApp project quickly.
