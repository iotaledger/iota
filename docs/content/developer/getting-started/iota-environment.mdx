...
It's a good idea to take a look at the toolbox before you start building. This section will give you a quick overview
of:

* The content in the [IOTA repository](#the-iota-repository).
* The IOTA [branch and network structure](#branch-and-network-structure).
...
- [sdk](https://github.com/iotaledger/iota/tree/develop/sdk): Contains the source code for different tools and SDKs,
  such
  as the IOTA TypeScript SDK, Kiosk SDK, BCS, dApp kit, and others.
...
experimental features, so use it at your own risk.
