...
See more [IDE options](https://github.com/iotaledger/awesome-move#ides) in the [Awesome Move](https://github.com/iotaledger/awesome-move) documentation.
...
- [apps](https://github.com/iotaledger/iota/tree/main/apps): Contains the source code for the main web applications that the IOTA Foundation runs, `IOTA Wallet`.
