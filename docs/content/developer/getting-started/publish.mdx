...
tags: [Move, Package Publishing,  Programmable Transactions]
---
...
After successfully publishing the package, you can use the `iota move call` command to execute individual functions or create sophisticated [programmable transaction blocks](../iota-101/transactions/ptb/prog-txn-blocks.mdx) that group multiple commands into a single, cost-effective transaction with the `iota client ptb` command.
