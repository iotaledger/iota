...
import sword_example from '!!raw-loader!../../../../examples/move/first_package/bytecode.json';
...
You can also connect your wallet to publish your package. You will see the objects directly in your wallet instead of the terminal output.
