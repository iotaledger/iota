...
- Basic understanding of blockchain concepts like [tokens](../../references/framework/Testnet/iota-framework/token.mdx) and [transactions](https://www.scalingparrots.com/en/what-is-a-blockchain-transaction/).
...
- [`iota::tx_context::sender`](../../references/framework/Testnet/iota-framework/tx_context.mdx): Manages the transaction context.
- [`iota::coin`](../../references/framework/Testnet/iota-framework/coin.mdx): Handles the creation and management of coins.
- [`iota::balance`](../../references/framework/Testnet/iota-framework/balance.mdx): Manages the balance of the shop.
- [`iota::token`](../../references/framework/Testnet/iota-framework/token.mdx): Manages the minting, transfer, and burning of tokens.
- [`iota::iota::IOTA`](../../references/framework/Testnet/iota-framework/iota.mdx): The IOTA cryptocurrency module.
...
The `transfer` function enables customers to [transfer](../../references/framework/Testnet/iota-framework/transfer.mdx) their `COFFEE` tokens to others, but with a 1-point fee deducted as commission. This demonstrates how Move can enforce rules and fees during token transfers, ensuring a fair system of exchange.
