...
The simplest way to generate an IOTA address is using the [IOTA Wallet Chrome browser extension](https://chromewebstore.google.com/detail/iota-wallet-rc/nlmllpflpelpannpijhhnbhekpbpejch).
