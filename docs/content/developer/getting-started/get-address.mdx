...
If you'd like to understand how a IOTA address is derived from private keys and other cryptography related topics, see the [Keys and Addresses](../cryptography/transaction-auth/keys-addresses.mdx) topic.
