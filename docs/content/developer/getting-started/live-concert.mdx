...
sequenceDiagram
    ...
    Owner->>Contract: change_price(Creator,category,udpated_price,Category)
...
In this file we will call the `change_price` function of the packge:
...
In this file we will call the `resale` function of the packge:
...
This file contains a function while calls function for specific opeartion like buy or resale.
