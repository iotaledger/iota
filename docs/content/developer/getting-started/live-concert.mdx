...
- [`Creator`](https://github.com/iota-community/on-chain-live-concerts-ticketing-system/blob/847b2f98e5de6523072d7058b89ebc96105589aa/package/sources/live_concert.move#L18-L21) will be used to verify the creator of the package.
...
- [`SoldTicket`](https://github.com/iota-community/on-chain-live-concerts-ticketing-system/blob/847b2f98e5de6523072d7058b89ebc96105589aa/package/sources/live_concert.move#L30-L36) will store the total number of seats sold to date.
...
To get the address for the above variables, see the transaction digest of your package publication or see the public transaction on[ IOTA Testnet Explorer](https://explorer.rebased.iota.org/?network=testnet).
