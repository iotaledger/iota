...
For more information on the IOTA TypeScript SDK, see the [IOTA TypeScript SDK documentation](https://sdk.iota.com/typescript).

## What is dApp Kit?

dApp Kit (@iota/dapp-kit) is a collection of React hooks, components, and utilities that make building dApps on IOTA straightforward. For more information on dApp Kit, see the [dApp Kit documentation](https://sdk.iota.com/dapp-kit).
