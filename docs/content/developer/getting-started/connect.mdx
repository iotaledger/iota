...
The IOTA Testnet and Devnet networks consist of four validator nodes operated by the IOTA Foundation. Clients send transactions and read requests via this endpoint: `https://fullnode.<IOTA-NETWORK-VERSION>.iota.io:443` using [JSON-RPC](/references/iota-api/json-rpc-format.mdx).
