---
description: Tutorial for Independent Ticketing System
tags:
  - explanation
  - tutorial
  - move
...
Run the following command to install the [IOTA dApp kit](../../../ts-sdk/dapp-kit), [IOTA SDK](../../ts-sdk/typescript), and [@tanstack/react-query](https://www.npmjs.com/package/@tanstack/react-query) in the react app.
