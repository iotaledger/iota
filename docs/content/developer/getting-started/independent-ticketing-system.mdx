...
- [`packageId`](https://github.com/iota-community/independent-ticketing-system/blob/4eabf7ef0c74e843d95e1658ae071df34488fd04/independent_ticketing_system/Frontend/src/networkConfig.ts#L12): The package ID of the published package.
- [`total_seats_object`](https://github.com/iota-community/independent-ticketing-system/blob/4eabf7ef0c74e843d95e1658ae071df34488fd04/independent_ticketing_system/Frontend/src/networkConfig.ts#L14): The total_seat shared object ID.
- [`creator_object`](https://github.com/iota-community/independent-ticketing-system/blob/4eabf7ef0c74e843d95e1658ae071df34488fd04/independent_ticketing_system/Frontend/src/networkConfig.ts#L16): The Creator shareed object ID.
- [`availableTickets_to_buy_object`](https://github.com/iota-community/independent-ticketing-system/blob/4eabf7ef0c74e843d95e1658ae071df34488fd04/independent_ticketing_system/Frontend/src/networkConfig.ts#L18): The AvailableTicketsToBuy shared object ID.
...
In this tutorial, we've successfully built an independent ticketing system where NFT tickets are created using the IOTA Move language for the contract package. We walked through the contract’s functionality step by step and how it works within the system. Additionally, we explored how to integrate the IOTA dApp kit into the frontend, providing a comprehensive guide to building a fully functional dApp. Each component was carefully explained, from minting and transferring tickets to reselling and burning them, ensuring a complete understanding of the system. By following this tutorial, you should now be equipped to develop and deploy your own ticketing application using IOTA's technologies, offering a secure and decentralized solution for ticket management.
