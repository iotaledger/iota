...
```move reference
https://github.com/iotaledger/iota/blob/e8d767b6b6d6825a97427c46d9fd819886ecef3c/examples/move/first_package/sources/first_package.move#L109-L127
```
...
```move reference
https://github.com/iotaledger/iota/blob/e8d767b6b6d6825a97427c46d9fd819886ecef3c/examples/move/first_package/sources/first_package.move#L124-L126
```
...
```move reference
https://github.com/iotaledger/iota/blob/e8d767b6b6d6825a97427c46d9fd819886ecef3c/examples/move/first_package/sources/first_package.move#L68-L85
```
...
```move reference
https://github.com/iotaledger/iota/blob/e8d767b6b6d6825a97427c46d9fd819886ecef3c/examples/move/first_package/sources/first_package.move#L95-L199
```
...
```move reference
https://github.com/iotaledger/iota/blob/e8d767b6b6d6825a97427c46d9fd819886ecef3c/examples/move/first_package/sources/first_package.move#L87-L93
```

### For The Complete tests coverage
The `first_package::my_module` includes a complete set of tests covering all major functionality. For complete testing coverage, refer to these test cases in the module:

```move reference
https://github.com/iotaledger/iota/blob/e8d767b6b6d6825a97427c46d9fd819886ecef3c/examples/move/first_package/sources/first_package.move#L95-L363
```
...
```move reference
https://github.com/iotaledger/iota/blob/e8d767b6b6d6825a97427c46d9fd819886ecef3c/examples/move/first_package/sources/first_package.move#L95-L107
```
...
```move reference
https://github.com/iotaledger/iota/blob/e8d767b6b6d6825a97427c46d9fd819886ecef3c/examples/move/first_package/sources/first_package.move#L131C5-L137C7
```
...
In this example, the `admin` uses the `new_sword` function to create a sword using a `Forge` object and then transfers it to the `initial_owner`.
    ...
    ```move reference 
   https://github.com/iotaledger/iota/blob/e8d767b6b6d6825a97427c46d9fd819886ecef3c/examples/move/first_package/sources/first_package.move#L167-L175
    ```
...
This works because `test_scenario` keeps track of objects created and transferred in earlier transactions.
    ...
    ```move reference
    https://github.com/iotaledger/iota/blob/e8d767b6b6d6825a97427c46d9fd819886ecef3c/examples/move/first_package/sources/first_package.move#L177-L184
    ```
...
```move reference
https://github.com/iotaledger/iota/blob/e8d767b6b6d6825a97427c46d9fd819886ecef3c/examples/move/first_package/sources/first_package.move#L186-L197
```
...
#### Example:
```move reference
https://github.com/iotaledger/iota/blob/e8d767b6b6d6825a97427c46d9fd819886ecef3c/examples/move/first_package/sources/first_package.move#L200-L218
```
...
Inlcudes test_scenario and test_utils modules:-

```move reference
https://github.com/iotaledger/iota/blob/e8d767b6b6d6825a97427c46d9fd819886ecef3c/examples/move/first_package/sources/first_package.move#L1-L364
```
