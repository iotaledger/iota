...
In this challenge, you will need to use the IOTA CLI to interact with the blockchain. Those set of articles will help you to setup your environment, and be able to call a deployed contract:
