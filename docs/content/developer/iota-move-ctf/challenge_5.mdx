...
:::tip
We recommend trying the challenge until completely stuck, then check the solution.
<details>
  <summary>View Solution</summary>

```rust file=<rootDir>/docs/examples/move/ctf/challenge_5/solution/src/main.rs
```

```bash file=<rootDir>/docs/examples/move/ctf/challenge_5/solution/solution.sh
```
</details>
:::
