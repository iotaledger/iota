...
:::tip
The pizzaiolo uses [bcs::to_bytes](../../references/framework/testnet/iota-framework/bcs.mdx#function-to_bytes) to make sure the ingredients are in order. Make sure you understand how to use this function to pass the test.
:::
...
After taking a look at the challenge's usage of [bcs::to_bytes](../../references/framework/testnet/iota-framework/bcs.mdx#function-to_bytes), we recommend you to take a look at the IOTA Framework documentation to understand how to use it in further challenges.

- [IOTA Framework](../../references/framework/testnet/iota-framework/)
