...
## Related Articles
This challenge's main contract is written using the Coin Stndard. Having been familiar with the [Object Model](../iota-101/objects/object-model.mdx) from the last challenge, you should now be able to understand the Coin Standard and how it works.
