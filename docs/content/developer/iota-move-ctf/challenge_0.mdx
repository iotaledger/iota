...
The module includes a function to mint a new NFT and transfer it to your account. To complete the challenge, simply fill in your data in the form below and click the "Submit Challenge" button to mint the NFT.
