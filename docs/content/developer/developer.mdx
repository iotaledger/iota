...
The IOTA Gas Station is a component that you can use to make [Sponsored Transaction](LINK_HERE).

Go to [IOTA Gas Station](exchange-integration/exchange-integration.mdx).
