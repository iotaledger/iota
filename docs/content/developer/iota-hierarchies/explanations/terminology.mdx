...
When defining the ontology we took inspiration in knowledge theory. In knowledge theory a property is a predicate that is used to describe the entity's attributes and relationships. Property has an associated value. Value is a subject that describes the property. Property and value combined form a property value pair.
In Hierarchies we use the same concept. A property is a predicate that is used to describe the entity's attributes and relationships. Property has an associated value. Value is a subject that describes the property. Property and value exist next to each other and are combined to form a property value pair.
...
A property value pair is a combination of a property and a value. It is used to describe the entity's attributes and relationships.
...
- **Ends With**: Enforces that the property's value must end with a specific substring.
- **Contains**: Ensures the property's value includes a specific substring anywhere within it.
...
Beyond numbers and strings, IOTA Hierarchies also support temporal constraints. This allows you to define shapes for properties related to time, such as timestamps or durations, ensuring that time-sensitive data remains valid and consistent.
...
A statement links a property and its value to a **target object**—the specific entity the claim describes. The target object is the receiver of the property-value pair and the thing being described.

Examples of statements is:
...
The following diagram illustrates how properties, values, and targets combine to form attestations:
