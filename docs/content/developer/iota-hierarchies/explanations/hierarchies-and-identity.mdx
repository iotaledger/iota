...
The flexible and unopinionated nature of Hierarchies allows it to be integrated with IOTA Identity in various ways. Below are three proposed use cases:
...
These are merely suggestions, and the inherent flexibility of the system means you can adapt and use it in numerous other ways to suit your needs.
...
An interesting scenario arises when IOTA Hierarchies is integrated into the validation process  for Iota Identity and Credentials. Consider a student who possesses a Credential containing their grades. The student wishes to present this credential to a potential employer. The employer, upon reviewing the credential, sees the professor's signature and the assigned grade. To verify whether the professor is authorized to issue such a statement about the student's grade, the employer consults the Federation.
