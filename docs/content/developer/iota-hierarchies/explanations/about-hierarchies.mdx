...
From a technological standpoint, IOTA Hierarchies is set of comiponents aligned into multiple layers, each serving specific purposes in the trust distribution ecosystem:
