---
description: The most important concepts that developers will need to know to utilize IOTA Hierarchies to their full potential.
teams:
  - iotaledger/identity
tags:
  - reference
...
![IOTA Hierarchies](/img/banner/banner_hierarchies.svg)
...
graph TD
    ...
    Federation -->|accredit| SubUnit2["Sub-Unit: Bird Experts (Accreditors for birds)"]
    Federation -->|accredit| SubUnit3["Sub-Unit: Reptile Experts (Accreditors for reptiles)"]
