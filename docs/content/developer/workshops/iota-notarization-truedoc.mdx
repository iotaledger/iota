...
![Notarization Transfer Success](/img/developer/workshops/iota-notarization-truedoc/transfer-succes-no-lock.png)
...
![Notarization Ownership Transfer with lock](/img/developer/workshops/iota-notarization-truedoc/transfer-fail-dueto-timelock.png)
