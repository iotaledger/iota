---
title: Workshop IOTA Single Notarization with TrueDoc
description: Complete tutorial for building on-chain notarization on IOTA
---

# Implementing Proof of Integrity and Auditability with IOTA Single Notarization

## Overview

This workshop tutorial guides you through implementing blockchain-based document notarization using IOTA's Single Notarization framework. You'll learn how to create immutable proof of document existence, build audit trails for regulatory compliance, and verify document integrity using both dynamic (mutable) and locked (immutable) notarization strategies.
...
The IOTA Single Notarization system provides two main types of notarizations:
...
## Set up Development Environment and Publish the IOTA Single Notarization Package
...
### Step 2: Publish the IOTA Single Notarization Package

Now we'll deploy the Single Notarization smart contract package to the testnet.

:::note 

For your reference do visit the [single notarization documentation](https://docs.iota.org/developer/iota-notarization/single-notarization/getting-started/local-network-setup) for more details and set up.
...
### Single Notarization Client Initialization

**What We're Building:** Connection to IOTA Single Notarization smart contract.
...
### Single Notarization Ownership Transfer
...
**Testing Single Notarization Ownership Transfer Endpoint**
...
### Single Notarization Destruction
...
**Testing Single Notarization Destruction Endpoint**
...
**Testing Single Notarization Query and Verification Endpoint**

**Single Notarization Details Retrieval**
...
**What We've Built:** A complete IOTA Single Notarization backend service with:
