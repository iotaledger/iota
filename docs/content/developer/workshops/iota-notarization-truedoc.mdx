...
This workshop has a [recorded live session](https://youtu.be/jc-vBx_mAhc) where we walk through the concepts first, then implement everything together in real time.
:::
