...
In this workshop, we will build a **University Degree Verification system** using **IOTA Hierarchies** and **Rust**. This tutorial demonstrates a decentralized trust framework for a consortium of universities, where accreditations and attestations create a tamper-proof chain for issuing and verifying degrees.
...
In this context of a Uinversity Degree Verification Sysytem:
...
Let’s set up the Rust project and initialize the environment for the IOTA Hierarchies tutorial.
