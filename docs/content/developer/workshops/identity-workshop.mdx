...
Visit the [Scaffold Code](/developer/workshops/identity-workshop-scaffold) page to copy the code for `main.rs` and `App.jsx`. The page provides instructions for macOS and Windows to set up the files correctly.
...
![Full Page](./images/createdid.png)
...
![Create Decentralized Identifier output](./images/didcreated.png)
...
![Create Decentralized Identifier output](./images/vccreated.png)
...
![Create Decentralized Identifier output](./images/vpcreated.png)
