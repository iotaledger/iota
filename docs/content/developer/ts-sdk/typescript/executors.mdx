...
```ts file=<rootDir>/docs/examples/typescript/src/ts-sdk/typescript/executors/serial-transaction-executor.ts
```
...
```ts file=<rootDir>/docs/examples/typescript/src/ts-sdk/typescript/executors/parallel-transaction-executor.ts
```
