...
The IOTA TypeScript SDK supports the following signing schemes:
...
| Passkey           | `PasskeyKeypair`           | `@iota/iota-sdk/keypairs/passkey`                |
| MoveAuthenticator | `MoveSigner`               | `@iota/iota-sdk/keypairs/move-authenticator`     |

For information on Ed25519, Secp256k1, and Secp256r1, see the
[Signatures](../../../../developer/cryptography/transaction-auth/signatures.mdx) topic. For the
two advanced schemes, see [Passkeys](./passkeys.mdx) and
[MoveAuthenticator](./move-authenticator.mdx).
