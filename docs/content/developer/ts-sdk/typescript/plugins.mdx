...
```typescript file=<rootDir>/docs/examples/typescript/src/ts-sdk/typescript/transaction-building/plugins-serialization.ts
```
...
```typescript file=<rootDir>/docs/examples/typescript/src/ts-sdk/typescript/transaction-building/plugins-build.ts
```
...
```typescript file=<rootDir>/docs/examples/typescript/src/ts-sdk/typescript/transaction-building/intent-basic.ts
```
...
```typescript file=<rootDir>/docs/examples/typescript/src/ts-sdk/typescript/transaction-building/intent-helper.ts
```
...
```typescript file=<rootDir>/docs/examples/typescript/src/ts-sdk/typescript/transaction-building/intent-resolver.ts
```
...
```typescript file=<rootDir>/docs/examples/typescript/src/ts-sdk/typescript/transaction-building/intent-auto-resolver.ts
```
