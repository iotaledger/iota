...
-   `Address::FRAMEWORK`: The address for the IOTA Framework
-   `Address::SYSTEM`: The address for the IOTA System module
-   `ObjectId::CLOCK`: The address for the `iota::clock::Clock` object
-   `ObjectId::SYSTEM`: The address for the `IotaSystemState` object
