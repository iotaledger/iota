...
```tsx file=<rootDir>/docs/examples/typescript/src/ts-sdk/dapp-kit/use-sign-and-execute-transaction-custom.tsx
```
...
[IotaClient.signAndExecuteTransaction](../../typescript/api/client/classes/IotaClient.md)
method accepts.
