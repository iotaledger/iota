...
```tsx file=<rootDir>/docs/examples/typescript/src/ts-sdk/dapp-kit/dapp-kit-setup-providers.tsx
```
...
```tsx file=<rootDir>/docs/examples/typescript/src/ts-sdk/dapp-kit/dapp-kit-rpc-hook-example.tsx
```
