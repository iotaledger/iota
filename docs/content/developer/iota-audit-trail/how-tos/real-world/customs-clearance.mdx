...
```rust reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/examples/audit-trail/real-world/01_customs_clearance.rs#L57-L78
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/bindings/wasm/audit_trail_wasm/examples/src/real-world/01_customs_clearance.ts#L61-L75
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/examples/audit-trail/real-world/01_customs_clearance.rs#L84-L145
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/bindings/wasm/audit_trail_wasm/examples/src/real-world/01_customs_clearance.ts#L81-L115
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/examples/audit-trail/real-world/01_customs_clearance.rs#L147-L282
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/bindings/wasm/audit_trail_wasm/examples/src/real-world/01_customs_clearance.ts#L117-L239
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/examples/audit-trail/real-world/01_customs_clearance.rs#L286-L313
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/bindings/wasm/audit_trail_wasm/examples/src/real-world/01_customs_clearance.ts#L243-L265
```
