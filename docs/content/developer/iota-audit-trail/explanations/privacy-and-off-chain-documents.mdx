...
description: Why storing only cryptographic hashes on-chain is the recommended pattern for IOTA Audit Trail, and how the on-chain/off-chain approach protects sensitive data.
tags:
 - explanation
 - audit-trail
---
