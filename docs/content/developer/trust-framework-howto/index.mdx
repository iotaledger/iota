...
sidebar_label: Trust Framework - How To
tags:
  - trust-framework
---
...
Despite offering a variety of components and tools for creating verifiable, on-chain records of any digital data
the Trust Framework (TF) uses several cross component technics and general concepts that are not specific to a single component.
