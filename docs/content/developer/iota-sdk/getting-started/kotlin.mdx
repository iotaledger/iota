...
```kotlin reference
https://github.com/iotaledger/iota-rust-sdk/blob/adcdd025036b8e18d4a6f32ce7bd20105965f81c/bindings/kotlin/build.gradle.kts#L21-L25
```
...
```kotlin reference
https://github.com/iotaledger/iota-rust-sdk/blob/develop/bindings/kotlin/examples/ChainId.kt#L4-L16
```
