...
tags: [ tutorial, kotlin, mainnet, testnet, devnet, setup, install, getting-started ]
---
...
```kotlin
dependencies {
    implementation("org.iota:iota-sdk:0.0.1-alpha.4")
}
```
...
```kotlin reference
https://github.com/iotaledger/iota-rust-sdk/blob/{SDK_REV}/bindings/kotlin/examples/ChainId.kt#L4-L16
```
