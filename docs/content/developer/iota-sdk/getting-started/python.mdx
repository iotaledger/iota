...
tags: [ tutorial, python, mainnet, testnet, devnet, setup, install, getting-started ]
---
...
```python reference
https://github.com/iotaledger/iota-rust-sdk/blob/{SDK_REV}/bindings/python/examples/chain_id.py#L4-L17
```
