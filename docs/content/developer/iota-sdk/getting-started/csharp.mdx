...
* Check Balances: Learn how to [query coin balances](../how-tos/accounts-and-addresses/coin-balance.mdx) for a specific address.
* Transactions: Build and sign Programmable Transaction Blocks (PTBs).
* Key Management: Use the SDK to [generate and manage IOTA addresses](../how-tos/accounts-and-addresses/create-mnemonic.mdx).
