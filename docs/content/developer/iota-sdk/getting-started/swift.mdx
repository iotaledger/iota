...
tags: [ tutorial, swift, mainnet, testnet, devnet, setup, install, getting-started ]
---
...
```swift reference
https://github.com/iotaledger/iota-rust-sdk/blob/{SDK_REV}/bindings/swift/examples/ChainId.swift#L4-L14
```
