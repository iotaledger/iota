...
For additional setup instructions and platform-specific details, refer to the official [Go bindings documentation](https://github.com/iotaledger/iota-rust-sdk/tree/develop/bindings/go) in the repository.
