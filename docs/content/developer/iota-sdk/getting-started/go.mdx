...
tags: [ tutorial, go, mainnet, testnet, devnet, setup, install, getting-started ]
---
...
```go reference
https://github.com/iotaledger/iota-rust-sdk/blob/{SDK_REV}/bindings/go/examples/chain_id/main.go#L4-L21
```
