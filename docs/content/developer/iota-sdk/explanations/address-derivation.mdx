---
title: Address Derivation in IOTA
...
| `Derivation Path` | A BIP-44/SLIP-10 path (e.g. the Ed25519 default `m/44'/4218'/0'/0'/0'`) specifying which key to derive from the seed. |
