...
This how-to explains why a sponsor's authenticator must commit to **who is sending the transaction** — not just **what the transaction is** — and demonstrates a concrete vulnerability that arises when sender identity is missing from the signed message.
