...
```rust file=<rootDir>/docs/examples/rust/abstract_account/authenticator-shared-object-swap.rs#L193-L220
```

The swap function replaces the shared object reference in the transaction:

```rust file=<rootDir>/docs/examples/rust/abstract_account/authenticator-shared-object-swap.rs#L433-L473
```
