...
```rust file=<rootDir>/docs/examples/rust/stardust/foundry-output-claim.rs#L77-96
```
...
```rust file=<rootDir>/docs/examples/rust/stardust/foundry-output-claim.rs#L147-159
```
...
```rust file=<rootDir>/docs/examples/rust/stardust/foundry-output-claim.rs#L164-174
```
...
```rust file=<rootDir>/docs/examples/rust/stardust/foundry-output-claim.rs#L178-216
```
...
```rust file=<rootDir>/docs/examples/rust/stardust/foundry-output-claim.rs#L220-227
```
...
```rust file=<rootDir>/docs/examples/rust/stardust/foundry-output-claim.rs#L231-300
```
