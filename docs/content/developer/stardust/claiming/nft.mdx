...
These tokens are stored in a [`Bag`](../../../references/framework/testnet/iota-framework/bag). 
...
[`Coin`](../../../references/framework/testnet/iota-framework/coin.mdx#resource-coin).
