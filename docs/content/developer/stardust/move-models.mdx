...
|--------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Basic Output with IOTA only                                                      | [`Coin<IOTA>`](../../references/framework/iota/coin.mdx#resource-coin)                                                                                                                                                                                                                                                                                         | ready to be used, no need to extract any assets                                                                                                                                                                                                                                                |
| Basic Output with IOTA and native tokens                                         | [`Coin<IOTA>`](../../references/framework/iota/coin.mdx#resource-coin) and one or more [`Coin<NATIVE_TOKEN>`](../../references/framework/iota/coin.mdx#resource-coin)                                                                                                                                                                                 | ready to be used, no need to extract any assets                                                                                                                                                                                                                                                |
| Basic Output with unlock conditions or features                                      | [`BasicOutput<IOTA>`](../../references/framework/stardust/basic_output#resource-basicoutput)                                                                                                                                                                                                                                                                            | [`Balance<IOTA>`](../../references/framework/iota/balance#struct-balance), [`Bag`](../../references/framework/iota/bag#resource-bag) of `Balance<NATIVE_TOKEN>` key-ed by `"NATIVE_TOKEN"`                                                                             |
| Alias Output                                                                         | [`AliasOutput<IOTA`](../../references/framework/stardust/alias_output#resource-aliasoutput)                                                                                                                                                                                                                                                                             | [`Balance<IOTA>`](../../references/framework/iota/balance#struct-balance), [`Bag`](../../references/framework/iota/bag#resource-bag) of `Balance<NATIVE_TOKEN>` key-ed by `"NATIVE_TOKEN"`, [`Alias`](../../references/framework/stardust/alias#resource-alias) object |
| Nft Output                                                                           | [`NftOutput<IOTA`](../../references/framework/stardust/nft_output#resource-nftoutput)                                                                                                                                                                                                                                                                                   | [`Balance<IOTA>`](../../references/framework/iota/balance#struct-balance), [`Bag`](../../references/framework/iota/bag#resource-bag) of `Balance<NATIVE_TOKEN>` key-ed by `"NATIVE_TOKEN"`, [`Nft`](../../references/framework/stardust/nft#resource-nft) object       |
...
| [Vested Rewards From the Stardust Upgrade](https://github.com/iotaledger/new_supply) | [`Timelock<Balance<IOTA>>`](../../references/framework/iota/timelock.mdx#resource-timelock) objects.                                                                                                                                                                                                                                                          | -                                                                                                                                                                                                                                                                                          |
...
genesis of the network.
 ...
 - There is no dedicated module for foundries and native tokens, since they are converted to [move-native tokens](../evm-to-move/creating-token.mdx)
   along with the base tokens (IOTA). These models are already part of the [`iota-framework`](../../references/framework/iota).
...
defines [`Coin`](../../references/framework/iota/coin.mdx#resource-coin) as the primary object type to use by users to hold
tokens.
...
In Move, there are established ways for these operations, in particular using a [`Coin`](../../references/framework/iota/coin.mdx#resource-coin)
to hold balances of tokens, as well as the [`CoinManager`](../../references/framework/iota/coin_manager.mdx)
(that wraps the [`TreasuryCap`](../../references/framework/iota/coin.mdx#resource-treasurycap))
...
A native token and its foundry from the Stardust ledger therefore translate to the following in the move ledger:
 ...
 - The [`CoinManagerTreasuryCap`](../../references/framework/iota/coin_manager.mdx#resource-coinmanagertreasurycap)
...
[`Timelock<Balance<IOTA>>`](../../references/framework/iota/timelock.mdx#resource-timelock).
