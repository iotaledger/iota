...
|--------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Basic Output with IOTA only                                                      | [`Coin<IOTA>`](../../references/framework/testnet/iota-framework/coin.mdx#resource-coin)                                                                                                                                                                                                                                                                                         | ready to be used, no need to extract any assets                                                                                                                                                                                                                                                |
| Basic Output with IOTA and native tokens                                         | [`Coin<IOTA>`](../../references/framework/testnet/iota-framework/coin.mdx#resource-coin) and one or more [`Coin<NATIVE_TOKEN>`](../../references/framework/testnet/iota-framework/coin.mdx#resource-coin)                                                                                                                                                                                 | ready to be used, no need to extract any assets                                                                                                                                                                                                                                                |
| Basic Output with unlock conditions or features                                      | [`BasicOutput<IOTA>`](../../references/framework/testnet/stardust/basic_output#resource-basicoutput)                                                                                                                                                                                                                                                                            | [`Balance<IOTA>`](../../references/framework/testnet/iota-framework/balance#struct-balance), [`Bag`](../../references/framework/testnet/iota-framework/bag#resource-bag) of `Balance<NATIVE_TOKEN>` key-ed by `"NATIVE_TOKEN"`                                                                             |
| Alias Output                                                                         | [`AliasOutput<IOTA`](../../references/framework/testnet/stardust/alias_output#resource-aliasoutput)                                                                                                                                                                                                                                                                             | [`Balance<IOTA>`](../../references/framework/testnet/iota-framework/balance#struct-balance), [`Bag`](../../references/framework/testnet/iota-framework/bag#resource-bag) of `Balance<NATIVE_TOKEN>` key-ed by `"NATIVE_TOKEN"`, [`Alias`](../../references/framework/testnet/stardust/alias#resource-alias) object |
| Nft Output                                                                           | [`NftOutput<IOTA`](../../references/framework/testnet/stardust/nft_output#resource-nftoutput)                                                                                                                                                                                                                                                                                   | [`Balance<IOTA>`](../../references/framework/testnet/iota-framework/balance#struct-balance), [`Bag`](../../references/framework/testnet/iota-framework/bag#resource-bag) of `Balance<NATIVE_TOKEN>` key-ed by `"NATIVE_TOKEN"`, [`Nft`](../../references/framework/testnet/stardust/nft#resource-nft) object       |
| Foundry Output                                                                       | Migrated to a Move Package with [template](https://github.com/iotaledger/iota/blob/develop/crates/iota-genesis-builder/src/stardust/native_token/package_template/sources/native_token_template.move) and [`CoinManager`](../../references/framework/testnet/iota-framework/coin_manager). Base tokens of the output are sent to the controlling alias as `Coin<IOTA>` objects. | -                                                                                                                                                                                                                                                                                              |
| [Vested Rewards From the Stardust Upgrade](https://github.com/iotaledger/new_supply) | [`Timelock<Balance<IOTA>>`](../../references/framework/testnet/iota-framework/timelock.mdx#resource-timelock) objects.                                                                                                                                                                                                                                                          | -                                                                                                                                                                                                                                                                                          |
...
genesis of the network.
 - The move package is called [`stardust`](../../references/framework/testnet/stardust) and is [located in the `iota_framework` crate.](https://github.com/iotaledger/iota/tree/develop/crates/iota-framework/packages/stardust)
 - The on-chain identifier for the stardust package is `0x107a`.
 - The following modules are present in the package:
    - [`basic_output`](../../references/framework/testnet/stardust/basic_output.mdx): Defines how a basic output _container_ is modeled.
    - [`alias_output`](../../references/framework/testnet/stardust/alias_output.mdx): Defines how an alias output _container_ is modeled.
    - [`alias`](../../references/framework/testnet/stardust/alias.mdx): Defines how an alias _asset_ is modeled.
    - [`nft_output`](../../references/framework/testnet/stardust/nft_output.mdx): Defines how an NFT output _container_ is modeled.
    - [`nft`](../../references/framework/testnet/stardust/nft.mdx): Defines how an NFT _asset_ is modeled.
    - [`address_unlock_condition`](../../references/framework/testnet/stardust/address_unlock_condition.mdx): Defines how an address unlock condition is modeled.
    - [`expiration_unlock_condition`](../../references/framework/testnet/stardust/expiration_unlock_condition.mdx): Defines how an expiration unlock condition is modeled.
    - [`timelock_unlock_condition`](../../references/framework/testnet/stardust/timelock_unlock_condition.mdx): Defines how a timelock unlock condition is modeled.
    - [`irc27`](../../references/framework/testnet/stardust/irc27.mdx): Defines how an IRC-27 metadata is modeled.
    - [`utilities`](../../references/framework/testnet/stardust/utilities.mdx): Contains utility functions for the stardust package, primarily to help with extracting assets from containers.
 - There is no dedicated module for foundries and native tokens, since they are converted to [move-native tokens](../evm-to-move/creating-token.mdx)
   along with the base tokens (IOTA). These models are already part of the [`iota-framework`](../../references/framework/testnet/iota-framework).
...
represented instead as a balance struct, parameterized with the type of the token:
  - [`Balance<IOTA>`](../../references/framework/testnet/iota-framework/balance#struct-balance): Represents a balance of the IOTA token.
  - The token types `IOTA` is defined as part of the IOTA Move Framework. The fully qualified type for them is:
    - [`0x2::iota::IOTA`](../../references/framework/testnet/iota-framework/iota#struct-iota) for IOTA.
...
defines [`Coin`](../../references/framework/testnet/iota-framework/coin.mdx#resource-coin) as the primary object type to use by users to hold
tokens.
...
In Move, there are established ways for these operations, in particular using a [`Coin`](../../references/framework/testnet/iota-framework/coin.mdx#resource-coin)
to hold balances of tokens, as well as the [`CoinManager`](../../references/framework/testnet/iota-framework/coin_manager.mdx)
(that wraps the [`TreasuryCap`](../../references/framework/testnet/iota-framework/coin.mdx#resource-treasurycap))
...
A native token and its foundry from the Stardust ledger therefore translate to the following in the move ledger:
 ...
 - The [`CoinManagerTreasuryCap`](../../references/framework/testnet/iota-framework/coin_manager.mdx#resource-coinmanagertreasurycap)
...
[`Alias`](../../references/framework/testnet/stardust/alias.mdx#resource-alias). Applications that use aliases (ISC, DID, token issuer)
...
functionality in the new move framework](../iota-101/objects/transfers/transfer-to-object.mdx#receiving-objects) that
 ...
 other Stardust containers:
  - [`unlock_alias_address_owned_basic`](../../references/framework/testnet/stardust/address_unlock_condition.mdx#function-unlock_alias_address_owned_basic)
  - [`unlock_alias_address_owned_alias`](../../references/framework/testnet/stardust/address_unlock_condition.mdx#function-unlock_alias_address_owned_alias)
  - [`unlock_alias_address_owned_nft`](../../references/framework/testnet/stardust/address_unlock_condition.mdx#function-unlock_alias_address_owned_nft)

### Non-Fungible Tokens (NFTs)

NFTs are migrated very similarly to aliases. The NFT object in move is called [`Nft`](../../references/framework/testnet/stardust/nft.mdx#resource-nft).
...
functionality in the new move framework](../iota-101/objects/transfers/transfer-to-object.mdx#receiving-objects) that
 allows one to receive assets on the an `ObjectID` that is an `NftID`. The following functions let an `Nft` receive
    other Stardust containers:
    - [`unlock_nft_address_owned_basic`](../../references/framework/testnet/stardust/address_unlock_condition.mdx#function-unlock_nft_address_owned_basic)
    - [`unlock_nft_address_owned_alias`](../../references/framework/testnet/stardust/address_unlock_condition.mdx#function-unlock_nft_address_owned_alias)
    - [`unlock_nft_address_owned_nft`](../../references/framework/testnet/stardust/address_unlock_condition.mdx#function-unlock_nft_address_owned_nft)
...
Once that happens, they are destroyed. The containers are:
 ...
 - [`BasicOutput`](../../references/framework/testnet/stardust/basic_output#resource-basicoutput): Represents a basic output container.
 - [`AliasOutput`](../../references/framework/testnet/stardust/alias_output#resource-aliasoutput): Represents an alias output container.
 - [`NftOutput`](../../references/framework/testnet/stardust/nft_output#resource-nftoutput): Represents an NFT output container.
...
The move model [`StorageDepositReturnUnlockCondition`](../../references/framework/testnet/stardust/storage_deposit_return_unlock_condition.mdx#struct-storagedepositreturnunlockcondition)
is added to the containers during the migration process where applicable. The [`unlock()`](../../references/framework/testnet/stardust/storage_deposit_return_unlock_condition.mdx#function-unlock)
...
locks funds until a certain time has passed. It is modeled in move via the [`TimelockUnlockCondition`](../../references/framework/testnet/stardust/timelock_unlock_condition.mdx#struct-timelockunlockcondition)
that is added to the containers during the migration process where applicable. The [`unlock()`](../../references/framework/testnet/stardust/timelock_unlock_condition.mdx#function-unlock)
...
[`Timelock<Balance<IOTA>>`](../../references/framework/testnet/iota-framework/timelock.mdx#resource-timelock).
  - `Timelock` objects can be staked to validators of the network to earn rewards. The functionality is provided by the
     [timelock::timelocked_staking](../../references/framework/testnet/iota-system/timelocked_staking.mdx) module.
  - The [timelock](../../references/framework/testnet/iota-framework/timelock.mdx) package and it's utilities can be used by anyone to create their own timelocked assets.
...
In move, the expiration unlock condition is modeled via the [`ExpirationUnlockCondition`](../../references/framework/testnet/stardust/expiration_unlock_condition.mdx#struct-expirationunlockcondition).
The [`unlock()`](../../references/framework/testnet/stardust/expiration_unlock_condition.mdx#function-unlock) function is called when assets are extracted from the container,
...
will be migrated to [`BasicOutput`](../../references/framework/testnet/stardust/basic_output#resource-basicoutput) containers.
...
```
 ...
 - A [`Bag`](../../references/framework/testnet/iota-framework/bag) is a heterogeneous map-like collection of values. The `native_tokens` bag
   stores `Balance<TOKEN-TYPE>` structs under the stringified type of the token.
 - The unlock conditions are all defined as [`Options`](../../references/framework/testnet/move-stdlib/option.mdx) since not all outputs have them.
...
1. Call the [`extract_assets()`](../../references/framework/testnet/stardust/basic_output#function-extract_assets) function on
...
The [`AliasOutput`](../../references/framework/testnet/stardust/alias_output#resource-aliasoutput) container contains the
following assets:
 - Base token balance (IOTA) of the migrated Stardust output.
 - A `Bag` that holds native tokens of the migrated Stardust output.
 - The [`Alias`](../../references/framework/testnet/stardust/alias#resource-alias) object that represents the alias in the move ledger.
...
```
 ...
 - This `Alias` object owns all other containers or `Coins` that were owned by the `Alias Address` in Stardust. One can
   receive them via the following functions:
    ...
    -  [`unlock_alias_address_owned_alias()`](../../references/framework/testnet/stardust/address_unlock_condition.mdx#function-unlock_alias_address_owned_alias)
    -  [`unlock_alias_address_owned_nft()`](../../references/framework/testnet/stardust/address_unlock_condition.mdx#function-unlock_alias_address_owned_nft)
    - For coins, use [transfer::public_receive()](../../references/framework/testnet/iota-framework/transfer#function-public_receive).
...
The [`NftOutput`](../../references/framework/testnet/stardust/nft_output#resource-nftoutput) container contains the:
 - Base token balance (IOTA) of the migrated Stardust output.
 - A `Bag` that holds native tokens of the migrated Stardust output.
 - The [`Nft`](../../references/framework/testnet/stardust/nft#resource-nft) object that represents the NFT in the move ledger.
   While this latter asset is not part of the container as a field, it is added to it as a [`dynamic object field`](../iota-101/objects/dynamic-fields/dynamic-fields.mdx)
...
```
 ...
 - This `Nft` object owns all other containers or `Coins` that were owned by the `Nft Address` in Stardust. One can
   receive them via the following functions:
    ...
    -  [`unlock_nft_address_owned_alias()`](../../references/framework/testnet/stardust/address_unlock_condition.mdx#function-unlock_nft_address_owned_alias)
    -  [`unlock_nft_address_owned_nft()`](../../references/framework/testnet/stardust/address_unlock_condition.mdx#function-unlock_nft_address_owned_nft)
    - For coins, use [transfer::public_receive()](../../references/framework/testnet/iota-framework/transfer.mdx#function-public_receive).
 - The immutable metadata field has been standardized as [`Irc27Metadata`](../../references/framework/testnet/stardust/irc27.mdx#struct-irc27metadata),
...
The [`extract_assets()`](../../references/framework/testnet/stardust/nft_output#function-extract_assets) function of the `NftOutput` container looks the following:
```move
