...
|--------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Basic Output with IOTA only                                                      | [`Coin<IOTA>`](../../references/framework/iota-framework/coin.mdx#struct-coin)                                                                                                                                                                                                                                                                                         | ready to be used, no need to extract any assets                                                                                                                                                                                                                                                |
| Basic Output with IOTA and native tokens                                         | [`Coin<IOTA>`](../../references/framework/iota-framework/coin.mdx#struct-coin) and one or more [`Coin<NATIVE_TOKEN>`](../../references/framework/iota-framework/coin.mdx#struct-coin)                                                                                                                                                                                 | ready to be used, no need to extract any assets                                                                                                                                                                                                                                                |
| Basic Output with unlock conditions or features                                      | [`BasicOutput<IOTA>`](../../references/framework/stardust/basic_output#struct-basicoutput)                                                                                                                                                                                                                                                                            | [`Balance<IOTA>`](../../references/framework/iota-framework/balance#struct-balance), [`Bag`](../../references/framework/iota-framework/bag#struct-bag) of `Balance<NATIVE_TOKEN>` key-ed by `"NATIVE_TOKEN"`                                                                             |
| Alias Output                                                                         | [`AliasOutput<IOTA`](../../references/framework/stardust/alias_output#struct-aliasoutput)                                                                                                                                                                                                                                                                             | [`Balance<IOTA>`](../../references/framework/iota-framework/balance#struct-balance), [`Bag`](../../references/framework/iota-framework/bag#struct-bag) of `Balance<NATIVE_TOKEN>` key-ed by `"NATIVE_TOKEN"`, [`Alias`](../../references/framework/stardust/alias#struct-alias) object |
| Nft Output                                                                           | [`NftOutput<IOTA`](../../references/framework/stardust/nft_output#struct-nftoutput)                                                                                                                                                                                                                                                                                   | [`Balance<IOTA>`](../../references/framework/iota-framework/balance#struct-balance), [`Bag`](../../references/framework/iota-framework/bag#struct-bag) of `Balance<NATIVE_TOKEN>` key-ed by `"NATIVE_TOKEN"`, [`Nft`](../../references/framework/stardust/nft#struct-nft) object       |
...
| [Vested Rewards From the Stardust Upgrade](https://github.com/iotaledger/new_supply) | [`Timelock<Balance<IOTA>>`](../../references/framework/iota-framework/timelock.mdx#struct-timelock) objects.                                                                                                                                                                                                                                                          | -                                                                                                                                                                                                                                                                                          |
...
defines [`Coin`](../../references/framework/iota-framework/coin.mdx#struct-coin) as the primary object type to use by users to hold
tokens.
...
In Move, there are established ways for these operations, in particular using a [`Coin`](../../references/framework/iota-framework/coin.mdx#struct-coin)
to hold balances of tokens, as well as the [`CoinManager`](../../references/framework/iota-framework/coin_manager.mdx)
(that wraps the [`TreasuryCap`](../../references/framework/iota-framework/coin.mdx#struct-treasurycap))
...
A native token and its foundry from the Stardust ledger therefore translate to the following in the move ledger:
 ...
 - The [`CoinManagerTreasuryCap`](../../references/framework/iota-framework/coin_manager.mdx#struct-coinmanagertreasurycap)
...
[`Timelock<Balance<IOTA>>`](../../references/framework/iota-framework/timelock.mdx#struct-timelock).
