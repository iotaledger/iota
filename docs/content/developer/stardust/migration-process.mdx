...
[`Coin`](../../references/framework/testnet/iota-framework/coin.mdx#resource-coin) and
[`TreasuryCap`](../../references/framework/testnet/iota-framework/coin.mdx#resource-treasurycap). The two main goals of the
foundry migration are to convert it to a [`CoinManager`](../../references/framework/testnet/iota-framework/coin_manager.mdx),
...
this document).
- A `CoinManager` and [`CoinManagerTreasuryCap`](../../references/framework/testnet/iota-framework/coin_manager.mdx#resource-coinmanagertreasurycap) object, the latter of which is owned by the address of the alias that
...
[`Balance`](../../references/framework/testnet/iota-framework/balance.mdx#struct-balance)) as its maximum supply. Since
...
[`iota::transfer::receive`](../../references/framework/testnet/iota-framework/transfer.mdx#function-receive). There are
