...
[`Coin`](../../references/framework/iota/coin.mdx#resource-coin) and
[`TreasuryCap`](../../references/framework/iota/coin.mdx#resource-treasurycap). The two main goals of the
foundry migration are to convert it to a [`CoinManager`](../../references/framework/iota/coin_manager.mdx),
...
this document).
- A `CoinManager` and [`CoinManagerTreasuryCap`](../../references/framework/iota/coin_manager.mdx#resource-coinmanagertreasurycap) object, the latter of which is owned by the address of the alias that
...
[`Balance`](../../references/framework/iota/balance.mdx#struct-balance)) as its maximum supply. Since
...
[`iota::transfer::receive`](../../references/framework/iota/transfer.mdx#function-receive). There are
