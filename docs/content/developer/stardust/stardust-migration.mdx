...
take any shape and form, as opposed to the rigid format of UTXOs. The IOTA Foundation developed a [Move package that emulates the Stardust output models](../../references/framework/testnet/stardust/) in the Move language with all the previous Stardust functionality supported.
