...
but [`Move Objects`](../iota-101/objects/object-model.mdx) instead.x
...
take any shape and form, as opposed to the rigid format of UTXOs. The IOTA Foundation developed a [Move package that emulates the Stardust output models](../references/framework/stardust/address_unlock_condition.mdx) in the Move language with all the previous Stardust functionality supported.
