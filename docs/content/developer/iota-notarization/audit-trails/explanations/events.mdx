...
| `RecordAdded` | A record is appended to the trail, including a correction record | [Add a record](../how-tos/add-and-read-records.mdx), [Correct records](../how-tos/correct-records.mdx) |
...
Emitted each time a record is appended to the trail. Correcting a record also emits `RecordAdded`, because the correction is stored as a newly appended record with correction metadata.
