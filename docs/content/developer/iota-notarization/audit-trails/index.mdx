...
- **Correction tracking**: Records can be corrected by appending replacement records that link back to earlier entries, preserving the full history while highlighting the current version.
...
- Correct existing records by creating new records that reference the originals
