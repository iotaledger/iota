...
- Access to an Audit Trails client (read-only access is sufficient)
...
```rust reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/examples/audit-trail/07_access_read_only_methods.rs#L28-L29
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/bindings/wasm/audit_trail_wasm/examples/src/07_access_read_only_methods.ts#L34-L35
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/examples/utils/utils.rs#L53-L65
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/bindings/wasm/audit_trail_wasm/examples/src/util.ts#L40-L46
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/examples/audit-trail/07_access_read_only_methods.rs#L82-L97
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/bindings/wasm/audit_trail_wasm/examples/src/07_access_read_only_methods.ts#L70-L80
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/examples/audit-trail/07_access_read_only_methods.rs#L99-L103
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/bindings/wasm/audit_trail_wasm/examples/src/07_access_read_only_methods.ts#L82-L91
```
