...
```rust reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/examples/audit-trail/real-world/03_digital_product_passport.rs#L53-L59
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/bindings/wasm/audit_trail_wasm/examples/src/real-world/03_digital_product_passport.ts#L54-L60
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/examples/audit-trail/real-world/03_digital_product_passport.rs#L78-L108
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/bindings/wasm/audit_trail_wasm/examples/src/real-world/03_digital_product_passport.ts#L72-L89
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/examples/audit-trail/real-world/03_digital_product_passport.rs#L113-L175
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/bindings/wasm/audit_trail_wasm/examples/src/real-world/03_digital_product_passport.ts#L93-L109
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/examples/audit-trail/real-world/03_digital_product_passport.rs#L180-L244
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/bindings/wasm/audit_trail_wasm/examples/src/real-world/03_digital_product_passport.ts#L113-L178
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/examples/audit-trail/real-world/03_digital_product_passport.rs#L249-L306
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/bindings/wasm/audit_trail_wasm/examples/src/real-world/03_digital_product_passport.ts#L181-L234
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/examples/audit-trail/real-world/03_digital_product_passport.rs#L311-L359
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/bindings/wasm/audit_trail_wasm/examples/src/real-world/03_digital_product_passport.ts#L237-L276
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/examples/audit-trail/real-world/03_digital_product_passport.rs#L364-L425
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/bindings/wasm/audit_trail_wasm/examples/src/real-world/03_digital_product_passport.ts#L280-L319
```
