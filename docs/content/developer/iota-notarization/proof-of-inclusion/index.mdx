...
The project currently distributes Proof of Inclusion from the Notarization repository source. It does not provide pre-built CLI binaries, and the Wasm Package is not a browser package.
