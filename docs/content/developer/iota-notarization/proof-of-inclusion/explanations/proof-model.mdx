...
flowchart TD
    ...
    TransactionTarget[Optional transaction digest]
    Objects[Exact object values]
    EventTargets[Event transaction digests and sequence numbers]
...
Read [Trust and Verification](./trust-and-verification.mdx) to choose a trust anchor and understand the verification checks.
