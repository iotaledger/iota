...
See [Verify a Proof Using a Trusted Node](../how-tos/examples/advanced/trusted-node.mdx) for a complete Rust and TypeScript example.
...
See [Persist Authenticated Committees in a File-Based Cache](../how-tos/examples/advanced/committee-cache.mdx) to build and configure a persistent Rust cache.
