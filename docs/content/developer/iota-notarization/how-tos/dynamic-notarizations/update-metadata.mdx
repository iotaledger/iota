...
```ts reference
https://github.com/iotaledger/notarization/tree/v0.1.0/bindings/wasm/notarization_wasm/examples/src/06_update_metadata.ts#L16-24
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/v0.1.0/bindings/wasm/notarization_wasm/examples/src/06_update_metadata.ts#L26-L35
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/v0.1.0/bindings/wasm/notarization_wasm/examples/src/06_update_metadata.ts#L64-L67
```
