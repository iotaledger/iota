...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1.0/examples/02_create_dynamic_notarization.rs#L20-L32
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/v0.1.0/bindings/wasm/notarization_wasm/examples/src/02_create_dynamic.ts#L22-L34
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1.0/examples/02_create_dynamic_notarization.rs#L43-L53
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/v0.1.0/bindings/wasm/notarization_wasm/examples/src/02_create_dynamic.ts#L30
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1.0/examples/02_create_dynamic_notarization.rs#L30-L32
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/v0.1.0/bindings/wasm/notarization_wasm/examples/src/02_create_dynamic.ts#L33-34
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1.0/examples/02_create_dynamic_notarization.rs
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/v0.1.0/bindings/wasm/notarization_wasm/examples/src/02_create_dynamic.ts
```
