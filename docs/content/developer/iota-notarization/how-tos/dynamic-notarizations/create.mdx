...
```ts reference
https://github.com/iotaledger/notarization/tree/v0.1.0/bindings/wasm/notarization_wasm/examples/src/02_create_dynamic.ts#L21-L34
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1.0/examples/02_create_dynamic_notarization.rs#L29-L32
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/v0.1.0/bindings/wasm/notarization_wasm/examples/src/02_create_dynamic.ts#L33-L34
```
