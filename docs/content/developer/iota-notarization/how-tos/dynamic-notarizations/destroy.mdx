...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1.0/examples/04_destroy_notarization.rs#L34-L37
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1.0/examples/04_destroy_notarization.rs#L41-L44
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/v0.1.0/bindings/wasm/notarization_wasm/examples/src/04_destroy_notarization.ts#L35-37
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1.0/examples/04_destroy_notarization.rs#L57-L66
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/v0.1.0/bindings/wasm/notarization_wasm/examples/src/04_destroy_notarization.ts#L50-51
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1.0/examples/04_destroy_notarization.rs#L64-L79
```
