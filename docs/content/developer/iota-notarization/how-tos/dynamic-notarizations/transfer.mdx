...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1.0/examples/07_transfer_dynamic_notarization.rs#L48-L50
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1.0/examples/07_transfer_dynamic_notarization.rs#L55-L58
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/v0.1.0/bindings/wasm/notarization_wasm/examples/src/07_transfer_notarization.ts#L43-47
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1.0/examples/07_transfer_dynamic_notarization.rs#L71-L97
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/v0.1.0/bindings/wasm/notarization_wasm/examples/src/07_transfer_notarization.ts#L54-82
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1.0/examples/07_transfer_dynamic_notarization.rs#L107-L135
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/v0.1.0/bindings/wasm/notarization_wasm/examples/src/07_transfer_notarization.ts#L87-110
```
