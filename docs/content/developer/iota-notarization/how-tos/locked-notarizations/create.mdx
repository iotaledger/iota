...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1.0/examples/01_create_locked_notarization.rs#L26-L37
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1.0/examples/01_create_locked_notarization.rs#L35-L37
```
