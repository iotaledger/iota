...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1.0/examples/08_access_read_only_methods.rs#L23-L33
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1.0/examples/08_access_read_only_methods.rs#L43-L52
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1.0/examples/08_access_read_only_methods.rs#L55-L57
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/v0.1.0/bindings/wasm/notarization_wasm/examples/src/08_access_read_only_methods.ts#L33-L58
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1.0/examples/08_access_read_only_methods.rs#L60-L69
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/v0.1.0/bindings/wasm/notarization_wasm/examples/src/08_access_read_only_methods.ts#L50-L52
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1.0/examples/08_access_read_only_methods.rs#L72-L81
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1.0/examples/08_access_read_only_methods.rs#L169-L171
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1.0/examples/08_access_read_only_methods.rs#L111-L114
```
