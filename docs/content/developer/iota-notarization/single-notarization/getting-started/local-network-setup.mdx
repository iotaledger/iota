...
description: Setup a local IOTA node and deploy the IOTA Notarization package.
teams:
  - iotaledger/identity
tags:
  - notarization
...
Now that you have your env pointing to a local node, and have an account, you're almost ready to put a checkmark on the last requirement for using the Single Notarization locally: The deployment of the smart contracts used by the library.
