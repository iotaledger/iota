...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1/examples/notarization/06_update_metadata.rs#L16-L28
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/v0.1/bindings/wasm/notarization_wasm/examples/src/06_update_metadata.ts#L14-L24
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1/examples/notarization/06_update_metadata.rs#L34-L38
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1/examples/notarization/06_update_metadata.rs#L64-L67
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/v0.1/bindings/wasm/notarization_wasm/examples/src/06_update_metadata.ts#L57-L61
```
...
You can also clear the metadata by setting it to `None` resp. `undefined`:
...
let _ = notarization_client
    .update_metadata(nNone, *notarization_id.object_id())
...
```ts
// Clear metadata, you can set it to null alternatively
await notarizationClient
    .updateMetadata(undefined, notarization.id)
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1/examples/notarization/06_update_metadata.rs
```
