...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1/examples/notarization/04_destroy_notarization.rs#L14-L25
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1/examples/notarization/04_destroy_notarization.rs#L32-L37
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1/examples/notarization/04_destroy_notarization.rs#L38-L44
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1/examples/notarization/04_destroy_notarization.rs#L55-L66
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/v0.1/bindings/wasm/notarization_wasm/examples/src/04_destroy_notarization.ts#L49-L59
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1/examples/notarization/04_destroy_notarization.rs#L75-L79
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/v0.1/bindings/wasm/notarization_wasm/examples/src/04_destroy_notarization.ts#L63-L71
```
