...
To create a Dynamic Notarization, you need access to an [IOTA network](../../../../network-overview) or run a
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1/examples/notarization/02_create_dynamic_notarization.rs#L20-L35
```
...
* The `finish()` method is called to build the transaction which will create the Dynamic Notarization when being
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1/examples/notarization/02_create_dynamic_notarization.rs#L43-L59
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1/examples/notarization/02_create_dynamic_notarization.rs
```
