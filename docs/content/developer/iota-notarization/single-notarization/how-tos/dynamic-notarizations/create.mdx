...
```rust reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/examples/notarization/02_create_dynamic_notarization.rs#L20-L32
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/examples/notarization/02_create_dynamic_notarization.rs#L43-L53
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/examples/notarization/02_create_dynamic_notarization.rs#L29-L32
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/examples/notarization/02_create_dynamic_notarization.rs
```
