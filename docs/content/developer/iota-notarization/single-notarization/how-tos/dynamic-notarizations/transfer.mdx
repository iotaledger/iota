...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1/examples/notarization/07_transfer_dynamic_notarization.rs#L19
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1/examples/notarization/07_transfer_dynamic_notarization.rs#L28-L40
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/v0.1/bindings/wasm/notarization_wasm/examples/src/07_transfer_notarization.ts#L25-L33
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1/examples/notarization/07_transfer_dynamic_notarization.rs#L42-L50
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1/examples/notarization/07_transfer_dynamic_notarization.rs#L49-L58
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/v0.1/bindings/wasm/notarization_wasm/examples/src/07_transfer_notarization.ts#L41-L50
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1/examples/notarization/07_transfer_dynamic_notarization.rs#L67-L96
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1/examples/notarization/07_transfer_dynamic_notarization.rs#L99-L128
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/v0.1/bindings/wasm/notarization_wasm/examples/src/07_transfer_notarization.ts#L83-L110
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1/examples/notarization/07_transfer_dynamic_notarization.rs
```
