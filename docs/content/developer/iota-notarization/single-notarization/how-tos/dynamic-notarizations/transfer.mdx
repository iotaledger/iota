...
```rust reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/examples/notarization/07_transfer_dynamic_notarization.rs#L19
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/bindings/wasm/notarization_wasm/examples/src/07_transfer_notarization.ts#L16-L18
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/examples/notarization/07_transfer_dynamic_notarization.rs#L28-L40
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/bindings/wasm/notarization_wasm/examples/src/07_transfer_notarization.ts#L26-L33
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/examples/notarization/07_transfer_dynamic_notarization.rs#L42-L50
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/bindings/wasm/notarization_wasm/examples/src/07_transfer_notarization.ts#L36-L40
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/examples/notarization/07_transfer_dynamic_notarization.rs#L49-L58
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/bindings/wasm/notarization_wasm/examples/src/07_transfer_notarization.ts#L44-L47
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/examples/notarization/07_transfer_dynamic_notarization.rs#L67-L96
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/bindings/wasm/notarization_wasm/examples/src/07_transfer_notarization.ts#L54-L82
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/examples/notarization/07_transfer_dynamic_notarization.rs#L99-L128
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/bindings/wasm/notarization_wasm/examples/src/07_transfer_notarization.ts#L87-L110
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/examples/notarization/07_transfer_dynamic_notarization.rs
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/bindings/wasm/notarization_wasm/examples/src/07_transfer_notarization.ts
```
