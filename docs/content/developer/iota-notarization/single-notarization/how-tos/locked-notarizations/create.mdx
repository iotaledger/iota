...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1/examples/notarization/01_create_locked_notarization.rs#L22-L40
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1/examples/notarization/01_create_locked_notarization.rs
```
