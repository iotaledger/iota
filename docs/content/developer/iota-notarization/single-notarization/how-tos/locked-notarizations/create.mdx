...
```rust reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/examples/01_create_locked_notarization.rs#L22-L37
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/examples/01_create_locked_notarization.rs#L34-L37
```
