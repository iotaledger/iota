...
- A funded notarization client with the necessary permissions to create and update a Dynamic Notarization
  as been described in [Get Funded Notarization Client](../how-tos/dynamic-notarizations/create#1-get-funded-notarization-client)
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1/examples/notarization/real-world/01_iot_weather_station.rs#L35-L70
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1/examples/notarization/real-world/01_iot_weather_station.rs#L80-L112
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1/examples/notarization/real-world/01_iot_weather_station.rs#L120-L141
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/v0.1/bindings/wasm/notarization_wasm/examples/src/real-world/01_iot_weather_station.ts#L133-L145
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1/examples/notarization/real-world/01_iot_weather_station.rs
```
