...
```rust reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/examples/notarization/real-world/01_iot_weather_station.rs#L35-L70
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/bindings/wasm/notarization_wasm/examples/src/real-world/01_iot_weather_station.ts#L44-L84
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/examples/notarization/real-world/01_iot_weather_station.rs#L80-L112
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/bindings/wasm/notarization_wasm/examples/src/real-world/01_iot_weather_station.ts#L92-L123
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/examples/notarization/real-world/01_iot_weather_station.rs#L120-L140
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/bindings/wasm/notarization_wasm/examples/src/real-world/01_iot_weather_station.ts#L135-L148
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/examples/notarization/real-world/01_iot_weather_station.rs
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/feat/audit-trails-dev/bindings/wasm/notarization_wasm/examples/src/real-world/01_iot_weather_station.ts
```
