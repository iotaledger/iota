...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1/examples/notarization/real-world/02_legal_contract.rs#L41-L125
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1/examples/notarization/real-world/02_legal_contract.rs#L90-L126
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/v0.1/bindings/wasm/notarization_wasm/examples/src/real-world/02_legal_contract.ts#L99-L134
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1/examples/notarization/real-world/02_legal_contract.rs#L135-L166
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1/examples/notarization/real-world/02_legal_contract.rs#L169-L177
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1/examples/notarization/real-world/02_legal_contract.rs#L192-L242
```
...
```ts reference
https://github.com/iotaledger/notarization/tree/v0.1/bindings/wasm/notarization_wasm/examples/src/real-world/02_legal_contract.ts#L198-L241
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1/examples/notarization/real-world/02_legal_contract.rs
```
