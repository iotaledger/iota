...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1/examples/real-world/02_legal_contract.rs#L90-L126
```
...
```rust reference
https://github.com/iotaledger/notarization/tree/v0.1/examples/real-world/02_legal_contract.rs#L192-L242
```
