...
The [Digital Product Passport real world example](./how-tos/real-world/digital-product-passport.mdx) demonstrates how to implement a Digital Product Passport following the example set by the [IOTA DPP demo](https://dpp.demo.iota.org/).
