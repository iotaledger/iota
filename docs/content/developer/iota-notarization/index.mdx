...
- **[Audit Trails](./audit-trail/index.mdx)** — for creating tamper-proof, chronological logs of activities. Use it when you need to record *who did what and when* in a sequential, append-only fashion. Audit trails are shared on-chain and governed by Role-Based Access Control (RBAC), enabling multiple authorized parties to write to the same trail under fine-grained permission rules.
...
| "Who did what and when?" | [Audit Trails](./audit-trail/index.mdx) |
| "How did this asset evolve over its lifecycle?" | [Audit Trails](./audit-trail/index.mdx) (often combined with a Dynamic Notarization for current state) |
...
- **Need event logs?** Jump straight to the [Audit Trails introduction](./audit-trail/index.mdx) and its [getting-started](./audit-trail/getting-started/rust.mdx) guides.
