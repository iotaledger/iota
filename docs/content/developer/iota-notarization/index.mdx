...
description: Discover the IOTA Notarization Toolkit — combining the Single Notarization and Audit Trail components to anchor digital data and event history to the IOTA ledger.
...
Together, Single Notarization and Audit Trail form the Notarization Toolkit for digital trust: Single Notarization captures *facts* and *current state*, while Audit Trail captures the *history of events* that led to them.
