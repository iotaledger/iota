...
description: Discover the IOTA Notarization Toolkit for creating verifiable records and proving that ledger activity is included in a certified IOTA checkpoint.
...
The IOTA Notarization Toolkit is part of the IOTA Trust Framework. It provides three complementary components for creating verifiable ledger records and proving their inclusion without trusting the system that transports the proof:
...
- **[Proof of Inclusion](./proof-of-inclusion/index.mdx)** — for constructing portable evidence that a transaction, object version, or event is included in a committee-certified IOTA checkpoint. Use it when another system must verify existing ledger activity locally and independently of the node or service that supplied the proof.

Single Notarization captures *facts* and *current state*, while Audit Trails captures the *history of events* that led to them. Proof of Inclusion complements both components by turning their ledger activity, or activity from any other IOTA application, into portable evidence for an independent verifier.
...
| "Can another system verify that this transaction, object version, or event is in a certified checkpoint?" | [Proof of Inclusion](./proof-of-inclusion/index.mdx) |
...
- **Need portable verification evidence?** Start with the [Proof of Inclusion introduction](./proof-of-inclusion/index.mdx), then choose the [Rust](./proof-of-inclusion/getting-started/rust.mdx), [Wasm](./proof-of-inclusion/getting-started/wasm.mdx), or [CLI](./proof-of-inclusion/getting-started/cli.mdx) workflow.
