...
--assign digest \
--move-call iota::package::authorize_upgrade @0x7ccc6c2fe6a509e6266b17e57a109f393f435a30da748c5168448958eb47d826 0u8 digest \
--assign ticket \
...
--assign digest \
--move-call YOUR_PKG::admin::authorize @0xSHARED_OBJ digest \
--assign ticket \
--execute-upgrade ticket \
--assign receipt \
