...
Options:
     ...
     --compile-upgrade <MOVE_PACKAGE_PATH>                                Compile a Move package for upgrade without executing any transaction commands.
     --execute-upgrade <TICKET>                                           Execute the system upgrade using previously compiled package data.
