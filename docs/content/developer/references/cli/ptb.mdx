...
Options:
     ...
     --gas-coin <ID>                                                      The object IDs for the gas coins to use. If not specified, it will try to use the first gas coin that it finds that has at least the requested gas-budget balance.
