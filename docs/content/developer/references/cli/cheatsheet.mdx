...
tags: [cli, reference, address, iota-cli]
teams:
...
<table class="w-100">
	...
	<tbody>
		<tr>
			...
			<td class="w-1/3">Get an IOTA coin from the faucet associated with the active network</td>
		</tr>
		<tr>
			<td class="w-2/3">`iota client faucet --address ADDRESS`</td>
			<td class="w-1/3">Get an IOTA coin for the address (accepts also an alias)</td>
		</tr>
		<tr>
			<td class="w-2/3">`iota client faucet --url CUSTOM_FAUCET_URL`</td>
			<td class="w-1/3">Get an IOTA coin from custom faucet</td>
		</tr>
		<tr>
...
<table class="w-100">
	...
	<tbody>
		...
		<tr>
			<td class="w-2/3">`iota-localnet genesis`</td>
			<td class="w-1/3">Bootstrap and initialize a new IOTA network</td>
		</tr>
		<tr>
			<td class="w-2/3">`iota-localnet start`</td>
