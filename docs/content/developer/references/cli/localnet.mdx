...
| `--pruning-config-path <PATH>` | Path to a TOML retention config for the indexer writer. Without it the indexer keeps all data and its database grows without bound. |
