...
To verify a signature against the cryptography library backing IOTA when debugging, see [sigs-cli](https://github.com/iotaledger/fastcrypto/blob/4cf71bd8b3a373495beeb77ce81c27827516c218/fastcrypto-cli/src/sigs_cli.rs).
