...
`Random` has a reserved address `0x8`. See <a href="/references/framework/testnet/iota-framework/random" data-noBrokenLinkCheck='true'>random.move</a> for the Move APIs for accessing randomness on IOTA.
