...
The deployment of the contract is done by the admin, which is a  address. Navigate to the [`publish.sh`](/examples/move/reviews_rating/publish.sh) script of the repository and follow the below steps to deploy the contract.  
