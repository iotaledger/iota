...
The [template package](https://github.com/iotaledger/iota/blob/main/examples/move/asset_tokenization/template) allows for seamless asset creation. It makes use of the previous explained `asset_tokenization` module.
