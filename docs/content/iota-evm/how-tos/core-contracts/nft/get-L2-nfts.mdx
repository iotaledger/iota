...
This guide will show you how to get the L2 NFTs owned by an account using the [`ISCAccounts.getL2NFTs`](../../../../references/iota-evm/magic-contract/ISCAccounts.md#getl2nfts) function from the [`ISCAccounts`](../../../../references/iota-evm/magic-contract/ISCAccounts.md) [magic contract](../../../../references/iota-evm/magic-contract/introduction.md).
<GetNftMetadata/>
