...
This guide will show you how to get the L2 NFTs of a given collection owned by an account using the [`ISCAccounts.getL2NFTsInCollection`] function from the [`ISCAccounts`][magic contract](../../../../references/iota-evm/magic-contract/introduction.md).
<GetNftMetadata />
