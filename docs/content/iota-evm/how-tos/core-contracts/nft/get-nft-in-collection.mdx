...
This guide will show you how to get the L2 NFTs of a given collection owned by an account using the [`ISCAccounts.getL2NFTsInCollection`](../../../../references/iota-evm/magic-contract/ISCAccounts.md#getl2nftsincollection) function from the [`ISCAccounts`](../../../../references/iota-evm/magic-contract/ISCAccounts.md) [magic contract](../../../../references/iota-evm/magic-contract/introduction.md).
<GetNftMetadata />
