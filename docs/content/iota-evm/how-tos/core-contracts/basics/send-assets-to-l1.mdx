...
IOTA EVM have 18 decimal places, while IOTA have 6. This means that any decimals beyond the 6th will be ignored by IOTA, even though you can see them on IOTA EVM. Please keep this in mind while sending your tokens to L1.

:::

This guide will show you how to use the ISC sandbox interface to send assets from L2 to L1. This includes base tokens and NFTs. Before you can send these assets, you need to know how you get them on L2 and how you allow a contract to use them.
...
ISC.sandbox.send(to, allowance, metadata, options);
```
