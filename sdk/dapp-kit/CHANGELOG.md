...
- 640b757: Add `getIotaClientQuery` to get the `queryOptions` config for usage with the `QueryClient`
  outside of React hooks. Added `useIotaClientSuspenseQuery` to support suspense-based data fetching.
