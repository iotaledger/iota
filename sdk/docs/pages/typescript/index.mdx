...
-   [`@iota/iota-sdk/client`](/typescript/iota-client) - A client for interacting with Iota RPC
    nodes.
-   [`@iota/iota-sdk/bcs`](/typescript/bcs) - A BCS builder with pre-defined types for Iota.
-   [`@iota/iota-sdk/transactions`](/typescript/transaction-building/basics) - Utilities for
...
-   [`@iota/iota-sdk/cryptography`](/typescript/cryptography/keypairs) - Shared types and classes
    for cryptography.
-   [`@iota/iota-sdk/multisig`](/typescript/cryptography/multisig) - Utilities for working with
    multisig signatures.
-   [`@iota/iota-sdk/utils`](/typescript/utils) - Utilities for formatting and parsing various Iota
    types.
-   [`@iota/iota-sdk/faucet`](/typescript/faucet) - Methods for requesting IOTA from a faucet.
-   [`@iota/iota-sdk/zklogin`](/typescript/zklogin) - Utilities for working with zkLogin.
