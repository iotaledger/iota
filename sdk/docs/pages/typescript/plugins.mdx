...
[TransactionDataBuilder](/typedoc/classes/_iota_iota.transactions.TransactionDataBuilder.html)
...
properties in the
[typedoc definition](/typedoc/classes/_iota_iota.transactions.TransactionDataBuilder.html).
...
-   `UnresolvedObject`: A partial reference to an object, often containing just the object's `id`,
    but may also include a version, digest, or initialSharedVersion.
