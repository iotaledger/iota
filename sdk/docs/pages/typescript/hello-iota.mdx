...
have an address, use the [Iota Client CLI](https://docs.iota.org/references/cli/client) or the
...
You can also use the [Iota Client CLI](https://docs.iota.org/references/cli/client) to perform
