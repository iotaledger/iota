...
an address, use the [Iota Client CLI](https://docs.iota.org/references/cli/client) or the
[Iota Wallet browser extension](https://docs.iota.org) to create one.
...
You can also use the [Iota Client CLI](https://docs.iota.org/references/cli/client) to perform client
