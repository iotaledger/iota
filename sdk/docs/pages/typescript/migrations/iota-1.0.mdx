...
As part of the 1.0 release the `@iota/iota-sdk` package has been renamed to `@iota/iota-sdk`
...
[wallet-standard documentation](https://docs.iota.org/standards/wallet-standard).
