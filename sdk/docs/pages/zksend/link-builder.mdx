...
<Callout type="warning">
	...
	necessary licenses. The information provided by IOTA Foundation is not legal advice, and developers
...
- **`client`** (optional) - The `@iota/iota-sdk` client used to fetch data to construct the link. If
