...
| `move-authenticator.ts`          | Publish, create and send with an on-chain accout (Move Authenticator) |
| `move-authenticator-existing.ts` | Send with an on-chain accout (Move Authenticator)                     |
