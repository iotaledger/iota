...
Aggregation and reporting tooling (under `h2/`, sharing `../aggregate.py`,
...
![Per-cell values for Run A and every Run B cell](h2/results/matrix/summary_plots/modes_heatmaps.png)
...
![Checkpoint lag and cancelled share against the admitted rate](h2/results/matrix/summary_plots/modes_knee.png)
...
![Success tps against checkpoint lag per cell](h2/results/matrix/summary_plots/modes_tradeoff.png)
...
![The same curves over admitted rate divided by drain rate](h2/results/matrix/summary_plots/modes_knee_utilization.png)
...
![Admitted per commit, and the outcome, for the five mixed-cost cells](h2/results/matrix/summary_plots/modes_mix.png)
...
window. The metric descriptions are in H1's H4 section above. The only
...
The takeaway is the TL;DR at the top of this section. Full per-cell
numbers: `h2/results/matrix/summary.md` and `summary.csv`; figures:
`h2/results/matrix/summary_plots/`; the cost calibration behind the grid:
`h2/probe-test.md`.
