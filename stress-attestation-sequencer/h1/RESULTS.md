...
Aggregation and reporting tooling (all in this directory):
...
![Attestation computation units and dry-run execution latency, n4](results/summary_plots_n4/attestation_latency_exec.png)
...
![Attestation computation units and dry-run execution latency, n24](results/summary_plots_n24/attestation_latency_exec.png)
...
![Attestation pool wait latency, n4](results/summary_plots_n4/attestation_latency_wait.png)
...
![Attestation pool wait latency, n24](results/summary_plots_n24/attestation_latency_wait.png)
...
![Attestation async resume latency, n4](results/summary_plots_n4/attestation_latency_resume.png)
...
![Attestation async resume latency, n24](results/summary_plots_n24/attestation_latency_resume.png)
...
![Full attestation latency, n4](results/summary_plots_n4/attestation_latency_full.png)
...
![Full attestation latency, n24](results/summary_plots_n24/attestation_latency_full.png)
...
![Attestation computation units and dry-run execution latency, moveauth](results/summary_plots_auth_n4/attestation_latency_exec.png)
...
![Receipt → execution latency, n4](results/summary_plots_n4/receipt_to_exec_latency.png)
...
![Receipt → execution latency, n24](results/summary_plots_n24/receipt_to_exec_latency.png)
...
![Settlement finality latency, n4](results/summary_plots_n4/settlement_finality_latency.png)
...
![Settlement finality latency, n24](results/summary_plots_n24/settlement_finality_latency.png)
...
![Receipt → execution latency, moveauth](results/summary_plots_auth_n4/receipt_to_exec_latency.png)

*Receipt → executed latency, `moveauth` campaign — A grows with the number
of verifications, B does not.*

![Settlement finality latency, moveauth](results/summary_plots_auth_n4/settlement_finality_latency.png)
...
![Checkpoint creation lag, n4](results/summary_plots_n4/checkpoint_creation_latency.png)
...
![Checkpoint creation lag, n24](results/summary_plots_n24/checkpoint_creation_latency.png)
...
![Checkpoint creation lag, moveauth](results/summary_plots_auth_n4/checkpoint_creation_latency.png)
...
![Post-consensus validation latency, n4](results/summary_plots_n4/post_consensus_validation_latency.png)
...
![Post-consensus validation latency, n24](results/summary_plots_n24/post_consensus_validation_latency.png)
...
![Post-consensus validation latency, moveauth](results/summary_plots_auth_n4/post_consensus_validation_latency.png)
...
![Submit-transaction latency, n4](results/summary_plots_n4/submit_latency.png)
...
![Submit-transaction latency, n24](results/summary_plots_n24/submit_latency.png)
...
![Submit-transaction latency, moveauth](results/summary_plots_auth_n4/submit_latency.png)
...
![CPU and memory, n4](results/summary_plots_n4/resources.png)
...
![CPU and memory, n24](results/summary_plots_n24/resources.png)
...
![CPU and memory, moveauth](results/summary_plots_auth_n4/resources.png)
...
![Throughput, attestation rate, and validation-drop rate, n4](results/summary_plots_n4/TPS.png)
...
![Throughput, attestation rate, and validation-drop rate, n24](results/summary_plots_n24/TPS.png)
...
![Throughput, attestation rate, and validation-drop rate, moveauth](results/summary_plots_auth_n4/TPS.png)
...
![Execution queues and backpressure, n4](results/summary_plots_n4/queues.png)
...
![Execution queues and backpressure, n24](results/summary_plots_n24/queues.png)
...
![Execution queues and backpressure, moveauth](results/summary_plots_auth_n4/queues.png)
...
![Post-consensus load shedding, n4](results/summary_plots_n4/load_shedding_post_consensus.png)
...
![Post-consensus load shedding, n24](results/summary_plots_n24/load_shedding_post_consensus.png)
...
Full per-configuration numbers: `results/summary_table_n4.md` and
`results/summary_table_n24.md`. Figures: `results/summary_plots_n4/`
and `results/summary_plots_n24/`.
